...
<div class="col-xs-12" style="left: 13%; width: 87%;">
	...
	<h2>공지사항 추가페이지</h2>
	<input type="button" value="수정하기" class="btn btn-icon-right btn-green g-recaptcha" onclick="location.href='http://localhost:8080/nespresso/listnotice.action';"
	...
	<!-- ******************************************************************************* -->
		<div class="input-group input-group-generic contactus-form-field">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
				<input type="text" name="nsubject" size="65" maxlength="100" class="col-xs-12 col-sm-8 col-md-8 col-lg-6"/>
			</div>
		</div>
		...
		<div class="input-group input-group-generic contactus-form-field">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
				<input type="date" name="ndate" size="65" maxlength="100" class="col-xs-12 col-sm-8 col-md-8 col-lg-6"/>
			</div>
		</div>
		...
		<div class="input-group input-group-generic contactus-form-field">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
				<textarea rows="12" cols="63" name="ncontent" class="col-xs-12 col-sm-8 col-md-8 col-lg-6"></textarea>
			</div>
		</div>
