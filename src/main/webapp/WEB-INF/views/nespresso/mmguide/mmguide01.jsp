		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Essenza-Mini/img/bg.jpg&quot;);">
																...
																<div class="v_item">
																	...
																	<div class="v_content">
																		...
																		<p>
																			<a class="v_link v_iconLeft"
																				href="http://localhost:8080/nespresso/resources/pdf/UM-NESPRESSO-ESSENZA-MINI-Z3-C-PROD-2017-02-20.pdf">
																				<i class="fas fa-long-arrow-alt-right" style="color: dimgrey;"></i> <span>가이드</span>
																			</a>
																		</p>
																	</div>
																</div>
