		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Maestria/img/bg.jpg&quot;);">
							<div id="aja1" style="display: block;">
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<section class="vue_headerMachine">
									<div class="v_sectionRestrict">
										<div class="v_sectionContent">
											<h1 tabindex="0"> <span>머신 사용 안내</span> 마에스트리아 </h1>
											...
											<div class="v_row">
												<aside class="v_col30">
													<div class="v_carousel">
															...
															<ul>
																<li class="v_selected" key="[object Object]">
																	<button aria-expanded="true">
																		<span class="v_visually_hidden">마에스트리아 레드 </span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/9148283519006/mobile_M-0133_icond740a1d4-bdb9-4a1d-aff7-7fd7c78893a6.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/9148283519006/mobile_M-0133_icond740a1d4-bdb9-4a1d-aff7-7fd7c78893a6.png&quot;);"></div>
																	</button>
																</li>
														...
														<div class="v_slide">
															<h4>
																<span class="v_visually_hidden">지금 보고있는 머신</span> 마에스트리아 레드
															</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/9148283519006/mobile_M-0133_icond740a1d4-bdb9-4a1d-aff7-7fd7c78893a6.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/9148283519006/mobile_M-0133_icond740a1d4-bdb9-4a1d-aff7-7fd7c78893a6.png"
																lazy="loaded">
														</div>
														
													</div>
													<div class="v_manuals"> <h3>사용 안내서</h3> <ul> <li key="[object Object]"> <a target="_blank" class="v_link" href="https://www.nespresso.com/shared_res/manuals/maestria/2012/www_Maestria_Z3A_NESPRESSO(EN_KO_HK_TW_CN).pdf" key="[object Object]"> <strong>마에스트리아</strong> <small>4.51 MB</small> <em>한국어</em> <span class="v_visually_hidden">PDF 다운로드</span> </a> </li> </ul> </div>
												</aside>
												...
												<div class="v_col70" style="width: 68%!important;">
													...
													<div class="v_tabPanel v_tablelist v_troubleshooting"
														...
														<!-- DB해결법 -->
														<div class="v_tabPanelContainer"> <div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 들어오지 않습니다.</h5> <div class="v_wysiwyg"><ul><li>플러그, 전압, 퓨즈를 확인합니다. 문제가 계속되면 네스프레소 클럽으로 연락 주십시오.<br>네스프레소 클럽: 080-734-1111<br>(24시간, 365일 수신자 부담)</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>커피나 물이 나오지 않습니다.</h5> <div class="v_wysiwyg"><ul><li>첫 사용시: 물통에 따뜻한 물을 채우고 (최대 55°C) 머신을 작동시킵니다.</li><li>물통이 비었습니다. 물통을 채웁니다.</li><li>필요하면 디스케일링을 진행합니다. 디스케일링 방법 참조.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png&quot;);"></div><div class="v_content"> <h5>커피가 충분히 뜨겁지 않습니다.</h5> <div class="v_wysiwyg"><ul><li>물만 추출하여 컵을 미리 데워놓습니다.</li><li>필요하면 디스케일링을 진행합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MILK-CONTAINER-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MILK-CONTAINER-B.png&quot;);"></div><div class="v_content"> <h5>스팀 파이프 사용 시 우유 거품이 생성되지 않습니다</h5> <div class="v_wysiwyg">스팀 파이프를 깨끗이 씻어준 후 조정해 줍니다. 냉장고 온도의 차가운 생우유를 사용하십시오.</div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MANUAL-LEVER-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MANUAL-LEVER-B.png&quot;);"></div><div class="v_content"> <h5>손잡이를 완전히 내릴 수 없습니다.</h5> <div class="v_wysiwyg">캡슐 컨테이너를 비웁니다. 머신 안쪽에 캡슐이 막혀 있진 않은지 확인합니다.</div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>누출 또는 비정상적인 커피 흐름</h5> <div class="v_wysiwyg">물통의 위치를 확인하십시오. 커피 추출구를 청소해줍니다.</div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>가운데 표시 등이 주황색으로 계속 켜져있습니다.</h5> <div class="v_wysiwyg"><ul><li>디스케일링을 진행하십시오</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>캡슐을 넣었지만 커피는 나오지 않고 물만 나옵니다.</h5> <div class="v_wysiwyg"><ul><li>문제가 계속되는 경우, 네스프레소 클럽으로 연락 주십시오.<br>네스프레소 클럽: 080-734-1111<br>(24시간, 365일 수신자 부담)</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png&quot;);"></div><div class="v_content"> <h5>머신이 자동으로 꺼집니다.</h5> <div class="v_wysiwyg"><ul><li>9분동안 사용하지 않으면 절전을 위하여 머신이 자동으로 꺼집니다. 설정을 변경하시려면 메뉴 모드를 참조하십시오.</li></ul></div> </div> </div> </div> </div>
														<!-- DB해결법끝 -->
													</div>
													<!-- 여기부터 개요 -->
