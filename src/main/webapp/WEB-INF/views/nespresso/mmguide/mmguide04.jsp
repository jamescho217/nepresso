		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Pixie/img/bg.jpg&quot;);">
							<div id="aja1" style="display: block;">
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<section class="vue_headerMachine">
									<div class="v_sectionRestrict">
										<div class="v_sectionContent">
											<h1 tabindex="0"> <span>머신 사용 안내</span> 픽시 </h1>
											...
											<div class="v_row">
												<aside class="v_col30">
													<div class="v_carousel">
															...
															<ul>
																<li class="v_selected" key="[object Object]">
																	<button aria-expanded="true">
																		<span class="v_visually_hidden">픽시 C61 타이탄  </span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/13901060571166.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/13901060571166.png&quot;);"></div>
																	</button>
																</li>
																<li key="[object Object]">
																	<button aria-expanded="false">
																		<span class="v_visually_hidden">픽시 C61 일렉트릭 레드</span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/13901056639006.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/13901056639006.png&quot;);"></div>
																	</button>
																</li>
															</ul>
														</div>
														<div class="v_slide">
															<h4>
																<span class="v_visually_hidden">지금 보고있는 머신</span> 픽시 C61 타이탄
																C30 블랙
															</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/13901060571166.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/13901060571166.png"
																lazy="loaded">
														</div>
														<div class="v_slide" style="display: none;">
															<h4>
																<span class="v_visually_hidden">지금 보고있는 머신</span> 픽시 C61 일렉트릭 레드
																C30 화이트
															</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/13901056639006.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/13901056639006.png"
																lazy="loaded">
														</div>
													...
													<div class="v_manuals">
														...
														<ul>
															<li key="[object Object]"><a target="_blank"
																class="v_link"
																href="http://localhost:8080/nespresso/resources/pdf/www_Pixie_Z3_NESPRESSO(EN_CN_HK_TW_KO).pdf"
																key="[object Object]"> <strong>픽시 C60</strong> <small>2.90MB</small>
															...
															<li key="[object Object]"><a target="_blank"
																class="v_link"
																href="http://localhost:8080/nespresso/resources/pdf/www_Pixie_Z3_NESPRESSO(EN_CN_HK_TW_KO).pdf"
																key="[object Object]"> <strong>픽시 C61</strong> <small>2.57MB</small>
																	<em>한국어</em> <span class="v_visually_hidden">PDF
																		다운로드</span>
															</a></li>
														</ul>
												...
												<div class="v_col70" style="width: 68%!important;">
													...
													<div class="v_tabPanel v_tablelist v_troubleshooting"
														...
														<!-- DB해결법 -->
														<div class="v_tabPanelContainer"> <div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 들어오지 않습니다</h5> <div class="v_wysiwyg"><ul><li>머신이 자동으로 꺼졌습니다. On/OFF 버튼을 누릅니다.</li><li>플러그, 전압, 퓨즈를 확인합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>커피나 물이 나오지 않습니다</h5> <div class="v_wysiwyg"><ul><li>물통을 확인하고, 비었으면 신선한 물을 채웁니다. 필요하다면 디스케일링을 진행합니다.</li>
<li>손잡이를 올립니다. 커피 버튼을 눌러 물이 나올 때까지 기다립니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png&quot;);"></div><div class="v_content"> <h5>커피가 충분히 뜨겁지 않습니다</h5> <div class="v_wysiwyg"><ul><li>컵을 미리 데워놓습니다. 필요하다면 디스케일링을 진행합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MANUAL-LEVER-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MANUAL-LEVER-B.png&quot;);"></div><div class="v_content"> <h5>손잡이를 완전히 내릴 수 없습니다</h5> <div class="v_wysiwyg"><ul><li>캡슐 컨테이너를 비웁니다 / 머신 안쪽에 캡슐이 막혀 있진 않은지 확인합니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>누출 또는 비정상적인 커피 흐름</h5> <div class="v_wysiwyg"><ul><li>물통이 잘 장착되어 있는지 확인합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 불규칙적으로 반짝 입니다</h5> <div class="v_wysiwyg"><ul><li>네스프레소 클럽으로 연락주십시오.<br>네스프레소 클럽: 080-734-1111
<br>(24시간, 365일 수신자 부담)
</li>
<li>디스케일링을 마칩니다.(디스케일링 방법 참조)</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>캡슐을 넣었지만 커피는 나오지 않고 물만 나옵니다</h5> <div class="v_wysiwyg"><ul><li>문제가 계속되는 경우, 네스프레소 클럽으로 연락주십시오.<br>네스프레소 클럽: 080-734-1111
<br>(24시간, 365일 수신자 부담)</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png&quot;);"></div><div class="v_content"> <h5>머신이 자동으로 꺼집니다</h5> <div class="v_wysiwyg"><ul><li>머신은 에너지 절약을 위해 9분간 사용하지 않을 경우 자동으로 꺼집니다. “절전 모드” 참조.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loading" style="background-image: url(&quot;data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7&quot;);"></div><div class="v_content"> <h5>전면부 등이 빨간색입니다</h5> <div class="v_wysiwyg"><ul><li>물통이 비었거나 청소가 필요합니다.</li></ul></div> </div> </div> </div> </div>
														<!-- DB해결법끝 -->
													</div>
													<!-- 여기부터 개요 -->
