		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Pixie-Clips/img/bg.jpg&quot;);">
							<div id="aja1" style="display: block;">
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<section class="vue_headerMachine">
									<div class="v_sectionRestrict">
										<div class="v_sectionContent">
											<h1 tabindex="0"> <span>머신 사용 안내</span> 픽시 클립 </h1>
											...
											<div class="v_row">
															...
															<ul>
																<li class="v_selected" key="[object Object]">
																	<button aria-expanded="true">
																		<span class="v_visually_hidden">픽시 클립 C60 블랙 &amp; 레몬 네온</span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/12615935950878.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/12615935950878.png&quot;);"></div>
																	</button>
																</li>
															</ul>
														</div>
														<div class="v_slide">
															<h4><span class="v_visually_hidden">지금 보고있는 머신</span> 픽시 클립 C60 블랙 &amp; 레몬 네온</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/12615935950878.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/12615935950878.png"
																lazy="loaded">
														</div>
													</div>
													<div class="v_manuals">
														...
														<ul>
															<li key="[object Object]"><a target="_blank"
																class="v_link"
																href="/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"
																key="[object Object]"> <strong>픽시 클립</strong> <small>2.51MB</small>
												...
												<div class="v_col70" style="width: 68%!important;">
													...
													<div class="v_tabPanel v_tablelist v_instructions"
														...
														<div class="v_tabPanelContainer"> <div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MODULARITY-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MODULARITY-B.png&quot;);"></div><div class="v_content"> <h5>사이드 패널 장착 / 분리</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a> 
														<!-- <a class="v_link v_iconLeft" href="#!/Pixie-Clips/instructions/clip-unclip/video"> <i class="fas fa-long-arrow-alt-right"></i> <span>동영상</span> </a> --> </p> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MODULARITY-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MODULARITY-B.png&quot;);"></div><div class="v_content"> <h5>전용 네스프레소 키를 이용하여 사이드 패널 분리</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a> 
														<!-- <a class="v_link v_iconLeft" href="#!/Pixie-Clips/instructions/ToUnclipPanel/video"> <i class="fas fa-long-arrow-alt-right"></i> <span>동영상</span> </a> --> </p> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>처음 사용시 또는 장기간 미사용 후 사용시</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a> 
														<!-- <a class="v_link v_iconLeft" href="#!/Pixie-Clips/instructions/first-use/video"> <i class="fas fa-long-arrow-alt-right"></i> <span>동영상</span> </a> --> </p> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/ENERGY-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/ENERGY-B.png&quot;);"></div><div class="v_content"> <h5>절전 모드</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a>  </p> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>커피 추출하기</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a>  </p> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/VOLUME-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/VOLUME-B.png&quot;);"></div><div class="v_content"> <h5>물의 양 설정하기</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a> 
														<!-- <a class="v_link v_iconLeft" href="#!/Pixie-Clips/instructions/programming-water-volume/video"> <i class="fas fa-long-arrow-alt-right"></i> <span>동영상</span> </a> --> </p> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/VELVETY-MILK-FROTH-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/VELVETY-MILK-FROTH-B.png&quot;);"></div><div class="v_content"> <h5>장기간 미사용 및 동파 방지 또는 수리 보내기 전에 머신에 남아있는 물 비우기</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a>  </p> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/footer/step3.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/footer/step3.png&quot;);"></div><div class="v_content"> <h5>공장 출하 설정으로 초기화</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a>  </p> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/DESCLAING-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/DESCLAING-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>디스케일링</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a> 
														<!-- <a class="v_link v_iconLeft" href="#!/Pixie-Clips/instructions/descaling/video"> <i class="fas fa-long-arrow-alt-right"></i> <span>동영상</span> </a> --> </p> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CLEAN-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CLEAN-B.png&quot;);"></div><div class="v_content"> <h5>머신 세척하기</h5> <p> <a class="v_link v_iconLeft" href="http://localhost:8080/nespresso/resources/pdf/www_PixieClips_Z3A_NESPRESSO(CN_EN_HK_TW_KO).pdf"> <i class="fas fa-long-arrow-alt-right"></i> <span>가이드</span> </a>  </p> </div> </div> </div> </div>
													</div>
													<!-- 여기부터해결법 -->
													<div class="v_tabPanel v_tablelist v_troubleshooting"
														...
														<!-- DB해결법 -->
														<div class="v_tabPanelContainer"> <div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 들어오지 않습니다</h5> <div class="v_wysiwyg"><ul><li>머신이 자동으로 꺼졌습니다. On/OFF 버튼을 누릅니다.</li><li>플러그, 전압, 퓨즈를 확인합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>커피나 물이 나오지 않습니다</h5> <div class="v_wysiwyg"><ul><li>물통을 확인하고, 비었으면 신선한 물을 채웁니다. 필요하다면 디스
														케일링을 진행합니다.</li><li>손잡이를 올립니다. 커피 버튼을 눌러 물이 나올 때까지 기다립니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png&quot;);"></div><div class="v_content"> <h5>커피가 충분히 뜨겁지 않습니다</h5> <div class="v_wysiwyg"><ul><li>컵을 미리 데워놓습니다.</li><li>필요하다면 디스케일링을 진행합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>누출 또는 비정상적인 커피 흐름</h5> <div class="v_wysiwyg"><ul><li>물통이 잘 장착되어 있는지 확인합니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 불규칙적으로 반짝 입니다</h5> <div class="v_wysiwyg"><ul><li>네스프레소 클럽으로 연락주십시오.<br>네스프레소 클럽 080-734-1111 (24시간, 365일 수신자부담)</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>캡슐을 넣었지만 커피 는 나오지 않고 물만 나옵니다</h5> <div class="v_wysiwyg"><ul><li>네스프레소 클럽으로 연락주십시오.<br>네스프레소 클럽 080-734-1111 (24시간, 365일 수신자부담)</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png&quot;);"></div><div class="v_content"> <h5>머신이 자동으로 꺼집니다</h5> <div class="v_wysiwyg"><ul><li>머신은 에너지 절약을 위해 9분간 사용하지 않을 경우 자동으로 꺼집니다. “절전 모드” 참조.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>전면부 등이 빨간색입니다</h5> <div class="v_wysiwyg"><ul><li>물통이 비었거나 청소가 필요합니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MACHINES-B.png" lazy="loading" style="background-image: url(&quot;data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7&quot;);"></div><div class="v_content"> <h5>패널을 장착할 수 없습니다</h5> <div class="v_wysiwyg"><ul><li>패널 안쪽의 화살표가 표시된 방향이 맞는지 확인하십시오. 위쪽에서부터 장착을 시작합니다.</li>
														<li>여전히 패널을 장착할 수 없는 경우 네스프레소 클럽으로 연락 주십시오.</li></ul></div> </div> </div> </div> </div>
														<!-- DB해결법끝 -->
													</div>
													<!-- 여기부터 개요 -->
