		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Aeroccino-plus/img/bg.jpg&quot;);">
										...
										<div class="v_sectionContent">
											<div class="v_row">
												<aside class="v_col30">
													...
													<div class="v_manuals"> <h3>사용 안내서</h3> <ul> <li key="[object Object]"> <a target="_blank" class="v_link" href="https://www.nespresso.com/shared_res/manuals/aeroccino/www_Aeroccino+_Z2(EN_DE_FR_IT_ES_PT_NL_SV_DA_FI_NO_GR_RU_CZ_PL_HU).pdf" key="[object Object]"> <strong>에어로치노 + 사용 설명서</strong> <small>2.40MB</small> <em>영어</em> <span class="v_visually_hidden">PDF 다운로드</span> </a> </li> </ul> </div>
												</aside>
