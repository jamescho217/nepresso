		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Inissia/img/bg.jpg&quot;);">
											...
											<div class="v_row">
												<aside class="v_col30">
													<div class="v_carousel">
															...
															<ul>
																<li class="v_selected" key="[object Object]">
																	<button aria-expanded="true">
																		<span class="v_visually_hidden">이니시아 D40 블랙</span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/11784667201566.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/11784667201566.png&quot;);"></div>
																	</button>
																</li>
																<li key="[object Object]">
																	<button aria-expanded="false">
																		<span class="v_visually_hidden">이니시아 C40 루비 레드</span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/11784668250142/mobile-M-0250-iconce19c3d7-4cd9-4964-838a-2a985638b036-1-.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/11784668250142/mobile-M-0250-iconce19c3d7-4cd9-4964-838a-2a985638b036-1-.png&quot;);"></div>
																	</button>
																</li>
															</ul>
														</div>
														<div class="v_slide">
															<h4>
																<span class="v_visually_hidden">지금 보고있는 머신</span> 이니시아 D40 블랙
																C30 블랙
															</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/11784667201566.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/11784667201566.png"
																lazy="loaded">
														</div>
														<div class="v_slide" style="display: none;">
															<h4>
																<span class="v_visually_hidden">지금 보고있는 머신</span> 이니시아 C40 루비 레드
																C30 화이트
															</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/11784668250142/mobile-M-0250-iconce19c3d7-4cd9-4964-838a-2a985638b036-1-.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/11784668250142/mobile-M-0250-iconce19c3d7-4cd9-4964-838a-2a985638b036-1-.png"
																lazy="loaded">
														</div>
													</div>
													<div class="v_manuals">
														...
														<ul>
															<li key="[object Object]"><a target="_blank"
																class="v_link"
																href="http://localhost:8080/nespresso/resources/pdf/inissia_C_zone3A.pdf"
																key="[object Object]"> <strong>이니시아</strong> <small>2.73MB</small>
												...
												<div class="v_col70" style="width: 68%!important;">
													...
													<div class="v_tabPanel v_tablelist v_troubleshooting"
														...
														<!-- DB해결법 -->
														<div class="v_tabPanelContainer"> <div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 들어오지 않습니다.</h5> <div class="v_wysiwyg"><ul><li>플러그, 전압, 퓨즈를 확인합니다. 문제가 계속되면 네스프레소 클럽으
														로 연락 주십시오.
														<br>네스프레소 클럽: 080-734-1111
														<br>(24시간, 365일 수신자 부담)</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>커피나 물이 나오지 않습니다.</h5> <div class="v_wysiwyg"><ul><li>첫 사용시: 물통에 따뜻한 물을 채우고 (최대 55°C) 페이지 9 의 안내에
														따라 머신을 작동시킵니다.</li><li>물통이 비었습니다. 물통을 채웁니다.</li><li>필요하면 디스케일링을 진행합니다. 디스케일링 방법 참조.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>커피가 매우 천천히 나옵니다.</h5> <div class="v_wysiwyg"><ul><li>커피 종류에 따라 흐름 속도가 달라집니다.</li><li>필요하면 디스케일링을 진행합니다. 디스케일링 방법 참조.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png&quot;);"></div><div class="v_content"> <h5>커피가 충분히 뜨겁지 않습니다.</h5> <div class="v_wysiwyg"><ul><li>물만 추출하여 컵을 미리 데워놓습니다.</li><li>필요하면 디스케일링을 진행합니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>캡슐부에서 물이 샙니다 (캡슐 컨테이너에 물이 많습니다).</h5> <div class="v_wysiwyg"><ul><li>캡슐을 정확한 위치에 넣습니다. 계속 물이 새면 네스프레소 클럽으로
														연락 주십시오.<br>네스프레소 클럽: 080-734-1111
														<br>(24시간, 365일 수신자 부담)</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불이 불규칙적으로 깜빡입니다.</h5> <div class="v_wysiwyg"><ul><li>캡슐을 정확한 위치에 넣습니다. 계속 물이 새면 네스프레소 클럽으로 연락 주십시오.<br>네스프레소 클럽: 080-734-1111
														<br>(24시간, 365일 수신자 부담)</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loading" style="background-image: url(&quot;data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7&quot;);"></div><div class="v_content"> <h5>캡슐을 넣었지만 커피는 나오지 않고 물만 나옵니다.</h5> <div class="v_wysiwyg"><ul><li>문제가 계속되는 경우, 네스프레소 클럽으로 연락 주십시오.<br>네스프레소 클럽: 080-734-1111
