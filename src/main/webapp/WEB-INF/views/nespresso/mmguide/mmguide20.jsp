		...
		<div id="app">
			<div id="contents" style="padding: 0 0 0;">
				<div id="machine" class="machine active" style="padding: 0;">
					<div class="vue" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/machineAssistance/machineAssistance/Vertuoline/img/bg.jpg&quot;);">
							<div id="aja1" style="display: block;">
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<section class="vue_headerMachine">
									<div class="v_sectionRestrict">
										<div class="v_sectionContent">
											<h1 tabindex="0"> <span>머신 사용 안내</span> 버츄오 </h1>
											...
											<div class="v_row">
												<aside class="v_col30">
													<div class="v_carousel">
															...
															<ul>
																<li class="v_selected" key="[object Object]">
																	<button aria-expanded="true">
																		<span class="v_visually_hidden">버츄오 블랙</span>
																		<div class="v_image"
																			data-src="https://www.nespresso.com/ecom/medias/sys_master/public/13266204098590/VertuoLine-Black-Coffee-Machine-200x200-products.png"
																			lazy="loaded"
																			style="background-image: url(&quot;https://www.nespresso.com/ecom/medias/sys_master/public/13266204098590/VertuoLine-Black-Coffee-Machine-200x200-products.png&quot;);"></div>
																	</button>
																</li>
														...
														<div class="v_slide">
															<h4>
																<span class="v_visually_hidden">지금 보고있는 머신</span> 버츄오 블랙
															</h4>
															<img alt=""
																data-src="https://www.nespresso.com/ecom/medias/sys_master/public/13266204098590/VertuoLine-Black-Coffee-Machine-200x200-products.png"
																src="https://www.nespresso.com/ecom/medias/sys_master/public/13266204098590/VertuoLine-Black-Coffee-Machine-200x200-products.png"
																lazy="loaded">
														</div>
														
													</div>
													<div class="v_manuals"> <h3>사용 안내서</h3> <ul> <li key="[object Object]"> <a target="_blank" class="v_link" href="https://www.nespresso.com/shared_res/manuals/vertuoline/UM_VERTUO_Z3_PROD_WEB_2018_11_13.pdf" key="[object Object]"> <strong>버츄오</strong> <small>2.6MB</small> <em>한국어</em> <span class="v_visually_hidden">PDF 다운로드</span> </a> </li> </ul> </div>
												</aside>
												...
												<div class="v_col70" style="width: 68%!important;">
													...
													<div class="v_tabPanel v_tablelist v_troubleshooting"
														...
														<!-- DB해결법 -->
														<div class="v_tabPanelContainer"> <div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>버튼에 불빛이 없음</h5> <div class="v_wysiwyg"><ul><li>머신이 자동으로 꺼짐, 버튼을 누르거나 잠금 해제 하세요.</li><li>추출구, 전원 플러그와 전압 그리고 퓨즈를 확인합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>커피와 물이 나오지 않음.</h5> <div class="v_wysiwyg"><ul><li>물통에 물이 채워져 있는지 확인 합니다.</li><li>새 캡슐이 제대로 장착 되어 있는지, 머신의 헤드가 제대로 닫혀 있는지 확인 후 버튼을 누릅니다.</li><li>필요시 디스케일링을 진행합니다.</li><li>머신의 헤드를 열어 사용한 캡슐을 배출 합니다. 청소 하기 부분을 참고하여 청소 합니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-WARMING-B.png&quot;);"></div><div class="v_content"> <h5>커피가 충분히 뜨겁지 않음.</h5> <div class="v_wysiwyg"><ul><li>컵을 미리 데워 둡니다.</li><li>필요시 디스케일링을 진행합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>머신이 시작되지 않고 불빛이 켜져 있음. 만약 깜빡이면 다음을 확인하세요.</h5> <div class="v_wysiwyg"><ul><li>레버가 제대로 잠궈져 있는지 확인합니다.</li><li>만약 커피나 에스프레소를 추출하려면, 새 캡슐이 제대로 장착 되어 있는지, 머신의 헤드가 제대로 닫혀 있는지 확인 후 버튼을 누릅니다.</li><li>만약 청소, 디스케일링, 비우기를 하려면 머신 내부에 캡슐이 없음을 확인한 후, 머신을 잠그고 버튼을 눌러 각 기능을 시작합니다.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>머신이 시작되지 않고 불빛이 번갈아 깜빡임; 한번 깜빡이고 한번 멈춤.</h5> <div class="v_wysiwyg"><ul><li>물통을 채운 후 다시 시작 버튼을 누르십시오.</li><li>레버가 제대로 잠궈져 있는지 확인합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>머신이 작동중에 불빛이 깜빡임.</h5> <div class="v_wysiwyg"><ul><li>만약 커피가 정상적으로 나오는 상태이면, 이는 머신이 정상적으로 작동함을 나타냅니다.</li><li>만약 물이 나오는 상태이면 청소, 디스케일링 혹은 비우기를 실행하는 중입니다. 해당 부분을 사용 설명서에서 확인 하십시오.</li><li>만약 청소, 디스케일링, 비우기를 하지 않으려면 버튼을 눌러 중단 합니다. 만약 머신이 계속 깜빡이면 버튼을 최소 7초간 눌러 디스케일링 모드에서 나가거나 다음을 참고 하세요.</li><li>문제가 지속되는 경우, 네스프레소 클럽으로 연락 주십시오.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불빛이 깜빡이며 머신이 작동하지 않음.</h5> <div class="v_wysiwyg"><ul><li>커피가 나오는데까지 약간의 시간이 소요 됩니다. (바코드를 읽고 커피 가루에 물을 축이는 과정이 필요합니다).</li><li>새 캡슐이 제대로 장착 되어 있는지, 머신의 헤드가 제대로 닫혀 있는지 확인 후 버튼을 누릅니다.</li><li>물통을 채운 후 다시 시작 버튼을 누르십시오.</li><li>버튼을 3초간 눌러 머신의 전원을 끈 후, 다시 버튼을 눌러 전원을 켭니다. 약 20분 정도 머신이 냉각 되길 기다립니다.</li><li>만약 머신이 꺼지지 않으면, 버튼을 최소 7초간 눌러 디스케일링 모드를 해제 하세요.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>버튼의 불빛이 지속적으로 두번 깜빡이고 한번 멈춤. 머신이 작동하지 않음.</h5> <div class="v_wysiwyg"><ul><li>정상적인 커피/에스프레소 추출중: 1) 사용하지 않은. 찌그러지지 않은 캡슐이 정상적인 위치에 놓여졌는지 확인 합니다.; 2) 레버가 “잠금” 위치에 있는지 확인 합니다; 3) 만약 문제가 지속되면 캡슐을 배출한 후 새로운 캡슐을 넣고 잠근 후, 버튼을 누릅니다.</li><li>디스케일링, 비우기, 청소하기중: 1) 캡슐이 배출 되었는지 확인 합니다; 2) 레버가 “잠금”위치에 있는지 확인합니다. 3) 버튼을 최소 3초간 눌러 머신을 끕니다. 4) 버튼을 다시 눌러 머신의 전원을 켭니다. 만약 문제가 지속되면 전원 코드를 소켓에서 분리한 후, 10초후에 다시 연결 합니다. 다시 버튼을 눌러 전원을 켜고 추출을 시작합니다.</li><li>물 양 조절 중: 1) 캡슐이 제대로 장착 되었는지 확인 합니다. 2) 관련 페이지를 참고 합니다.</li><li>만약 문제가 지속되면:1. 레버를 열고 머신의 헤드를 엽니다. 2. 캡슐을 교체 합니다.(필요시). 3. 전원 소켓에서 플러그를 분리한 후, 10초 후에 다시 연결합니다. 4. 머신의 헤드를 닫고 버튼을 눌러 머신의 전원을 켜고, 추출을 위해 다시 버튼을 누릅니다. 만약 문제가 지속되면 네스프레소 클럽으로 연락하십시오.</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <h5>물이 세거나 커피가 정상적으로 흐르지 않음.</h5> <div class="v_wysiwyg"><ul><li>물통이 제대로 장착되어 있는지 확인합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png&quot;);"></div><div class="v_content"> <h5>머신의 전원이 꺼짐.</h5> <div class="v_wysiwyg"><ul><li>절전 모드를 위해 머신을 9분동안 사용하지 않으면 자동으로 전원이 꺼집니다.</li><li>절전 모드 부분을 참고 합니다 .</li></ul></div> </div> </div> </div><div class="v_itemTable"> <div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/LIGHT-ALERT-B.png&quot;);"></div><div class="v_content"> <h5>불빛이 3번 깜빡인 후, 켜져 있는 상태 있음.</h5> <div class="v_wysiwyg"><ul><li>디스케일링이 필요함: 알람이 나타난 이후로 디스케일링을 진행하지 않으면 몇 잔의 커피밖에 추출하지 못합니다.</li></ul></div> </div> </div><div class="v_item"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/CUP-ESPRESSO-B.png&quot;);"></div><div class="v_content"> <h5>컵에 커피 가루가 나옴.</h5> <div class="v_wysiwyg"><ul><li>청소하기를 두번 진행 합니다.</li><li>“청소하기” 부분을 참고 합니다.</li></ul></div> </div> </div> </div> </div>
														<!-- DB해결법끝 -->
													</div>
													<!-- 여기부터 개요 -->
													<div class="v_tabPanel v_tablelist v_overview"
														...
														<!-- DB개요 -->
														<div class="v_tabPanelContainer"> <h4>스펙</h4> <div class="v_itemTable" key="[object Object],[object Object]"> <div class="v_item" key="[object Object]"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MACHINES-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MACHINES-B.png&quot;);"></div><div class="v_content"> <span><strong>무게</strong><span>4.9 Kg</span></span> </div> </div><div class="v_item" key="[object Object]"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/WATER-TANK-B.png&quot;);"></div><div class="v_content"> <span><strong>물통</strong><span>1.2 L</span></span> </div> </div> </div><div class="v_itemTable" key="[object Object],[object Object]"> <div class="v_item" key="[object Object]"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/COMPACT-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/COMPACT-B.png&quot;);"></div><div class="v_content"> <span><span>21.1 X 30.3 X 30.3 cm</span></span> </div> </div><div class="v_item" key="[object Object]"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/AUTO-OFF-MODE-B.png&quot;);"></div><div class="v_content"> <span><strong>자동꺼짐 모드:</strong><span> 9 분</span></span> </div> </div> </div><div class="v_itemTable" key="[object Object]"> <div class="v_item" key="[object Object]"> <div class="v_img" data-src="https://www.nespresso.com/shared_res/machineassistance/images/icon/MACHINES-B.png" lazy="loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/machineassistance/images/icon/MACHINES-B.png&quot;);"></div><div class="v_content"> <span><strong>보증기간:</strong><span>2년</span></span> </div> </div> </div> </div>
													</div>
													<!-- 사용법,해결법,개요끝 -->
												</div>
											</div>
