...
<!-- ------------------------------------------상단 끝---------------------------------------------------- -->
	...
	<!-- 
	<iframe src="http://localhost:8080/nespresso/faqlist.action" width="100%" scrolling="no" height="4300" 
	frameborder="0" id="iFrameResizer0" style="overflow: hidden; height: 3686px;"></iframe>
	 -->
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group input-group-generic with-picto">
												<form action="<%=cp%>/faq.action" method="post" id="gogo">
													<div class="col-xs-12">
...
<footer role="contentinfo" style="background-color: #000;">
