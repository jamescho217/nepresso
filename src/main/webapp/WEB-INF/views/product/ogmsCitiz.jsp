...
<meta name="keywords" content="네스프레소커피머신추천,캡슐커피머신,가정용커피머신추천,네스프레소시티즈직구,네스프레소커피머신시티즈,시티즈화이트">
<meta name="description" content="시티즈 D113 화이트, 첨단 기술과 레트로 모던한 디자인이 결합된 네스프레소 시티즈는 어떤 환경과도 완벽히 어울리는 커피 머신">
<meta property="og:title" content="네스프레소 시티즈 D113 화이트 | 캡슐 커피 머신 | 네스프레소">
<meta property="og:url" content="/nespresso/product/ogmsEssenza?mo_num=15">
<meta property="og:description" content="시티즈 D113 화이트, 첨단 기술과 레트로 모던한 디자인이 결합된 네스프레소 시티즈는 어떤 환경과도 완벽히 어울리는 커피 머신">
<meta property="og:image" content="https://www.nespresso.com:443https://www.nespresso.com/ecom/medias/sys_master/public/10054249971742/M-0370-main-684x378-6.jpg">
<title>${dto.mo_modelName2 } | 캡슐 커피 머신 | 네스프레소</title>
<link rel="canonical" href="/nespresso/product/ogmsEssenza?mo_num=15">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:machines::pdp-machines-machine-name:originalline","pageName":"Machine PDP","primaryCategory":"MACHINE","secondaryCategory":["White","CitiZ","Espresso","Lungo","Fast heat","OFF mode after 9 min.","cup"],"segmentBusiness":"B2C","technology":["original"],"type":"","variant":""}}};
...
<iframe target="_self" title="SaleCycle" style="display: none; height: 0px; width: 0px;" src="https://s.salecycle.com/receiver.html?sc_frame_id=1c62f0bb-54c9-4770-920e-08dfecc8dc97"></iframe>
...
<script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624444103721&amp;cv=9&amp;fst=1624444103721&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=376635471%2C2505059651&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=7&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DMachines%3Becomm_pagetype%3Dcategory%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Foriginal%2Fnespresso-citiz-white-refresh&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Foriginal&amp;tiba=%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%EC%8B%9C%ED%8B%B0%EC%A6%88%20D113%20%ED%99%94%EC%9D%B4%ED%8A%B8%20%7C%20%EC%BA%A1%EC%8A%90%20%EC%BB%A4%ED%94%BC%20%EB%A8%B8%EC%8B%A0%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624444103881&amp;cv=9&amp;fst=1624444103881&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=7&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DMachines%3Becomm_pagetype%3Dproduct%3Becomm_prodid%3D122159%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Foriginal%2Fnespresso-citiz-white-refresh&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Foriginal&amp;tiba=%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%EC%8B%9C%ED%8B%B0%EC%A6%88%20D113%20%ED%99%94%EC%9D%B4%ED%8A%B8%20%7C%20%EC%BA%A1%EC%8A%90%20%EC%BB%A4%ED%94%BC%20%EB%A8%B8%EC%8B%A0%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<script type="text/javascript" defer="" src="https://view.seekxr.com/nespresso/seek.min.js"></script>
</head>
<body class="livechat-collapsed"><!---->
<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">네스프레소 시티즈 D113 화이트 캡슐 커피 머신</h2>
...
<div id="respProductDetailPDPMachine-8797707511568-6f9f2f13-17b3-41e6-9b51-0673efe8d7df" class="crema-ui-container ">
	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/D113-KR-WH-KIT2">
    		...
    		$('#QuantitySelector__wrapper'+i).css('display','none');
				...
				<div class="ProductDetails__information">
					...
					<div class="ProductDetails__range">
						<span class="ProductDetails__specs">시티즈</span>
					</div>
					...
					<div class="ProductDetails__colorSwitcher">
						<div class="ProductDetailsColorSwitcher">
							...
							<ul class="ProductDetailsColorSwitcher__color-list">
								<c:if test="${dto.mo_num==15 }">
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsCitiz?mo_num=15" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(255, 255, 255);">
										<span class="element-visually-hidden">White</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsCitiz?mo_num=16" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(0, 0, 0);">
										<span class="element-visually-hidden">Black</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsCitiz?mo_num=17" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(165, 13, 36);">
										<span class="element-visually-hidden">Cherry Red</span>
									</a>
								</li>
								</c:if>
								<c:if test="${dto.mo_num==16 }">
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsCitiz?mo_num=15" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(255, 255, 255);">
										<span id="pd_color" class="element-visually-hidden">White</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsCitiz?mo_num=16" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(0, 0, 0);">
										<span class="element-visually-hidden">Black</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
								...
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsCitiz?mo_num=17" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(165, 13, 36);">
										<span class="element-visually-hidden">Cherry Red</span>
									</a>
								</li>
								</c:if>
						...
						<div class="ProductDetails__add-to-basket">
							<div class="AddToBagButton__container">
								<div id="AddToBagButton__button-CremaComponentId-150">
										...
										<input type="hidden" id="mo_num${dto.mo_num }" name="mo_num" value="${dto.mo_num }"/>	
											<input
			...
			<div class="ProductDetailsBody">
				...
				<div class="ResponsiveContainer">
					<div class="ProductDetailsBodyInformation">
						<div class="ProductDetailsBodyInformation__title">The ultimate coffee in town</div>
										...
										<div class="pdpEnhancement">
											...
											<div class="capsule-attribute">
												<div class="visual-capsule">
											    	<img src="${dto.mo_atMachine5 }" alt="시티즈 화이트">
											    </div>
	...
	<div class="ProductDetailsBodyInformation">
		...
		<div class="ProductDetailsBodyInformation__description">
			<ul class="ProductDetailsBodyInformation__specifications-list">
				<li class="ProductDetailsBodyInformation__specification">무게: 3.31 Kilogram</li>
				<li class="ProductDetailsBodyInformation__specification">캡슐 수거함 용량: 11</li>
				<li class="ProductDetailsBodyInformation__specification">수치 (폭x깊이x높이): 13 x 37.2 x 27.8 cm</li>
			...
			<a class="AccessibleLink DefaultLink ProductDetailsBodyInformation__link DefaultLink--with-right-chevron" href="https://www.nespresso.com/shared_res/manuals/essenza-mini/2020/UM_NEW_QUICK_START_GUIDE_Z3.pdf">
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script><script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(3989);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script><script type="text/javascript" id="">_mpulsePageGroup=function(c){var a=c.page.pageInfo.breadcrumbUID.split(":"),b=function(){if("customEvent"===google_tag_manager["GTM-WJGQVL"].macro(5011)&&"other"!==google_tag_manager["GTM-WJGQVL"].macro(5012))return google_tag_manager["GTM-WJGQVL"].macro(5013);switch(a[0]){case "account":return a[0]+"-"+(a[1]||"other");case "checkister":return a[0]+"-"+a[3];case "cart":case "shopping bag":return"checkout-shopping-bag";case "multi-step-checkout-summary-page":return"checkout-multi-step-checkout-summary-page";case "checkout":return"shopping bag"===a[3]?"checkout-shopping-bag":
a[0]+"-"+a[3];case "shop":a[0]="catalog";case "catalog":return/plp|pdp/.test(a[3])?/_plp/.test(c.page.pageInfo.pageName)?a[0]+"-plp":a[0]+"-pdp":a[0]+"-other";case "guest-checkout":return a[0]+"-"+a[3];case "login":return a[0]+"-"+a[3];case "registration-personal-info-page":return"registration";case "store-locator":return"locator";case "services-site-internet-nespresso":return"services";case "personal-info-page":case "brand":case "content":case "country-language":case "home":case "legal":case "locator":case "local-page":case "club":case "maintenance":case "registration":case "landing-page":case "services":case "standalone":case "support":return a[0];
case "page":return"unsubscribe"===a[3]?"page-unsubscribe":a[0]+"-"+a[1]}return"other"}();b=b.replace(/[^0-9a-z-]/g,"-").replace(/-+/g,"-");b=b.split("-");b[0]==b[1]&&(b=b.slice(1));return b.join("-")};mpulsePageGroup=function(){try{return _mpulsePageGroup(padl)}catch(c){}};mpulseBreadcrumbUIDGetter=function(c){return function(){try{return padl.page.pageInfo.breadcrumbUID.split(":")[c]}catch(a){}}};mpulseBreadcrumbUIDType=mpulseBreadcrumbUIDGetter(0);mpulseBreadcrumbUIDCategory=mpulseBreadcrumbUIDGetter(1);
mpulseBreadcrumbUIDSubCategory=mpulseBreadcrumbUIDGetter(2);mpulseBreadcrumbUIDName=mpulseBreadcrumbUIDGetter(3);mpulseBreadcrumbUIDTechnology=mpulseBreadcrumbUIDGetter(4);</script><script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5607),google_tag_manager["GTM-WJGQVL"].macro(5608),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(5609)],content_name:google_tag_manager["GTM-WJGQVL"].macro(5610),currency:google_tag_manager["GTM-WJGQVL"].macro(5611)||google_tag_manager["GTM-WJGQVL"].macro(5612),is_live:google_tag_manager["GTM-WJGQVL"].macro(5613),landscape:google_tag_manager["GTM-WJGQVL"].macro(5614),language:google_tag_manager["GTM-WJGQVL"].macro(5615),num_items:google_tag_manager["GTM-WJGQVL"].macro(5617),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(5618)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(5619)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(5620)),user_id:google_tag_manager["GTM-WJGQVL"].macro(5621),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(5628)),
value:google_tag_manager["GTM-WJGQVL"].macro(5629)||0})})(ah.facebook);</script><script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5670),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5671),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5672),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5673).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5674).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5675).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5676)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5677)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5678)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5679)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5680))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5681)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5682)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5683))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5684)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5685)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5686))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5687)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5688)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5689)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5690))}}),pushedGroupTagStrings.push(groupTagString));</script><script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5696),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5697),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5698)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5699),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5700)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
