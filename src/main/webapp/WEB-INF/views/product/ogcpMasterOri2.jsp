...
<title>${dto.co_modelName1 } | 마스터 오리진 오리지널 | 네스프레소 코리아</title>
        				...
        				<div class="ProductDetailsAttributes">
        					...
        					<ul class="ResponsiveContainer ProductDetailsAttributes__attributesList">
        						...
        						<!-- <li class="ProductDetailsAttributes__attribute ProductDetailsAttributes__intensity">
        							...
        							<div class="ProductDetailsAttributes__intensity-value" aria-hidden="true">7</div>
        							<div class="ProductDetailsAttributes__title ProductDetailsAttributes__title--intensity" aria-hidden="true">강도</div>
        							<span class="VisuallyHidden">강도 7</span>
        						</li> -->
        							...
        							<div class="ProductDetailsBodyInformation__description" itemprop="description">
        								<div class="FreeHTML">
        									...
        									description_aromaticprofile="아로마 프로파일: 우디향. 스파이시향 " description_icon="https://www.nespresso.com/shared_res/nc2/pdp_bg/reviving-origins-2020/images/icon_greencoffee.svg" description_background_color="" description_background_image="" description_cta_text="" description_cta_link="">
            									<n-zone data-product-item-id="7549.80" data-product-section="Page Builder - Master Origins PDP" data-product-position="1" container="true" background_mobile="${dto.co_bg }" background_desktop="${dto.co_bg }" background_position="top" campaign_id="" campaign_name="MasterOrigins_Sumatra_OL_2020" campaign_position="" campaign_creative="pb_component_master_origins_pdp" class="ns-master-origins ns-master-origins--agesumatra c-Zone c-Zone--null c-Zone--container" style="; background-image: url(${dto.co_bg});background-position: top;background-repeat: no-repeat">
            										<section class="c-Zone__item">
														<div class="ns-master-origins__wrapper">
											                <div class="ns-master-origins-logo">
											                	<img src="${dto.co_bigName1 }" loading="lazy" alt="agesumatra" title="agesumatra">
											                </div>
											                <div class="ns-master-origins-capsule">
																<n-heading level="2" class="c-Heading">
																	<h2 class="c-Heading__l" title="리미티드 에디션 빈티지 셀렉션 에이지드 수마트라   습식 탈곡 후 3년간 에이징한 아라비카">${dto.co_bigName2 }</h2>
																</n-heading>
																<div class="ns-master-origins-capsule-attributes">
																	<div class="ns-master-origins-capsule__img">
                            											<img loading="lazy" src="${dto.co_aticleCoffee2 }" alt="agesumatra" title="agesumatra">
                        											</div>
                        											<div class="ns-master-origins-capsule-attributes__first">
                            											<n-master-origins-attributes heading="로스팅" level="5">
																            <div class="n-attributes">
																                <h3>${dto.co_roastiness1 }</h3>
																                <div class="levels" data-levels="5">
																                    <div class="sr-only" aria-label="5">${dto.co_roastiness2 }</div>
																                    <span></span>
																                    <span></span>
																                    <span></span>
																                    <span></span>
                            											...
                            											<n-master-origins-attributes heading="산미" level="2">
																            <div class="n-attributes">
																                <h3>${dto.co_acidity1 }</h3>
																                <div class="levels" data-levels="2">
																                    <div class="sr-only" aria-label="2">${dto.co_acidity2 }</div>
																                    <span></span>
																                    <span></span>
																                    <span></span>
																                    <span></span>
											                        ...
											                        <div class="ns-master-origins-capsule-attributes__last">
											                        	<n-master-origins-attributes heading="쓴맛" level="4">
											            					<div class="n-attributes">
																                <h3>${dto.co_bitterness1 }</h3>
																                <div class="levels" data-levels="4">
																                    <div class="sr-only" aria-label="4">${dto.co_bitterness2 }</div>
																                    <span></span>
																                    <span></span>
																                    <span></span>
																                    <span></span>
                            											...
                            											<n-master-origins-attributes heading="바디감" level="4">
																            <div class="n-attributes">
																                <h3>${dto.co_body1 }</h3>
																                <div class="levels" data-levels="4">
																                    <div class="sr-only" aria-label="4">${dto.co_body2 }</div>
																                    <span></span>
																                    <span></span>
																                    <span></span>
																                    <span></span>
											                    ...
											                    <div class="ns-master-origins-capsule__footer">
											                        <n-heading level="4" class="c-Heading">
											                        	<h4 class="c-Heading__s" title="강도: 7  ">
											                        		<n-heading level="4" class="c-Heading">
											                        			<h4 class="c-Heading__s" title="강도: 7  ">강도: <strong>${dto.co_intensity2 }</strong> <span> </span></h4>
											                        		</n-heading>
											                        	</h4>
											                        </n-heading>
											                    </div>
											                    <div class="ns-master-origins-capsule__footer">
											                    	<n-add-to-cart sku="7549.80" buttonsize="large">
											                    		<span class="ProductListElement__price">
											                    			...
											                    			<span class="price">${dto.co_price }</span>
											                    		</span>
											                ...
											                <div class="ns-master-origins-description" style="">
											                	<div class="ns-master-origins-description__info">
											                        <n-heading level="2" class="c-Heading">
											                        	<h2 class="c-Heading__l" title="">
											                        		<img loading="lazy" class="ns-master-origins-description__logo" src="${dto.co_aticleCoffee3 }" alt="agesumatra" title="agesumatra">
											                        	</h2>
											                        </n-heading>
											                        <p>${dto.co_atContent1 }</p>
											                        <img loading="lazy" class="ns-master-origins-description__icon" src="${dto.co_aticleCoffee4 }" alt="" title="">
											                        <p class="ns-master-origins-description__details">${dto.co_atContent2 }</p>
											                    </div>
											                    <div class="ns-master-origins-description__image">
                        											<img loading="lazy" src="${dto.co_aticleCoffee5 }" alt="" title="">
																</div>
                											</div>
            											</div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceOrder__list">
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogaccView?ao_num=28" 
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/13989819482142/ViewCube-Capsules-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogaccView?ao_num=28" 
					data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" 
					data-product-position="1">
						<div class="ProductPush__name">뷰 큐브</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
							<span class="ProductPush__price">₩ <fmt:formatNumber value="41000" pattern="#,###" /></span>
						</div>
						<div class="ProductPush__add-to-bag AddToBagButton__container">
							<div id="AddToBagButton__button-CremaComponentId-2">
								<button class="AddToBagButton AddToBagButtonSmall" data-focus-id="AddToBagButton__button-CremaComponentId-2" type="button">
