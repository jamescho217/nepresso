...
<title>${dto.cv_modelName1 } | 캡슐커피 | 네스프레소</title>
				...
				<div class="ProductDetails__information">
					...
					<div>
						<span itemprop="offers" itemtype="http://schema.org/Offer" itemscope="">
							<span class="ProductDetails__price">₩ <fmt:formatNumber value="${dto.cv_price }" pattern="#,###" /></span>
...
<div class="ProductDetailsAttributes">
	<h3 class="VisuallyHidden">상품 특성</h3>
		<ul class="ResponsiveContainer ProductDetailsAttributes__attributesList">
			...
			<li class="ProductDetailsAttributes__attribute ProductDetailsAttributes__cupSizes">
				<img width="25" src="${dto.cv_cupSize9 }" role="presentation" class="ResponsiveImage" alt="">
				<div class="ProductDetailsAttributes__title">${dto.cv_sp4 }</div>
			</li>
			<li class="ProductDetailsAttributes__attribute ProductDetailsAttributes__cupSizes">
				<img width="25" src="${dto.cv_cupSize10 }" role="presentation" class="ResponsiveImage" alt="">
				<div class="ProductDetailsAttributes__title">${dto.cv_sp5 }</div>
			</li>
		</ul>
	</div>
		...
		<div class="ResponsiveContainer">
			<div class="ProductDetailsBodyInformation">
				<div class="ProductDetailsBodyInformation__description" itemprop="description">
					<div class="FreeHTML">
						<div style="margin-top: 5px; margin-bottom: 5px; padding: 5px; background-color: #8d7b79; color: #fff; text-align: center;">
							<strong>${dto.cv_shortContent }</strong>
						</div>
						<p>${dto.cv_longContent }</p>
					</div>
				</div>
			</div>
