...
<meta name="keywords" content="lume collection, coffee porcelain, porcelain coffee cup, porcelain coffee mugs, porcelain espresso cups, fine porcelain espresso mugs, porcelain coffee set">
<meta name="description" content="현대적이면서 클래식한 이탈리아 감성의 루메 컬렉션 에스프레소 컵 세트로 커피 일상에 새로운 빛을 더해보세요. Nespresso 캡슐커피 &amp; 커피머신을 통해 나만의 프리미엄 홈카페를 완성하세요.">
<meta property="og:title" content="루메 에스프레소 컵 세트 | 루메 컬렉션 | 네스프레소 코리아">
<meta property="og:url" content="https://www.nespresso.com:443/kr/ko/order/accessories/original/lume-espresso">
<meta property="og:description" content="현대적이면서 클래식한 이탈리아 감성의 루메 컬렉션 에스프레소 컵 세트로 커피 일상에 새로운 빛을 더해보세요. Nespresso 캡슐커피 &amp; 커피머신을 통해 나만의 프리미엄 홈카페를 완성하세요.">
<meta property="og:image" content="ecom/medias/sys_master/public/13569649967134/684x378.png">
<title>${dto.ao_modelName } | 액세서리 | 네스프레소 코리아</title>
<link rel="canonical" href="https://www.nespresso.com/kr/ko/order/accessories/original/lume-espresso">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:accessories::pdp-accessories-accessorie-name:originalline","pageName":"Accessories PDP","primaryCategory":"ACCESSORY","secondaryCategory":["Lume Collection","Cups"],"segmentBusiness":"B2C","technology":["original","vertuo"],"type":"","variant":""}}};
...
<noscript>
  ...
  <script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-0376d467-186d-495c-9c71-5cc50401a67e","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<div id="respPromotionBannersBlockAccessories_PDP-8802977392400-df226652-12d8-40b1-ae8e-f65feb717b26" class="crema-ui-container "></div>
<script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockAccessories_PDP-8802977392400-df226652-12d8-40b1-ae8e-f65feb717b26","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockAccessories_PDP-8802977392400-9a39ce33-8d72-43c7-95b6-dde64f907a4c","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockControllerhttps://www.nespresso.com/ecommerce-data?componentUid=respPromotionBannersBlockAccessories_PDP"}}});
</script>
        <div id="respProductDetailPDPAccessory-8797707577104-951ec987-a8fb-4b38-8278-a96e9c3c44f0" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/3535">
        		<h2 class="VisuallyHidden">${dto.ao_modelName }</h2>
        		<div class="ProductDetails__header">
        			<div class="ResponsiveContainer ProductDetails__display">
        				<a class="AccessibleLink DefaultLink ProductDetails__link DefaultLink--with-left-chevron" href="/nespresso/product/originalacc">
        					<span class="ProductDetails__link-text">액세서리 페이지로 돌아가기</span>
        				</a>
        				<div class="ProductDetailsImageSlider">
							...
							<div class="ProductDetailsImage-wrapper" style="display: none;"><!--  ProductDetailsImage-wrapper--not-current"> -->
								<img width="1568" height="608" itemprop="image" src="${dto.ao_atAcc3 }" 
								role="presentation" class="ResponsiveImage ProductDetailsImage ResponsiveImage--flexible" alt="">
							</div>
							</c:if>
							<c:if test="${dto.ao_num!=12 }">
        				...
        				<div class="ProductDetails__information">
        					...
        					<div>
        						<span itemprop="offers" itemtype="http://schema.org/Offer" itemscope="">
        							<span class="ProductDetails__price">₩ <fmt:formatNumber value="${dto.ao_price }" pattern="#,###" /></span>
        				...
        				<div class="ResponsiveContainer">
        					<div class="ProductDetailsBodyInformation">
        						<div class="ProductDetailsBodyInformation__description" itemprop="description">
        							<div class="FreeHTML">${dto.ao_atContent1 }</div>
        						</div>
        					</div>
        				...
        				<div class="ResponsiveContainer">
        					<ul class="ProductDetailsSocialMedias__list">
        						...
        						<li class="ProductDetailsSocialMedias__list-item">
        							<button class="ProductDetailsSocialMedias__list-item-button">
        								<span class="VisuallyHidden">productdetailsrespblock.a11y.pdp.social.link.label</span>
        								<i aria-hidden="true" class="Glyph Glyph--googleplus ProductDetailsSocialMedias__list-item-glyph"></i>
        							</button>
        						</li>
        						<li class="ProductDetailsSocialMedias__list-item">
        							<button class="ProductDetailsSocialMedias__list-item-button">
...
"\u01b6":"z","\u0225":"z","\u0240":"z","\u2c6c":"z","\ua763":"z"});</script><script type="text/javascript" id="" src="//d22xmn10vbouk4.cloudfront.net/b924dea2389e11e6bf0212f5c79d2169.js"></script><script type="text/javascript" id="">ah.wrap(function(){function b(a,c){return(a=location.search.match("(\\?|\x26)("+a+")\x3d([^\x26]+)"))&&(c?a[2]+":":"")+a[3]}ah.affiliation(b("aff")||b("utm_id|gclid|dclid",1)||b("utm_source"))})();</script><script type="text/javascript" id="">ah.wrap(function(b,f,e,m,d,c,n,g,p,k){c=b.fbq=b.fbq||function(){b=arguments;c[m]?c[m].apply(c,b):n.push(b)};b._fbq=b._fbq||c;c.push=c;c.version="2.0";n=c.queue=[];b=f.getElementsByTagName(e)[0];e=f.createElement(e);c.loaded=e.async=!0;e.src="//connect.facebook.net/en_US/fbevents.js";b.parentNode.insertBefore(e,b);ah.facebook={split:function(a){return a?a.split(/\|+/):[]},track:function(a){google_tag_manager["GTM-WJGQVL"].macro(3676)&&console.log("FB Deprecated Track Fired");if(a){a=a.split(";");d="product"!==a[3]?{page_type:d=
a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];c(a[2],a[1],d)}},trackSingle:function(a,h){if(a&&h){a=a.split(";");h=h.split(",");google_tag_manager["GTM-WJGQVL"].macro(3677)&&console.log("FB Data: "+a);google_tag_manager["GTM-WJGQVL"].macro(3678)&&console.log("FB Pixels: "+h);d="product"!==a[3]?{page_type:d=a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];
for(var q="track"==a[2]?"trackSingle":"trackSingleCustom",l=0;l<h.length;l++)c(q,h[l],a[1],d)}}};g=google_tag_manager["GTM-WJGQVL"].macro(3679).split(",");for(p=0;k=+g[p++];)c("set","autoConfig",!1,k),c("init",k);0!=google_tag_manager["GTM-WJGQVL"].macro(3680)&&(c("set","autoConfig",!1,google_tag_manager["GTM-WJGQVL"].macro(3681)),c("init",google_tag_manager["GTM-WJGQVL"].macro(3682)))})(window,document,"script","callMethod");</script><script type="text/javascript" id="">ah.wrap(function(a){a.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(3687),google_tag_manager["GTM-WJGQVL"].macro(3688),{content_name:google_tag_manager["GTM-WJGQVL"].macro(3691),content_subsection:google_tag_manager["GTM-WJGQVL"].macro(3694),content_technology:google_tag_manager["GTM-WJGQVL"].macro(3697),is_live:google_tag_manager["GTM-WJGQVL"].macro(3698),landscape:google_tag_manager["GTM-WJGQVL"].macro(3699),language:google_tag_manager["GTM-WJGQVL"].macro(3700),user_id:google_tag_manager["GTM-WJGQVL"].macro(3701),user_owned_machines:a.split(google_tag_manager["GTM-WJGQVL"].macro(3708))})})(ah.facebook);</script>
...
"getAttribute","offsetParent","getElement","innerWidth","innerHeight","clientWidth","clientHeight","length","click","innerHTML","innerText","promotion","roduct","impression","position","Scroll","gtmTracked","Load","load","DOMContentLoaded","EventListener");</script><script type="text/javascript" id="">ah.wrap(function(g,t,w,x,n,y,z,A,u,B,C,p,h,D,l,c){function E(b,d){var a=g[b]=g[b]||function(){e=arguments;a[x]?a[x].apply(a,e):a.queue.push(e)},e=t.getElementsByTagName(w)[0],f=t.createElement(w);g[b="_"+b]=g[b]||a;a.push=a;a.loaded=!0;a.version="1.0";a.queue=[];a.market=google_tag_manager["GTM-WJGQVL"].macro(3749);a.language=google_tag_manager["GTM-WJGQVL"].macro(3750);a.channel=google_tag_manager["GTM-WJGQVL"].macro(3751);f.async=!0;f.src="//www."+("true"===google_tag_manager["GTM-WJGQVL"].macro(3752)?"":"vst.")+"contact.nespresso.com/apps.php?a\x3dcalleo-"+d+(/(msie [1-9]|Trident\/7\.0)/i.test(navigator.userAgent)?
"\x26v\x3die":"");e.parentNode.insertBefore(f,e)}function F(b,d,a,e){a&&a(l);c=function(f,G,q,m,r){m&&m(l);m=m||a;q=q||f.replace(/e?$/,"ed");g[n+b]("add"+b+"Listener",f[z](),D[r=d+q]=y(function(I,J,H,k,v){k=G||"Click";k={eventAction:"Source:"+H+";Action:"+k,eventLabel:q,calleoChatType:d,nonInteraction:+!!G};for(v in l)k[v]=l[v];k[r]=1;m&&m(k,H,I,J);gtmDataObject.push(k)}));l[r=h+r]=e}}l={event:h=n+u,eventRaisedBy:"GTM"};D=ah[h]={};"true"===google_tag_manager["GTM-WJGQVL"].macro(3753)+""&&(E(h,"livechat"),F(u,A),c(C),c("Start"),
c("End"),c("Cancel"),c("Rating",0,"Reviewed",function(b,d){function a(e,f){b[h+A+"Review"+e]=d&&(f||["","Very good","Good","Fairly good","Not acceptable"])[+d[e[z]()]]}a("Delay");a("Quality");a("Satisfaction",["No","Yes"])}),t.addEventListener("click",y(function(b,d){d=b.target;/(^|\s)open-live-chat(\s|$)/.test(d.id+" "+d.className)&&(b.preventDefault(),g[h]("start"+u))})));if("true"===google_tag_manager["GTM-WJGQVL"].macro(3754)+""){E(n+p,"triggers");if(c=google_tag_manager["GTM-WJGQVL"].macro(3755))g[n+p]("NessclubId",c);F(p,B,function(b,d,
...
e&&Array.prototype.forEach.call(document.querySelectorAll(c),function(a){k.test(a.className)||(a.className+=a.className?" "+e:e)}),c}var d,e,k;ah.sessioncam={hide_pii:g,init:function(e,b){function c(){g(b,google_tag_manager["GTM-WJGQVL"].macro(3756),"ignorechanges");g(b,google_tag_manager["GTM-WJGQVL"].macro(3757),"hidetext");var a=document.getElementsByTagName("script")[0],c=document.createElement("script");c.async=!0;c.src="//d2oh4tlt9mrke9.cloudfront.net/Record/js/sessioncam.recorder.js";a.parentNode.insertBefore(c,a)}var a=ah.extend({Channel:google_tag_manager["GTM-WJGQVL"].macro(3758),
DeviceType:google_tag_manager["GTM-WJGQVL"].macro(3759),IsMobileSite:0,Landscape:google_tag_manager["GTM-WJGQVL"].macro(3760),LanguageCode:google_tag_manager["GTM-WJGQVL"].macro(3761),PrimaryCategory:google_tag_manager["GTM-WJGQVL"].macro(3762),Technology:google_tag_manager["GTM-WJGQVL"].macro(3763),UserIsLoggedIn:+("true"===google_tag_manager["GTM-WJGQVL"].macro(3764)),UserID:google_tag_manager["GTM-WJGQVL"].macro(3765)},e);b=b||google_tag_manager["GTM-WJGQVL"].macro(3778);sessioncamConfiguration={SessionCamHostname:location.href.replace(/^([^\/]+\/\/[^\/]+)\/.*$/,"$1."+google_tag_manager["GTM-WJGQVL"].macro(3780)),SessionCamPath:a.PrimaryCategory,SessionCamPageName:google_tag_manager["GTM-WJGQVL"].macro(3781)+":"+b,customDataObjects:Object.keys(a).map(function(b){return[{key:b,
value:a[b]}]}),elementsToRemove:g(b,google_tag_manager["GTM-WJGQVL"].macro(3782))};var d=document.readyState;if("complete"===d||"loading"!==d&&!document.documentElement.doScroll)setTimeout(ah.wrap(c));else{var f=ah.wrap(function(){f&&(document.removeEventListener("DOMContentLoaded",f),window.removeEventListener("load",f),f=0,c())});document.addEventListener("DOMContentLoaded",f);window.addEventListener("load",f)}}}})(eval);</script><script type="text/javascript" id="">ah.wrap(function(){ah.sessioncam.init()})();</script><script type="text/javascript" id="">var pageViewDebug=false&&google_tag_manager["GTM-WJGQVL"].macro(3783);var pageTech=google_tag_manager["GTM-WJGQVL"].macro(3786);var pageSub1=google_tag_manager["GTM-WJGQVL"].macro(3789);var pagePath=google_tag_manager["GTM-WJGQVL"].macro(3790);var isMachinePage=pageSub1==="machines";var isCapsulePage=pageSub1==="coffee";var isAccessoryPage=pageSub1==="accessories"||pagePath.indexOf("accessories")!=-1;var isVertuoPage=pagePath.indexOf("vertuo")!==-1||pageTech==="vertuoline";var isOriginalPage=pageTech==="originalline"&&!isVertuoPage||!isVertuoPage;var isComboSubscriptionPage=pageSub1==="combo-subscription";
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script><script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(3793);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script><script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(4843),google_tag_manager["GTM-WJGQVL"].macro(4844),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(4845)],content_name:google_tag_manager["GTM-WJGQVL"].macro(4846),currency:google_tag_manager["GTM-WJGQVL"].macro(4847)||google_tag_manager["GTM-WJGQVL"].macro(4848),is_live:google_tag_manager["GTM-WJGQVL"].macro(4849),landscape:google_tag_manager["GTM-WJGQVL"].macro(4850),language:google_tag_manager["GTM-WJGQVL"].macro(4851),num_items:google_tag_manager["GTM-WJGQVL"].macro(4853),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(4854)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(4855)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(4856)),user_id:google_tag_manager["GTM-WJGQVL"].macro(4857),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(4864)),
value:google_tag_manager["GTM-WJGQVL"].macro(4865)||0})})(ah.facebook);</script><script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(4906),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(4907),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(4908),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(4909).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(4910).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(4911).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(4912)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(4913)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(4914)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(4915)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(4916))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(4917)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(4918)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(4919))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(4920)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(4921)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(4922))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(4923)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(4924)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(4925)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(4926))}}),pushedGroupTagStrings.push(groupTagString));</script><script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(4931),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(4932),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(4933)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(4934),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(4935)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
