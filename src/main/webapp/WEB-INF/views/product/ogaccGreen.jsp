...
<meta name="keywords" content="재활용백,네스프레소,캡슐커피,캡슐커피머신">
<meta name="description" content="네스프레소 캡슐 재활용 프로그램에 참여하세요. 다음 주문 시 무료로 제공되는 네스프레소 재활용 백을 추가하여 여러분 가정에서 네스프레소 재활용을 시작하세요.">
<meta property="og:title" content="네스프레소 캡슐 재활용 백 | 캡슐 재활용 | 네스프레소">
<meta property="og:url" content="https://www.nespresso.com:443/kr/ko/order/accessories/original/recycling-at-home-campaign">
<meta property="og:description" content="네스프레소 캡슐 재활용 프로그램에 참여하세요. 다음 주문 시 무료로 제공되는 네스프레소 재활용 백을 추가하여 여러분 가정에서 네스프레소 재활용을 시작하세요.">
<title>${dto.ao_modelName } | 액세서리 | 네스프레소</title>
<link rel="canonical" href="https://www.nespresso.com/kr/ko/order/accessories/original/recycling-at-home-campaign">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:accessories::pdp-accessories-accessorie-name:originalline","pageName":"Accessories PDP","primaryCategory":"ACCESSORY","secondaryCategory":["We Make Green Moments"],"segmentBusiness":"B2C","technology":["original"],"type":"","variant":""}}};
...
<div id="respPromotionBannersBlockAccessories_PDP-8802977392400-f743454c-b86d-4cca-a331-3f224f03be76" class="crema-ui-container "></div>
<script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockAccessories_PDP-8802977392400-f743454c-b86d-4cca-a331-3f224f03be76","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockAccessories_PDP-8802977392400-34b5a618-5fb6-4376-9c94-b510b0fb51ce","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockControllerhttps://www.nespresso.com/ecommerce-data?componentUid=respPromotionBannersBlockAccessories_PDP"}}});
</script>
        <div id="respProductDetailPDPAccessory-8797707577104-b3873691-07b4-4e3f-bfb6-619376fe51ca" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/115801">
        				...
        				<div class="ResponsiveContainer">
        					<div class="ProductDetailsBodyInformation">
        						<div class="ProductDetailsBodyInformation__description" itemprop="description">
        							<c:if test="${dto.ao_num!=5 }">
        							<div class="FreeHTML">
        								<p>${fn:replace(dto.ao_atContent1, replaceChar,"<br/>") }</p>
        								<p>${fn:replace(dto.ao_atContent2, replaceChar,"<br/>") }</p>
        								<p>${fn:replace(dto.ao_atContent3, replaceChar,"<br/>") }</p>
        								<p>&nbsp;</p>
        							</div>
        							</c:if>
        							<c:if test="${dto.ao_num==5 }">
        							<div class="FreeHTML">
        								<p>${dto.ao_atContent1 }</p><br/>
        								<p>${dto.ao_atContent2 }</p><br/>
        								<p>${fn:replace(dto.ao_atContent3, replaceChar,"<br/>") }</p>
        								<p>&nbsp;</p>
        							</div>
        							</c:if>
...
d.id});0<b.length&&(e.automl.productEventDetail.productDetails=b,gtmDataObject=window.gtmDataObject||[],gtmDataObject.push(e))}):(gtmDataObject=window.gtmDataObject||[],gtmDataObject.push(e))})();</script><iframe src="https://bid.g.doubleclick.net/xbbe/pixel?d=KAE" style="display: none;"></iframe></body></html>