...
<title>${dto.cv_modelName1 } | 롱 블랙 하프 디카페인 버츄오 커피 캡슐 | 네스프레소</title>
													...
													<div class="pdpEnhancement">
														<div class="gradient">
															<div class="master-origin-logo">
																<img src="${dto.cv_bigName1 }" width="70%" alt="Half Caffeinato">
															</div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceDisplay__list">
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpMug2?cv_num=27">
					<span class="VisuallyHidden">디카페나토</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10386861129758/C-0111-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">디카페나토</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
