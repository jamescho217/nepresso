...
<meta name="keywords" content="네스프레소커피머신추천,캡슐커피머신,가정용커피머신추천,네스프레소에센자미니직구,네스프레소커피머신에센자미니,에센자미니C30블랙">
<meta name="description" content="네스프레소 에센자 미니 C30 블랙은 가장 작은 크기의 커피 머신입니다. 작고 가벼운 커피 머신으로 주방 어디에 놓아도 손색이 없습니다">
<meta property="og:title" content="네스프레소 에센자 미니 C30 블랙 | 초소형 캡슐 커피머신 | 네스프레소   ">
<meta property="og:url" content="/nespresso/product/ogmsEssenza?mo_num=1">
<meta property="og:description" content="네스프레소 에센자 미니 C30 블랙은 가장 작은 크기의 커피 머신입니다. 작고 가벼운 커피 머신으로 주방 어디에 놓아도 손색이 없습니다">
<meta property="og:image" content="https://www.nespresso.com:443/ecom/medias/sys_master/public/10259229605918/M-0445-main-684x378.jpg">
<title>${dto.mo_modelName2 } | 초소형 캡슐 커피머신 | 네스프레소   </title>
<link rel="canonical" href="/nespresso/product/ogmsEssenza?mo_num=1">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:machines::pdp-machines-machine-name:originalline","pageName":"Machine PDP","primaryCategory":"MACHINE","secondaryCategory":["Espresso","Lungo","Essenza Mini","Black","19 bar pressure","OFF mode after 9 min."],"segmentBusiness":"B2C","technology":["original"],"type":"","variant":""}}};
...
<script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-87deb149-a435-461a-84ba-2e457ec8261f","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<div id="respProductDetailPDPMachine-8797707511568-1a8409f4-07f5-4fce-bc4c-600648910152" class="crema-ui-container ">
	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/C30-KR-BK-KIT">
...
$( function() {
	...
	// . 이 class고 #이 id인거 아시죠???
    $('div.ProductDetailsSliderBullet').on('click', function(e){ //div의 ProductDetailsSliderBullet클래스를 클릭했을때 on됨

    	var idx = $(this).index(); //클릭한것의 index값을 구해줌 (0,1,2,3......)
    	
    	if( $(this).children('label').hasClass('ProductDetailsSliderBullet__label--selected') ){ 
    		//클릭한것(div의 ProductDetailsSliderBullet클래스)의 자녀(하위값중 <label>을)가 ~~~클래스를 갖고있을때!!
    		$(this).siblings().children('label').removeClass('ProductDetailsSliderBullet__label--selected'); 
    		//~~~클릭한것의 siblings(형제(=본인빼고겠죠??형제에 본인포함x))의 자녀중(<label>)에 ~~클래스를 지워라 제거해라// 여기서는 검은색동그라미 제거
    		$('div.ProductDetailsImage-wrapper').hide();
    		//div의 ProductDetailsImage-wrapper클래스를 숨겨라(display:none)-->이미지
        	$('div.ProductDetailsImage-wrapper').eq(idx).show();
    		//이미지를 나타내라!! 클릭한 버튼의 index값과 일치하는 index값을 가진 이미지를
    		//그래서 첫번째버튼=첫번째이미지 가 성립됩니다
    	} else {
    		$(this).children('label').addClass('ProductDetailsSliderBullet__label--selected');
    		//여기서 selected시켜서 동그라미 버튼검은색이 되도록 해줍니다 (addClass)
    		$(this).siblings().children('label').removeClass('ProductDetailsSliderBullet__label--selected');
    		//위와 같음 나머지를 제거해야하니까
    		$('div.ProductDetailsImage-wrapper').hide();
        	$('div.ProductDetailsImage-wrapper').eq(idx).show();
    		...
    		$('#QuantitySelector__wrapper'+i).css('display','none');
				...
				<div class="ProductDetails__information">
					...
					<div class="ProductDetails__range">
						<span class="ProductDetails__specs">에센자 미니</span>
					</div>
					...
					<div class="ProductDetails__colorSwitcher">
						<div class="ProductDetailsColorSwitcher">
							...
							<ul class="ProductDetailsColorSwitcher__color-list">
								<c:if test="${dto.mo_num==1 }">
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=1" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(0, 0, 0);">
										<span class="element-visually-hidden">Black</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=2" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(255, 255, 255);">
										<span class="element-visually-hidden">White</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=3" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(0, 0, 0);">
										<span class="element-visually-hidden">Black</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=4" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(255, 0, 0);">
										<span class="element-visually-hidden">Red</span>
									</a>
								</li>
								</c:if>
								<c:if test="${dto.mo_num==2 }">
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=1" class="ProductDetailsColorSwitcher__color-link" style="background-color: rgb(0, 0, 0);">
										<span class="element-visually-hidden">Black</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=2" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(255, 255, 255);">
										<span class="element-visually-hidden">White</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
								...
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=3" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(0, 0, 0);">
										<span class="element-visually-hidden">Black</span>
									</a>
								</li>
								<li class="ProductDetailsColorSwitcher__color">
								...
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/ogmsEssenza?mo_num=4" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(255, 0, 0);">
										<span class="element-visually-hidden">Red</span>
									</a>
								</li>
								</c:if>
				...
				<div class="ProductDetailsBodyInformation__description" itemprop="description">
					<div class="FreeHTML">
						<div class="machinepdp_center">
							<div class="machine_freedelivery">
								<strong>머신 구매 시 무료 배송 및 14개입 커피캡슐 샘플팩 증정</strong>
							</div>
						</div>
						<div class="ResponsiveContainer">
								...
								<div class="background-BaristaCreation-mobile">
									<div class="pdpEnhancement">
										...
										<div class="title_line">&nbsp;</div>
						  				<div class="master-origin-description">${dto.mo_atContent2 }</div>
            							<div class="capsule-attribute">
                							<div class="visual-capsule">
                								<img src="${dto.mo_atMachine5 }" alt="에센자 미니 C30 블랙">
                							</div>
...
<!--h3><b>상품 상세 정보</b></h3> <p><b>정격전압, 소비전력, 에너지소비 효율등급</b><br /> AC220V/60Hz/1200W</p> <p><b>동일모델의 출시년월</b><br /> 2017년 6월</p> <p><b>용량/형태</b><br /> 캡슐 6개/물탱크0.6L</p> <p><b>크기</b><br /> 8.4x33x20.4cm(폭x깊이x높이)</p> <p><b>품질보증기준</b><br /> 관련 법 및 소비자 분쟁해결 규정에 따름</p> <p><b>수입자</b><br /> 네스프레소/네슬레코리아 유한책임회사</p> <p><b>제조국</b><br /> 헝가리</p> <p><b>KC인증 필 유무</b><br /> 인증필함(한국산업기술시험원  SW07546-16001)</p> <p><b>전파인증 적합성평가 대상</b><br /> 인증필함(국립전파연구원장 MSIP-REM-FL2-C30)</p> <p><b>A/S 책임자와 전화번호</b><br /> 네스프레소 고객센터 080-734-1111(365일 24시간)</p--></div>
<a class="AccessibleLink DefaultLink ProductDetailsBodyInformation__link DefaultLink--with-right-chevron" href="https://www.nespresso.com/kr/ko/essenza-mini-coffee-machine">
...
<div class="ProductDetailsBodyInformation">
	...
	<div class="ProductDetailsBodyInformation__description">
		<ul class="ProductDetailsBodyInformation__specifications-list">
			<li class="ProductDetailsBodyInformation__specification">무게: 2.3 Kilogram</li>
			<li class="ProductDetailsBodyInformation__specification">탈착식 물탱크: 0.6 Litre</li>
			<li class="ProductDetailsBodyInformation__specification">캡슐 수거함 용량: 6</li>
			<li class="ProductDetailsBodyInformation__specification">압력: 19 bar 기압</li>
			...
			<li class="ProductDetailsBodyInformation__specification">수치 (폭x깊이x높이): 8.4 x 33 x 20.4 cm</li>
		</ul>
		<a class="AccessibleLink DefaultLink ProductDetailsBodyInformation__link DefaultLink--with-right-chevron" href="https://www.nespresso.com/ecom/medias/sys_master/public/10335627837470/UM-NESPRESSO-ESSENZA-MINI-Z3-C-PROD-2017-02-20.pdf">
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceOrder__list">
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogcpIspirazione?co_num=27" 
						data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" 
						data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/12836992745502/Desktop-Standard-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogcpIspirazione?co_num=27" 
					data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
						<div class="ProductPush__name">이스피라치오네 피렌체 아르페지오</div>
					</a>
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogcpIspirazione?co_num=30" 
						data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" 
						data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/12839365705758/Desktop-Standard-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogcpIspirazione?co_num=30" 
					data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
						<div class="ProductPush__name">이스피라치오네 제노바 리반토</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
							<span class="ProductPush__price">₩ <fmt:formatNumber value="590" pattern="#,###" /></span>
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogcpWorldExplo?co_num=20" 
						data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" 
						data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/13702032228382/C-0685-Responsive-Standard-2000x2000-min.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogcpWorldExplo?co_num=20" 
					data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
						<div class="ProductPush__name">케이프타운 엔비보 룽고</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogcpBaristaCre2?co_num=7" 
						data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" 
						data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/13044036010014/C-0600-Responsive-Standard-2000x2000-.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogcpBaristaCre2?co_num=7" 
					data-product-code="7570.40" data-product-item-id="7570.40" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
						<div class="ProductPush__name">바닐라향* 에클레어 커피</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
				...
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						...
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="관련 제품" data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10394871988254/A-0319-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
...
"\u01b6":"z","\u0225":"z","\u0240":"z","\u2c6c":"z","\ua763":"z"});</script><script type="text/javascript" id="" src="//d22xmn10vbouk4.cloudfront.net/b924dea2389e11e6bf0212f5c79d2169.js"></script><script type="text/javascript" id="">ah.wrap(function(){function b(a,c){return(a=location.search.match("(\\?|\x26)("+a+")\x3d([^\x26]+)"))&&(c?a[2]+":":"")+a[3]}ah.affiliation(b("aff")||b("utm_id|gclid|dclid",1)||b("utm_source"))})();</script><script type="text/javascript" id="">ah.wrap(function(b,f,e,m,d,c,n,g,p,k){c=b.fbq=b.fbq||function(){b=arguments;c[m]?c[m].apply(c,b):n.push(b)};b._fbq=b._fbq||c;c.push=c;c.version="2.0";n=c.queue=[];b=f.getElementsByTagName(e)[0];e=f.createElement(e);c.loaded=e.async=!0;e.src="//connect.facebook.net/en_US/fbevents.js";b.parentNode.insertBefore(e,b);ah.facebook={split:function(a){return a?a.split(/\|+/):[]},track:function(a){google_tag_manager["GTM-WJGQVL"].macro(3876)&&console.log("FB Deprecated Track Fired");if(a){a=a.split(";");d="product"!==a[3]?{page_type:d=
a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];c(a[2],a[1],d)}},trackSingle:function(a,h){if(a&&h){a=a.split(";");h=h.split(",");google_tag_manager["GTM-WJGQVL"].macro(3877)&&console.log("FB Data: "+a);google_tag_manager["GTM-WJGQVL"].macro(3878)&&console.log("FB Pixels: "+h);d="product"!==a[3]?{page_type:d=a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];
for(var q="track"==a[2]?"trackSingle":"trackSingleCustom",l=0;l<h.length;l++)c(q,h[l],a[1],d)}}};g=google_tag_manager["GTM-WJGQVL"].macro(3879).split(",");for(p=0;k=+g[p++];)c("set","autoConfig",!1,k),c("init",k);0!=google_tag_manager["GTM-WJGQVL"].macro(3880)&&(c("set","autoConfig",!1,google_tag_manager["GTM-WJGQVL"].macro(3881)),c("init",google_tag_manager["GTM-WJGQVL"].macro(3882)))})(window,document,"script","callMethod");</script><script type="text/javascript" id="">ah.wrap(function(a){a.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(3887),google_tag_manager["GTM-WJGQVL"].macro(3888),{content_name:google_tag_manager["GTM-WJGQVL"].macro(3891),content_subsection:google_tag_manager["GTM-WJGQVL"].macro(3894),content_technology:google_tag_manager["GTM-WJGQVL"].macro(3897),is_live:google_tag_manager["GTM-WJGQVL"].macro(3898),landscape:google_tag_manager["GTM-WJGQVL"].macro(3899),language:google_tag_manager["GTM-WJGQVL"].macro(3900),user_id:google_tag_manager["GTM-WJGQVL"].macro(3901),user_owned_machines:a.split(google_tag_manager["GTM-WJGQVL"].macro(3908))})})(ah.facebook);</script>
...
"getAttribute","offsetParent","getElement","innerWidth","innerHeight","clientWidth","clientHeight","length","click","innerHTML","innerText","promotion","roduct","impression","position","Scroll","gtmTracked","Load","load","DOMContentLoaded","EventListener");</script><script type="text/javascript" id="">ah.wrap(function(g,t,w,x,n,y,z,A,u,B,C,p,h,D,l,c){function E(b,d){var a=g[b]=g[b]||function(){e=arguments;a[x]?a[x].apply(a,e):a.queue.push(e)},e=t.getElementsByTagName(w)[0],f=t.createElement(w);g[b="_"+b]=g[b]||a;a.push=a;a.loaded=!0;a.version="1.0";a.queue=[];a.market=google_tag_manager["GTM-WJGQVL"].macro(3949);a.language=google_tag_manager["GTM-WJGQVL"].macro(3950);a.channel=google_tag_manager["GTM-WJGQVL"].macro(3951);f.async=!0;f.src="//www."+("true"===google_tag_manager["GTM-WJGQVL"].macro(3952)?"":"vst.")+"contact.nespresso.com/apps.php?a\x3dcalleo-"+d+(/(msie [1-9]|Trident\/7\.0)/i.test(navigator.userAgent)?
"\x26v\x3die":"");e.parentNode.insertBefore(f,e)}function F(b,d,a,e){a&&a(l);c=function(f,G,q,m,r){m&&m(l);m=m||a;q=q||f.replace(/e?$/,"ed");g[n+b]("add"+b+"Listener",f[z](),D[r=d+q]=y(function(I,J,H,k,v){k=G||"Click";k={eventAction:"Source:"+H+";Action:"+k,eventLabel:q,calleoChatType:d,nonInteraction:+!!G};for(v in l)k[v]=l[v];k[r]=1;m&&m(k,H,I,J);gtmDataObject.push(k)}));l[r=h+r]=e}}l={event:h=n+u,eventRaisedBy:"GTM"};D=ah[h]={};"true"===google_tag_manager["GTM-WJGQVL"].macro(3953)+""&&(E(h,"livechat"),F(u,A),c(C),c("Start"),
c("End"),c("Cancel"),c("Rating",0,"Reviewed",function(b,d){function a(e,f){b[h+A+"Review"+e]=d&&(f||["","Very good","Good","Fairly good","Not acceptable"])[+d[e[z]()]]}a("Delay");a("Quality");a("Satisfaction",["No","Yes"])}),t.addEventListener("click",y(function(b,d){d=b.target;/(^|\s)open-live-chat(\s|$)/.test(d.id+" "+d.className)&&(b.preventDefault(),g[h]("start"+u))})));if("true"===google_tag_manager["GTM-WJGQVL"].macro(3954)+""){E(n+p,"triggers");if(c=google_tag_manager["GTM-WJGQVL"].macro(3955))g[n+p]("NessclubId",c);F(p,B,function(b,d,
...
e&&Array.prototype.forEach.call(document.querySelectorAll(c),function(a){k.test(a.className)||(a.className+=a.className?" "+e:e)}),c}var d,e,k;ah.sessioncam={hide_pii:g,init:function(e,b){function c(){g(b,google_tag_manager["GTM-WJGQVL"].macro(3956),"ignorechanges");g(b,google_tag_manager["GTM-WJGQVL"].macro(3957),"hidetext");var a=document.getElementsByTagName("script")[0],c=document.createElement("script");c.async=!0;c.src="//d2oh4tlt9mrke9.cloudfront.net/Record/js/sessioncam.recorder.js";a.parentNode.insertBefore(c,a)}var a=ah.extend({Channel:google_tag_manager["GTM-WJGQVL"].macro(3958),
DeviceType:google_tag_manager["GTM-WJGQVL"].macro(3959),IsMobileSite:0,Landscape:google_tag_manager["GTM-WJGQVL"].macro(3960),LanguageCode:google_tag_manager["GTM-WJGQVL"].macro(3961),PrimaryCategory:google_tag_manager["GTM-WJGQVL"].macro(3962),Technology:google_tag_manager["GTM-WJGQVL"].macro(3963),UserIsLoggedIn:+("true"===google_tag_manager["GTM-WJGQVL"].macro(3964)),UserID:google_tag_manager["GTM-WJGQVL"].macro(3965)},e);b=b||google_tag_manager["GTM-WJGQVL"].macro(3978);sessioncamConfiguration={SessionCamHostname:location.href.replace(/^([^\/]+\/\/[^\/]+)\/.*$/,"$1."+google_tag_manager["GTM-WJGQVL"].macro(3980)),SessionCamPath:a.PrimaryCategory,SessionCamPageName:google_tag_manager["GTM-WJGQVL"].macro(3981)+":"+b,customDataObjects:Object.keys(a).map(function(b){return[{key:b,
value:a[b]}]}),elementsToRemove:g(b,google_tag_manager["GTM-WJGQVL"].macro(3982))};var d=document.readyState;if("complete"===d||"loading"!==d&&!document.documentElement.doScroll)setTimeout(ah.wrap(c));else{var f=ah.wrap(function(){f&&(document.removeEventListener("DOMContentLoaded",f),window.removeEventListener("load",f),f=0,c())});document.addEventListener("DOMContentLoaded",f);window.addEventListener("load",f)}}}})(eval);</script><script type="text/javascript" id="">ah.wrap(function(){ah.sessioncam.init()})();</script><script type="text/javascript" id="">var pageViewDebug=false&&google_tag_manager["GTM-WJGQVL"].macro(3983);var pageTech=google_tag_manager["GTM-WJGQVL"].macro(3986);var pageSub1=google_tag_manager["GTM-WJGQVL"].macro(3989);var pagePath=google_tag_manager["GTM-WJGQVL"].macro(3990);var isMachinePage=pageSub1==="machines";var isCapsulePage=pageSub1==="coffee";var isAccessoryPage=pageSub1==="accessories"||pagePath.indexOf("accessories")!=-1;var isVertuoPage=pagePath.indexOf("vertuo")!==-1||pageTech==="vertuoline";var isOriginalPage=pageTech==="originalline"&&!isVertuoPage||!isVertuoPage;var isComboSubscriptionPage=pageSub1==="combo-subscription";
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script><script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(3995);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script><script type="text/javascript" id="">_mpulsePageGroup=function(c){var a=c.page.pageInfo.breadcrumbUID.split(":"),b=function(){if("customEvent"===google_tag_manager["GTM-WJGQVL"].macro(5009)&&"other"!==google_tag_manager["GTM-WJGQVL"].macro(5010))return google_tag_manager["GTM-WJGQVL"].macro(5011);switch(a[0]){case "account":return a[0]+"-"+(a[1]||"other");case "checkister":return a[0]+"-"+a[3];case "cart":case "shopping bag":return"checkout-shopping-bag";case "multi-step-checkout-summary-page":return"checkout-multi-step-checkout-summary-page";case "checkout":return"shopping bag"===a[3]?"checkout-shopping-bag":
a[0]+"-"+a[3];case "shop":a[0]="catalog";case "catalog":return/plp|pdp/.test(a[3])?/_plp/.test(c.page.pageInfo.pageName)?a[0]+"-plp":a[0]+"-pdp":a[0]+"-other";case "guest-checkout":return a[0]+"-"+a[3];case "login":return a[0]+"-"+a[3];case "registration-personal-info-page":return"registration";case "store-locator":return"locator";case "services-site-internet-nespresso":return"services";case "personal-info-page":case "brand":case "content":case "country-language":case "home":case "legal":case "locator":case "local-page":case "club":case "maintenance":case "registration":case "landing-page":case "services":case "standalone":case "support":return a[0];
case "page":return"unsubscribe"===a[3]?"page-unsubscribe":a[0]+"-"+a[1]}return"other"}();b=b.replace(/[^0-9a-z-]/g,"-").replace(/-+/g,"-");b=b.split("-");b[0]==b[1]&&(b=b.slice(1));return b.join("-")};mpulsePageGroup=function(){try{return _mpulsePageGroup(padl)}catch(c){}};mpulseBreadcrumbUIDGetter=function(c){return function(){try{return padl.page.pageInfo.breadcrumbUID.split(":")[c]}catch(a){}}};mpulseBreadcrumbUIDType=mpulseBreadcrumbUIDGetter(0);mpulseBreadcrumbUIDCategory=mpulseBreadcrumbUIDGetter(1);
mpulseBreadcrumbUIDSubCategory=mpulseBreadcrumbUIDGetter(2);mpulseBreadcrumbUIDName=mpulseBreadcrumbUIDGetter(3);mpulseBreadcrumbUIDTechnology=mpulseBreadcrumbUIDGetter(4);</script><script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5471),google_tag_manager["GTM-WJGQVL"].macro(5472),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(5473)],content_name:google_tag_manager["GTM-WJGQVL"].macro(5474),currency:google_tag_manager["GTM-WJGQVL"].macro(5475)||google_tag_manager["GTM-WJGQVL"].macro(5476),is_live:google_tag_manager["GTM-WJGQVL"].macro(5477),landscape:google_tag_manager["GTM-WJGQVL"].macro(5478),language:google_tag_manager["GTM-WJGQVL"].macro(5479),num_items:google_tag_manager["GTM-WJGQVL"].macro(5481),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(5482)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(5483)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(5484)),user_id:google_tag_manager["GTM-WJGQVL"].macro(5485),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(5492)),
value:google_tag_manager["GTM-WJGQVL"].macro(5493)||0})})(ah.facebook);</script><script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5534),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5535),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5536),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5537).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5538).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5539).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5540)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5541)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5542)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5543)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5544))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5545)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5546)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5547))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5548)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5549)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5550))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5551)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5552)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5553)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5554))}}),pushedGroupTagStrings.push(groupTagString));</script><script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5560),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5561),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5562)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5563),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5564)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
