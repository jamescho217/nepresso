...
<meta name="keywords" content="버츄오에스프레소, 버츄오컬렉션, 액세서리, 커피컵, 네스프레소">
<meta name="description"
	content="높이가 다른 크레마의 버츄오 커피를 즐길 수 있도록 최적으로 고안된 강화유리 소재의 에스프레소잔(80ml) 2개와 컵받침 그리고 스푼 세트(12cm).">
<meta property="og:title" content="버츄오 에스프레소 | 버츄오 컬렉션 | 네스프레소">
<meta property="og:url"
	content="https://www.nespresso.com:443/kr/ko/order/accessories/original/vertuo-espresso-set">
<meta property="og:description"
	content="높이가 다른 크레마의 버츄오 커피를 즐길 수 있도록 최적으로 고안된 강화유리 소재의 에스프레소잔(80ml) 2개와 컵받침 그리고 스푼 세트(12cm).">
<meta property="og:image"
	content="https://www.nespresso.com:443/ecom/medias/sys_master/public/9450570154014/A-0234-main-684x378.jpg">
<title>${dto.ao_modelName } | 액세서리 | 네스프레소</title>

<link rel="canonical"
	href="https://www.nespresso.com/kr/ko/order/accessories/original/vertuo-espresso-set">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:accessories::pdp-accessories-accessorie-name:originalline","pageName":"Accessories PDP","primaryCategory":"ACCESSORY","secondaryCategory":["Vertuo Collection"],"segmentBusiness":"B2C","technology":["original","vertuo"],"type":"","variant":""}}};
...
<iframe target="_self" title="SaleCycle"
	src="https://s.salecycle.com/receiver.html?sc_frame_id=89c1d5a0-4133-4337-a2d1-dc87315461c1"
	style="display: none; height: 0px; width: 0px;"></iframe>
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624940548770&amp;cv=9&amp;fst=1624940548770&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059651&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=9&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6n0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DAccessories%3Becomm_pagetype%3Dproduct%3Becomm_prodid%3D3711R%2F2%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal%2Fvertuo-espresso-set&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal&amp;tiba=%EB%B2%84%EC%B8%84%EC%98%A4%20%EC%97%90%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%7C%20%EB%B2%84%EC%B8%84%EC%98%A4%20%EC%BB%AC%EB%A0%89%EC%85%98%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624940548790&amp;cv=9&amp;fst=1624940548790&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=9&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6n0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DAccessories%3Becomm_pagetype%3Dcategory%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal%2Fvertuo-espresso-set&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal&amp;tiba=%EB%B2%84%EC%B8%84%EC%98%A4%20%EC%97%90%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%7C%20%EB%B2%84%EC%B8%84%EC%98%A4%20%EC%BB%AC%EB%A0%89%EC%85%98%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<link id="dnsprefetchlink" rel="dns-prefetch"
	href="//3reupydijk7q6yg2uaba-f-7255fe7d0-clientnsv4-s.akamaihd.net">
</head>

<body class="livechat-collapsed">
	<!---->
	<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">버츄오
		에스프레소 | 버츄오 컬렉션 | 네스프레소</h2>
...
@media screen and (max-width: 767px) {
	...
	<div
		id="respPromotionBannersBlockAccessories_PDP-8802977392400-92c29de7-7e0b-4aa6-82d4-7b436d68161c"
		class="crema-ui-container "></div>
	<!-- <script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockAccessories_PDP-8802977392400-92c29de7-7e0b-4aa6-82d4-7b436d68161c","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockAccessories_PDP-8802977392400-d86fd5fd-8705-4103-8b89-b901940ce169","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockController/ecommerce-data?componentUid=respPromotionBannersBlockAccessories_PDP"}}});
            </script> -->
	<div
		id="respProductDetailPDPAccessory-8797707577104-5528d195-d8dd-45b2-94f2-551a9bb52f8d"
		class="crema-ui-container ">
		<div class="ProductDetails" itemtype="http://schema.org/Product"
			itemscope="" id="ProductDetail__erp.kr.b2c/prod/3711R/2">
			<h2 class="VisuallyHidden">버츄오 에스프레소 컵 세트</h2>
					...
					<div class="ProductDetails__information">
						...
						<div>
							...
							<meta itemprop="priceCurrency" content="KRW">
								<meta itemprop="price" content="33000"></span>
...
"\u01b6":"z","\u0225":"z","\u0240":"z","\u2c6c":"z","\ua763":"z"});</script>
	...
	<script type="text/javascript" id="">ah.wrap(function(b,f,e,m,d,c,n,g,p,k){c=b.fbq=b.fbq||function(){b=arguments;c[m]?c[m].apply(c,b):n.push(b)};b._fbq=b._fbq||c;c.push=c;c.version="2.0";n=c.queue=[];b=f.getElementsByTagName(e)[0];e=f.createElement(e);c.loaded=e.async=!0;e.src="//connect.facebook.net/en_US/fbevents.js";b.parentNode.insertBefore(e,b);ah.facebook={split:function(a){return a?a.split(/\|+/):[]},track:function(a){google_tag_manager["GTM-WJGQVL"].macro(3678)&&console.log("FB Deprecated Track Fired");if(a){a=a.split(";");d="product"!==a[3]?{page_type:d=
a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];c(a[2],a[1],d)}},trackSingle:function(a,h){if(a&&h){a=a.split(";");h=h.split(",");google_tag_manager["GTM-WJGQVL"].macro(3679)&&console.log("FB Data: "+a);google_tag_manager["GTM-WJGQVL"].macro(3680)&&console.log("FB Pixels: "+h);d="product"!==a[3]?{page_type:d=a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];
for(var q="track"==a[2]?"trackSingle":"trackSingleCustom",l=0;l<h.length;l++)c(q,h[l],a[1],d)}}};g=google_tag_manager["GTM-WJGQVL"].macro(3681).split(",");for(p=0;k=+g[p++];)c("set","autoConfig",!1,k),c("init",k);0!=google_tag_manager["GTM-WJGQVL"].macro(3682)&&(c("set","autoConfig",!1,google_tag_manager["GTM-WJGQVL"].macro(3683)),c("init",google_tag_manager["GTM-WJGQVL"].macro(3684)))})(window,document,"script","callMethod");</script>
	<script type="text/javascript" id="">ah.wrap(function(a){a.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(3689),google_tag_manager["GTM-WJGQVL"].macro(3690),{content_name:google_tag_manager["GTM-WJGQVL"].macro(3693),content_subsection:google_tag_manager["GTM-WJGQVL"].macro(3696),content_technology:google_tag_manager["GTM-WJGQVL"].macro(3699),is_live:google_tag_manager["GTM-WJGQVL"].macro(3700),landscape:google_tag_manager["GTM-WJGQVL"].macro(3701),language:google_tag_manager["GTM-WJGQVL"].macro(3702),user_id:google_tag_manager["GTM-WJGQVL"].macro(3703),user_owned_machines:a.split(google_tag_manager["GTM-WJGQVL"].macro(3710))})})(ah.facebook);</script>
...
"getAttribute","offsetParent","getElement","innerWidth","innerHeight","clientWidth","clientHeight","length","click","innerHTML","innerText","promotion","roduct","impression","position","Scroll","gtmTracked","Load","load","DOMContentLoaded","EventListener");</script>
	<script type="text/javascript" id="">ah.wrap(function(g,t,w,x,n,y,z,A,u,B,C,p,h,D,l,c){function E(b,d){var a=g[b]=g[b]||function(){e=arguments;a[x]?a[x].apply(a,e):a.queue.push(e)},e=t.getElementsByTagName(w)[0],f=t.createElement(w);g[b="_"+b]=g[b]||a;a.push=a;a.loaded=!0;a.version="1.0";a.queue=[];a.market=google_tag_manager["GTM-WJGQVL"].macro(3751);a.language=google_tag_manager["GTM-WJGQVL"].macro(3752);a.channel=google_tag_manager["GTM-WJGQVL"].macro(3753);f.async=!0;f.src="//www."+("true"===google_tag_manager["GTM-WJGQVL"].macro(3754)?"":"vst.")+"contact.nespresso.com/apps.php?a\x3dcalleo-"+d+(/(msie [1-9]|Trident\/7\.0)/i.test(navigator.userAgent)?
"\x26v\x3die":"");e.parentNode.insertBefore(f,e)}function F(b,d,a,e){a&&a(l);c=function(f,G,q,m,r){m&&m(l);m=m||a;q=q||f.replace(/e?$/,"ed");g[n+b]("add"+b+"Listener",f[z](),D[r=d+q]=y(function(I,J,H,k,v){k=G||"Click";k={eventAction:"Source:"+H+";Action:"+k,eventLabel:q,calleoChatType:d,nonInteraction:+!!G};for(v in l)k[v]=l[v];k[r]=1;m&&m(k,H,I,J);gtmDataObject.push(k)}));l[r=h+r]=e}}l={event:h=n+u,eventRaisedBy:"GTM"};D=ah[h]={};"true"===google_tag_manager["GTM-WJGQVL"].macro(3755)+""&&(E(h,"livechat"),F(u,A),c(C),c("Start"),
c("End"),c("Cancel"),c("Rating",0,"Reviewed",function(b,d){function a(e,f){b[h+A+"Review"+e]=d&&(f||["","Very good","Good","Fairly good","Not acceptable"])[+d[e[z]()]]}a("Delay");a("Quality");a("Satisfaction",["No","Yes"])}),t.addEventListener("click",y(function(b,d){d=b.target;/(^|\s)open-live-chat(\s|$)/.test(d.id+" "+d.className)&&(b.preventDefault(),g[h]("start"+u))})));if("true"===google_tag_manager["GTM-WJGQVL"].macro(3756)+""){E(n+p,"triggers");if(c=google_tag_manager["GTM-WJGQVL"].macro(3757))g[n+p]("NessclubId",c);F(p,B,function(b,d,
...
e&&Array.prototype.forEach.call(document.querySelectorAll(c),function(a){k.test(a.className)||(a.className+=a.className?" "+e:e)}),c}var d,e,k;ah.sessioncam={hide_pii:g,init:function(e,b){function c(){g(b,google_tag_manager["GTM-WJGQVL"].macro(3758),"ignorechanges");g(b,google_tag_manager["GTM-WJGQVL"].macro(3759),"hidetext");var a=document.getElementsByTagName("script")[0],c=document.createElement("script");c.async=!0;c.src="//d2oh4tlt9mrke9.cloudfront.net/Record/js/sessioncam.recorder.js";a.parentNode.insertBefore(c,a)}var a=ah.extend({Channel:google_tag_manager["GTM-WJGQVL"].macro(3760),
DeviceType:google_tag_manager["GTM-WJGQVL"].macro(3761),IsMobileSite:0,Landscape:google_tag_manager["GTM-WJGQVL"].macro(3762),LanguageCode:google_tag_manager["GTM-WJGQVL"].macro(3763),PrimaryCategory:google_tag_manager["GTM-WJGQVL"].macro(3764),Technology:google_tag_manager["GTM-WJGQVL"].macro(3765),UserIsLoggedIn:+("true"===google_tag_manager["GTM-WJGQVL"].macro(3766)),UserID:google_tag_manager["GTM-WJGQVL"].macro(3767)},e);b=b||google_tag_manager["GTM-WJGQVL"].macro(3780);sessioncamConfiguration={SessionCamHostname:location.href.replace(/^([^\/]+\/\/[^\/]+)\/.*$/,"$1."+google_tag_manager["GTM-WJGQVL"].macro(3782)),SessionCamPath:a.PrimaryCategory,SessionCamPageName:google_tag_manager["GTM-WJGQVL"].macro(3783)+":"+b,customDataObjects:Object.keys(a).map(function(b){return[{key:b,
value:a[b]}]}),elementsToRemove:g(b,google_tag_manager["GTM-WJGQVL"].macro(3784))};var d=document.readyState;if("complete"===d||"loading"!==d&&!document.documentElement.doScroll)setTimeout(ah.wrap(c));else{var f=ah.wrap(function(){f&&(document.removeEventListener("DOMContentLoaded",f),window.removeEventListener("load",f),f=0,c())});document.addEventListener("DOMContentLoaded",f);window.addEventListener("load",f)}}}})(eval);</script>
	<script type="text/javascript" id="">ah.wrap(function(){ah.sessioncam.init()})();</script>
	<script type="text/javascript" id="">var pageViewDebug=false&&google_tag_manager["GTM-WJGQVL"].macro(3785);var pageTech=google_tag_manager["GTM-WJGQVL"].macro(3788);var pageSub1=google_tag_manager["GTM-WJGQVL"].macro(3791);var pagePath=google_tag_manager["GTM-WJGQVL"].macro(3792);var isMachinePage=pageSub1==="machines";var isCapsulePage=pageSub1==="coffee";var isAccessoryPage=pageSub1==="accessories"||pagePath.indexOf("accessories")!=-1;var isVertuoPage=pagePath.indexOf("vertuo")!==-1||pageTech==="vertuoline";var isOriginalPage=pageTech==="originalline"&&!isVertuoPage||!isVertuoPage;var isComboSubscriptionPage=pageSub1==="combo-subscription";
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script>
	<script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(3795);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script>
	<script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(4977),google_tag_manager["GTM-WJGQVL"].macro(4978),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(4979)],content_name:google_tag_manager["GTM-WJGQVL"].macro(4980),currency:google_tag_manager["GTM-WJGQVL"].macro(4981)||google_tag_manager["GTM-WJGQVL"].macro(4982),is_live:google_tag_manager["GTM-WJGQVL"].macro(4983),landscape:google_tag_manager["GTM-WJGQVL"].macro(4984),language:google_tag_manager["GTM-WJGQVL"].macro(4985),num_items:google_tag_manager["GTM-WJGQVL"].macro(4987),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(4988)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(4989)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(4990)),user_id:google_tag_manager["GTM-WJGQVL"].macro(4991),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(4998)),
value:google_tag_manager["GTM-WJGQVL"].macro(4999)||0})})(ah.facebook);</script>
	<script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5040),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5041),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5042),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5043).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5044).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5045).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5046)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5047)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5048)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5049)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5050))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5051)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5052)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5053))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5054)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5055)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5056))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5057)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5058)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5059)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5060))}}),pushedGroupTagStrings.push(groupTagString));</script>
	<script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5065),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5066),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5067)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5068),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5069)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
...
d.id});0<b.length&&(e.automl.productEventDetail.productDetails=b,gtmDataObject=window.gtmDataObject||[],gtmDataObject.push(e))}):(gtmDataObject=window.gtmDataObject||[],gtmDataObject.push(e))})();</script>
	...
	<script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(8960),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(8961),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(8962),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(8963).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(8964).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(8965).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(8966)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(8967)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(8968)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{impressions:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(8969)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(8970))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(8971)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{impressions:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(8972)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(8973))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(8974)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{impressions:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(8975)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(8976))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(8977)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(8978)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{impressions:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(8979)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(8980))}}),pushedGroupTagStrings.push(groupTagString));</script>
	<script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(8985),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(8986),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(8987)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(8988),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(8989)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
b||"";return window.napi.catalog().getProduct(b.id).then(function(d){if("Others"===d.category)return{id:"Subscription"};var c={categoricalFeatures:{},numericalFeatures:{}};d.capsuleProperties&&(c.numericalFeatures.intensity={value:[d.capsuleProperties.intensity]});return Promise.all(d.supercategories.map(function(g){return window.napi.catalog().getCategory(g)})).then(function(g){var h=[],k=[],l=[],m=[],n=[],p=[],q=[],r=[],t=[],u=[];g.forEach(function(a){"MachineTechnology"===a.type?m.push(a.code):
0===a.code.indexOf("products-")?n.push(a.code.replace("products-","")):/(machine|capsule)-cupSize-/.test(a.code)?h.push(a.code.replace(/(machine|capsule)-cupSize-/,"")):/(machine|capsule)-range-/.test(a.code)?p.push(a.code.replace(/(machine|capsule)-range-/,"")):0===a.code.indexOf("capsule-aromatic-")?k.push(a.code.replace("capsule-aromatic-","")):0===a.code.indexOf("recipe-capsule-aromatic-")?l.push(a.code.replace("recipe-capsule-aromatic-","")):0===a.code.indexOf("machine-keyFeature-")?t.push(a.code.replace("machine-keyFeature-",
"")):0===a.code.indexOf("machine-color-")?u.push(a.code.replace("machine-color-","")):0===a.code.indexOf("accessory-collection")?q.push(a.code.replace("accessory-collection-","")):0===a.code.indexOf("accessory-usage")&&r.push(a.code.replace("accessory-usage-",""))});m.length&&(c.categoricalFeatures.technologies={value:m});n.length&&(c.categoricalFeatures.productTypes={value:n});h.length&&(c.categoricalFeatures.cupSizes={value:h});p.length&&(c.categoricalFeatures.ranges={value:p});k.length&&(c.categoricalFeatures.capsulesAromatics=
{value:k});l.length&&(c.categoricalFeatures.recipeCapsules={value:l});t.length&&(c.categoricalFeatures.machineKeyFeatures={value:t});u.length&&(c.categoricalFeatures.machineColors={value:u});q.length&&(c.categoricalFeatures.accessoryCollections={value:q});r.length&&(c.categoricalFeatures.accessoryUsages={value:r});return{id:b.id,quantity:b.quantity,displayPrice:b.displayPrice,currencyCode:google_tag_manager["GTM-WJGQVL"].macro(8990),itemAttributes:c}})})})).then(function(b){b=b.filter(function(d){return"Subscription"!==
d.id});0<b.length&&(e.automl.productEventDetail.productDetails=b,gtmDataObject=window.gtmDataObject||[],gtmDataObject.push(e))}):(gtmDataObject=window.gtmDataObject||[],gtmDataObject.push(e))})();</script>
</body>
</html>