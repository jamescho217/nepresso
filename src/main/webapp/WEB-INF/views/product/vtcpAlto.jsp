...
<meta name="keywords" content="네스프레소, 네스프레소캡슐,&nbsp;네스프레소커피머신, 버츄오플러스, 하프 카페나토, 네스프레소버츄오캡슐커피추천,">
<meta name="description" content="브라질과 에티오피아산 아라비카 블렌드인 하프 카페나토 버츄오 커피는 카페인 함량을 절반으로 줄인 벨벳처럼 부드럽고 비스킷향이 나는 커피">
<meta property="og:title" content="하프 카페나토 | 롱 블랙 하프 디카페인 버츄오 커피 캡슐 | 네스프레소">
<meta property="og:url" content="https://www.nespresso.com:443/kr/ko/order/capsules/vertuo/half-caffeinato-vertuo-coffee-capsules">
<meta property="og:description" content="브라질과 에티오피아산 아라비카 블렌드인 하프 카페나토 버츄오 커피는 카페인 함량을 절반으로 줄인 벨벳처럼 부드럽고 비스킷향이 나는 커피">
<meta property="og:image" content="https://www.nespresso.com/ecom/medias/sys_master/public/10433262092318/Halfcaffeinato-PDP-.jpg">
<title>${dto.cv_modelName1 } | 버츄오 커피 캡슐 | 네스프레소</title>
<link rel="canonical" href="https://www.nespresso.com/kr/ko/order/capsules/vertuo/half-caffeinato-vertuo-coffee-capsules">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:coffee::pdp-coffee-capsule-name:originalline","pageName":"Capsules PDP","primaryCategory":"CAPSULE","secondaryCategory":["Mug","Mug"],"segmentBusiness":"B2C","technology":["vertuo"],"type":"","variant":""}}};
...
<noscript>
  ...
  <script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-08260aab-e5ea-49c8-828e-7b5c561c5b45","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<div id="respPromotionBannersBlockCapsules_PDP-8801697212176-0550ad0f-7bd5-4227-978f-5a1c59efdf30" class="crema-ui-container "></div>
<script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockCapsules_PDP-8801697212176-0550ad0f-7bd5-4227-978f-5a1c59efdf30","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockCapsules_PDP-8801697212176-d7488b74-6b61-407c-bba1-7209e718f69d","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockControllerhttps://www.nespresso.com/ecommerce-data?componentUid=respPromotionBannersBlockCapsules_PDP"}}});
</script>
...
$(document).keyup(function(e) {
    if (e.keyCode == 27) {
        ...
        <div id="respProductDetailPDPCapsule-8797707544336-6a65c100-f4cb-4939-a067-9100b0fa5847" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/7367.40">
        								...
        								<div class="ProductDetails__col-data">
        									<ul class="ProductDetails__cupSize content">
        										<li class="ProductDetails__cupSize li ProductDetails__cup-active">
        											<img src="${dto.cv_cupSize1 }" border="0">
        										</li>
        									</ul>
        								</div>
        							</div>
        		...
        		<div>
        			<div class="ProductDetailsAttributes">
        				...
        				<ul class="ResponsiveContainer ProductDetailsAttributes__attributesList"></ul>
        			</div>
        			<div class="ProductDetailsBody">
        				<h3 class="VisuallyHidden">상품 설명</h3>
        				<div class="ResponsiveContainer">
        					<div class="ProductDetailsBodyInformation">
        						<div class="ProductDetailsBodyInformation__title">디카페인 커피가 절반 블렌딩 된 비스킷 향의 크리미한 커피</div>
        						<div class="ProductDetailsBodyInformation__description" itemprop="description">
        							<div class="FreeHTML"><!-- PDP RESPONSIVE Barista Creation -->
										<div class="ResponsiveContainer">
											...
											<div class="background-BaristaCreation" style="background-image: url(${dto.cv_bg})">
												<div class="background-BaristaCreation-mobile">
													<div class="pdpEnhancement">
														<div class="gradient">
															<div class="master-origin-logo">
																<img src="${dto.cv_bigName1 }" width="95%" alt="Half Caffeinato">
															</div>
															<div class="master-origin-subtitle">${dto.cv_bigName2 }</div>
															<div style="display: block;width: 10%;border-top: 2px solid white;margin: 0 auto;">&nbsp;</div>
  															<div class="master-origin-description">${dto.cv_atContent1 }</div><br>
															<div class="capsule-attribute">
																<div class="visual-capsule">
															    	<img src="${dto.cv_aticleCoffee2 }" alt="Decaffeinato">
															   	</div>
															    <div class="attributes">
															    	<div class="left">
															        	<ul>
															            	<li class="bitterness">
															            		<h3 class="gradient-grey"><!--Text to localize-BEGIN-->${dto.cv_bitterness1 }<!--Text to localize-END--></h3>
															            		<span class="white-square">${dto.cv_bitterness2 }</span>
															            	</li>
															 				<li class="acidity">
															 					<h3 class="gradient-grey"><!--Text to localize-BEGIN-->${dto.cv_acidity1 }<!--Text to localize-END--></h3>
															 					<span class="white-square">${dto.cv_acidity2 }</span>
															 				</li>
															            </ul>
															        </div>
                        											<div class="right">
										                                 <ul>
										                                 	<li class="body">
										                                 		<h3 class="gradient-grey"><!--Text to localize-BEGIN-->${dto.cv_body1 }<!--Text to localize-END--></h3>
										                                 		<span class="white-square">${dto.cv_body2 }</span>
										                                 	</li>
										                                  	<li class="roasting">
										                                  		<h3 class="gradient-grey"><!--Text to localize-BEGIN-->${dto.cv_roastiness1 }<!--Text to localize-END--></h3>
										                                  		<span class="white-square">${dto.cv_roastiness2 }</span>
										                                  	</li>
										                                 </ul>
											                        </div>
											                	</div>                        
											                    <div class="intensity">
											                    	<strong><!--Text to localize-BEGIN-->강도<br/>${dto.cv_intensity }<!--Text to localize-END--></strong><br></div>
											             		</div>                        
																<div class="shape-color-white">
													                <div class="cup-aromatic">
													                	<li>
													                		<span><!--Text to localize-BEGIN-->${dto.cv_atContent2 }</span>
													                	</li>
													                	<li>
													                		<span><!--Text to localize-BEGIN-->${dto.cv_atContent3 }<!--Text to localize-END--></span>
													                	</li>
                														<div class="position-add-to-bag">
                															<div class="add-to-bag" data-product-id="7367.40" data-button-size="large" data-initialized="true">
                																<div class="AddToBagButton__container">
                																	<div id="AddToBagButton__button-CremaComponentId-2">
                																		<button class="AddToBagButton AddToBagButtonLarge" data-focus-id="AddToBagButton__button-CremaComponentId-2">
                																			...
                																			<span class="VisuallyHidden">고객님의 장바구니에 하프 카페나토 가 없습니다. 구매를 원하시면, 해당 상품을 담으세요.</span>
...
.cup-aromatic li {color:#fff!important;}
.ProductDetailsBodyInformation:nth-child(1) .ProductDetailsBodyInformation__title {display:none;}
  
.background-BaristaCreation {
    background: url(https://www.nespresso.com/ecom/medias/sys_master/public/12715653627934/PDPBackground-HalfCaffeinato.png) center top no-repeat black;
    background-repeat: no-repeat;
    background-position: center top;
}
.cup-aromatic li:nth-child(1) {
    padding-top: 20px;
}
 .cup-aromatic li {
    padding-top: 10px;
...
$( document ).ready( function() {
	...
	<div class="ProductDetailsBodyInformation">
		...
		<div class="ProductDetailsBodyInformation__description ProductDetailsBodyInformation__description--isCollapsed" style="display: none;">
			<div>네스프레소 커피머신과 함께 사용 가능한 커피 캡슐 10개</div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceDisplay__list">
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpMug2?cv_num=23">
					<span class="VisuallyHidden">멜로지오</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10386860146718/C-0106-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">멜로지오</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
				<a class="AccessibleLink ProductDetailsReferenceDisplay__link track-product-click" data-product-code="7568.40" 
				data-product-item-id="7568.40" data-product-section="유사한 아로마" data-product-position="1" 
				href="/nespresso/product/vtcpMug2?cv_num=24">
					<span class="VisuallyHidden">엘바지오</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10386860343326/C-0107-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">엘바지오</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
				<a class="AccessibleLink ProductDetailsReferenceDisplay__link track-product-click" data-product-code="7568.40" 
				data-product-item-id="7568.40" data-product-section="유사한 아로마" data-product-position="1" 
				href="/nespresso/product/vtcpMug2?cv_num=26">
					<span class="VisuallyHidden">지오니오</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10611414138910/C-0208-Giornio-2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">지오니오</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpMug2?cv_num=25">
					<span class="VisuallyHidden">솔레리오</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10386863292446/C-0207-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">솔레리오</div>
				</a>
			</li>
		</ul>
	</div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceOrder__list">
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogaccView?ao_num=25" 
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10398991777822/A-0351-VIEW-Coffee-Mug-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogaccView?ao_num=25" 
					data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" 
					data-product-position="1">
						<div class="ProductPush__name">뷰 커피 머그 컵 세트</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
...
"\u01b6":"z","\u0225":"z","\u0240":"z","\u2c6c":"z","\ua763":"z"});</script><script type="text/javascript" id="" src="//d22xmn10vbouk4.cloudfront.net/b924dea2389e11e6bf0212f5c79d2169.js"></script><script type="text/javascript" id="">ah.wrap(function(){function b(a,c){return(a=location.search.match("(\\?|\x26)("+a+")\x3d([^\x26]+)"))&&(c?a[2]+":":"")+a[3]}ah.affiliation(b("aff")||b("utm_id|gclid|dclid",1)||b("utm_source"))})();</script><script type="text/javascript" id="">ah.wrap(function(b,f,e,m,d,c,n,g,p,k){c=b.fbq=b.fbq||function(){b=arguments;c[m]?c[m].apply(c,b):n.push(b)};b._fbq=b._fbq||c;c.push=c;c.version="2.0";n=c.queue=[];b=f.getElementsByTagName(e)[0];e=f.createElement(e);c.loaded=e.async=!0;e.src="//connect.facebook.net/en_US/fbevents.js";b.parentNode.insertBefore(e,b);ah.facebook={split:function(a){return a?a.split(/\|+/):[]},track:function(a){google_tag_manager["GTM-WJGQVL"].macro(4143)&&console.log("FB Deprecated Track Fired");if(a){a=a.split(";");d="product"!==a[3]?{page_type:d=
a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];c(a[2],a[1],d)}},trackSingle:function(a,h){if(a&&h){a=a.split(";");h=h.split(",");google_tag_manager["GTM-WJGQVL"].macro(4144)&&console.log("FB Data: "+a);google_tag_manager["GTM-WJGQVL"].macro(4145)&&console.log("FB Pixels: "+h);d="product"!==a[3]?{page_type:d=a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];
for(var q="track"==a[2]?"trackSingle":"trackSingleCustom",l=0;l<h.length;l++)c(q,h[l],a[1],d)}}};g=google_tag_manager["GTM-WJGQVL"].macro(4146).split(",");for(p=0;k=+g[p++];)c("set","autoConfig",!1,k),c("init",k);0!=google_tag_manager["GTM-WJGQVL"].macro(4147)&&(c("set","autoConfig",!1,google_tag_manager["GTM-WJGQVL"].macro(4148)),c("init",google_tag_manager["GTM-WJGQVL"].macro(4149)))})(window,document,"script","callMethod");</script><script type="text/javascript" id="">ah.wrap(function(a){a.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(4154),google_tag_manager["GTM-WJGQVL"].macro(4155),{content_name:google_tag_manager["GTM-WJGQVL"].macro(4158),content_subsection:google_tag_manager["GTM-WJGQVL"].macro(4161),content_technology:google_tag_manager["GTM-WJGQVL"].macro(4164),is_live:google_tag_manager["GTM-WJGQVL"].macro(4165),landscape:google_tag_manager["GTM-WJGQVL"].macro(4166),language:google_tag_manager["GTM-WJGQVL"].macro(4167),user_id:google_tag_manager["GTM-WJGQVL"].macro(4168),user_owned_machines:a.split(google_tag_manager["GTM-WJGQVL"].macro(4175))})})(ah.facebook);</script>
...
"getAttribute","offsetParent","getElement","innerWidth","innerHeight","clientWidth","clientHeight","length","click","innerHTML","innerText","promotion","roduct","impression","position","Scroll","gtmTracked","Load","load","DOMContentLoaded","EventListener");</script><script type="text/javascript" id="">ah.wrap(function(g,t,w,x,n,y,z,A,u,B,C,p,h,D,l,c){function E(b,d){var a=g[b]=g[b]||function(){e=arguments;a[x]?a[x].apply(a,e):a.queue.push(e)},e=t.getElementsByTagName(w)[0],f=t.createElement(w);g[b="_"+b]=g[b]||a;a.push=a;a.loaded=!0;a.version="1.0";a.queue=[];a.market=google_tag_manager["GTM-WJGQVL"].macro(4216);a.language=google_tag_manager["GTM-WJGQVL"].macro(4217);a.channel=google_tag_manager["GTM-WJGQVL"].macro(4218);f.async=!0;f.src="//www."+("true"===google_tag_manager["GTM-WJGQVL"].macro(4219)?"":"vst.")+"contact.nespresso.com/apps.php?a\x3dcalleo-"+d+(/(msie [1-9]|Trident\/7\.0)/i.test(navigator.userAgent)?
"\x26v\x3die":"");e.parentNode.insertBefore(f,e)}function F(b,d,a,e){a&&a(l);c=function(f,G,q,m,r){m&&m(l);m=m||a;q=q||f.replace(/e?$/,"ed");g[n+b]("add"+b+"Listener",f[z](),D[r=d+q]=y(function(I,J,H,k,v){k=G||"Click";k={eventAction:"Source:"+H+";Action:"+k,eventLabel:q,calleoChatType:d,nonInteraction:+!!G};for(v in l)k[v]=l[v];k[r]=1;m&&m(k,H,I,J);gtmDataObject.push(k)}));l[r=h+r]=e}}l={event:h=n+u,eventRaisedBy:"GTM"};D=ah[h]={};"true"===google_tag_manager["GTM-WJGQVL"].macro(4220)+""&&(E(h,"livechat"),F(u,A),c(C),c("Start"),
c("End"),c("Cancel"),c("Rating",0,"Reviewed",function(b,d){function a(e,f){b[h+A+"Review"+e]=d&&(f||["","Very good","Good","Fairly good","Not acceptable"])[+d[e[z]()]]}a("Delay");a("Quality");a("Satisfaction",["No","Yes"])}),t.addEventListener("click",y(function(b,d){d=b.target;/(^|\s)open-live-chat(\s|$)/.test(d.id+" "+d.className)&&(b.preventDefault(),g[h]("start"+u))})));if("true"===google_tag_manager["GTM-WJGQVL"].macro(4221)+""){E(n+p,"triggers");if(c=google_tag_manager["GTM-WJGQVL"].macro(4222))g[n+p]("NessclubId",c);F(p,B,function(b,d,
...
e&&Array.prototype.forEach.call(document.querySelectorAll(c),function(a){k.test(a.className)||(a.className+=a.className?" "+e:e)}),c}var d,e,k;ah.sessioncam={hide_pii:g,init:function(e,b){function c(){g(b,google_tag_manager["GTM-WJGQVL"].macro(4223),"ignorechanges");g(b,google_tag_manager["GTM-WJGQVL"].macro(4224),"hidetext");var a=document.getElementsByTagName("script")[0],c=document.createElement("script");c.async=!0;c.src="//d2oh4tlt9mrke9.cloudfront.net/Record/js/sessioncam.recorder.js";a.parentNode.insertBefore(c,a)}var a=ah.extend({Channel:google_tag_manager["GTM-WJGQVL"].macro(4225),
DeviceType:google_tag_manager["GTM-WJGQVL"].macro(4226),IsMobileSite:0,Landscape:google_tag_manager["GTM-WJGQVL"].macro(4227),LanguageCode:google_tag_manager["GTM-WJGQVL"].macro(4228),PrimaryCategory:google_tag_manager["GTM-WJGQVL"].macro(4229),Technology:google_tag_manager["GTM-WJGQVL"].macro(4230),UserIsLoggedIn:+("true"===google_tag_manager["GTM-WJGQVL"].macro(4231)),UserID:google_tag_manager["GTM-WJGQVL"].macro(4232)},e);b=b||google_tag_manager["GTM-WJGQVL"].macro(4245);sessioncamConfiguration={SessionCamHostname:location.href.replace(/^([^\/]+\/\/[^\/]+)\/.*$/,"$1."+google_tag_manager["GTM-WJGQVL"].macro(4247)),SessionCamPath:a.PrimaryCategory,SessionCamPageName:google_tag_manager["GTM-WJGQVL"].macro(4248)+":"+b,customDataObjects:Object.keys(a).map(function(b){return[{key:b,
value:a[b]}]}),elementsToRemove:g(b,google_tag_manager["GTM-WJGQVL"].macro(4249))};var d=document.readyState;if("complete"===d||"loading"!==d&&!document.documentElement.doScroll)setTimeout(ah.wrap(c));else{var f=ah.wrap(function(){f&&(document.removeEventListener("DOMContentLoaded",f),window.removeEventListener("load",f),f=0,c())});document.addEventListener("DOMContentLoaded",f);window.addEventListener("load",f)}}}})(eval);</script><script type="text/javascript" id="">ah.wrap(function(){ah.sessioncam.init()})();</script><script type="text/javascript" id="">var pageViewDebug=false&&google_tag_manager["GTM-WJGQVL"].macro(4250);var pageTech=google_tag_manager["GTM-WJGQVL"].macro(4253);var pageSub1=google_tag_manager["GTM-WJGQVL"].macro(4256);var pagePath=google_tag_manager["GTM-WJGQVL"].macro(4257);var isMachinePage=pageSub1==="machines";var isCapsulePage=pageSub1==="coffee";var isAccessoryPage=pageSub1==="accessories"||pagePath.indexOf("accessories")!=-1;var isVertuoPage=pagePath.indexOf("vertuo")!==-1||pageTech==="vertuoline";var isOriginalPage=pageTech==="originalline"&&!isVertuoPage||!isVertuoPage;var isComboSubscriptionPage=pageSub1==="combo-subscription";
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script><script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(4262);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script><script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5522),google_tag_manager["GTM-WJGQVL"].macro(5523),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(5524)],content_name:google_tag_manager["GTM-WJGQVL"].macro(5525),currency:google_tag_manager["GTM-WJGQVL"].macro(5526)||google_tag_manager["GTM-WJGQVL"].macro(5527),is_live:google_tag_manager["GTM-WJGQVL"].macro(5528),landscape:google_tag_manager["GTM-WJGQVL"].macro(5529),language:google_tag_manager["GTM-WJGQVL"].macro(5530),num_items:google_tag_manager["GTM-WJGQVL"].macro(5532),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(5533)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(5534)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(5535)),user_id:google_tag_manager["GTM-WJGQVL"].macro(5536),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(5543)),
value:google_tag_manager["GTM-WJGQVL"].macro(5544)||0})})(ah.facebook);</script><script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5585),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5586),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5587),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5588).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5589).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5590).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5591)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5592)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5593)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5594)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5595))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5596)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5597)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5598))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5599)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5600)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5601))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5602)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5603)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5604)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5605))}}),pushedGroupTagStrings.push(groupTagString));</script><script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5611),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5612),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5613)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5614),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5615)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
