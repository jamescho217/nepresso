...
<title>${dto.cv_modelName1 } | 바리스타 크리에이션 오리지널 I 네스프레소 코리아</title>
        ...
        <div id="respProductDetailPDPCapsule-8797707544336-7f9542eb-c6b7-46fb-9060-595cb3d21c9e" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/7718.40">
        		<h2 class="VisuallyHidden">${dto.cv_modelName1 }</h2>
        				...
        				<div class="ResponsiveContainer ProductDetails__display">
        					...
        					<div class="ProductDetailsImageSlider">
        						...
        						<div class="ProductDetailsImage-wrapper">
        							<img width="1568" height="608" itemprop="image" src="${dto.cv_aticleCoffee1 }" 
        					...
        					<div class="ProductDetails__information">
        						...
        						<div>
        							<span itemprop="offers" itemtype="http://schema.org/Offer" itemscope="">
        								<c:if test="${dto.cv_num==2 }">
        								<div class="ProductDetails__price">
        									<span style="display: inline-block; font-size: 16px; padding-top: 5px; color: rgb(61, 135, 5); font-weight: bold;">₩ <fmt:formatNumber value="${dto.cv_price }" pattern="#,###" /></span>
        								</div>
        								</c:if>
        								<c:if test="${dto.cv_num!=2 }">
        								<div class="ProductDetails__price">
        			...
        			<div>
        				<div class="ProductDetailsAttributes" style="height: 80px;">
        					<h3 class="VisuallyHidden">상품 특성</h3>
        						<ul class="ResponsiveContainer ProductDetailsAttributes__attributesList">
        							...
        							<li class="ProductDetailsAttributes__attribute ProductDetailsAttributes__cupSizes">
        								<img width="25" src="${dto.cv_cupSize7 }" role="presentation" class="ResponsiveImage" alt="">
        								<div class="ProductDetailsAttributes__title">${dto.cv_sp2}</div>
        							</li>
        							<li class="ProductDetailsAttributes__attribute ProductDetailsAttributes__cupSizes">
        								<img width="25" src="${dto.cv_cupSize8 }" role="presentation" class="ResponsiveImage" alt="">
        								<div class="ProductDetailsAttributes__title">${dto.cv_sp3}</div>
        							</li>
        						</ul>
        					</div>
        									...
        									<div class="FreeHTML">
        											...
        											:&quot;n-pdp-header-efa49228-017b-0338-22ee-d363ad3c7c9f&quot;,&quot;data-wc-order&quot;:&quot;0&quot;}">
        												...
        												slot="<div class=&quot;c-pdp-header&quot; data-product-item-id=&quot;7718.40&quot; data-product-section=&quot;Page Builder - PDP Header&quot; data-product-position=&quot;1&quot;>
                    										...
                    										<div class=&quot;c-pdp-header__subheading&quot;>
                            									<n-heading level=&quot;3&quot;>${dto.cv_modelName1 }</n-heading>
                        									</div>
            												...
            												<section class="c-Container " data-contrast="dark" style="null">
												                <div class="c-Container__bg_image" style="background-image: url(${dto.cv_bg })"></div>
												                    		...
												                    		<div class="c-pdp-header__heading">
												                    			<n-heading level="1" seo_title="아이스 프레도 델리카토 " class="c-Heading">
												                    				<h1 class="c-Heading__xl" title="아이스 프레도 델리카토 ">
												                    					<img loading="lazy" src="${dto.cv_bigName1 }" alt="아이스 프레도 델리카토 " title="아이스 프레도 델리카토 " class="c-pdp-header__heading__image">
												                    				</h1>
												                    			</n-heading>
												                    		</div>
												                    		<div class="c-pdp-header__subheading">
												                    			<c:if test="${dto.cv_num==3 }">
												                            	<n-heading level="3" class="c-Heading">
												                            		<h3 class="c-Heading__m" title="아이스 프레도 델리카토" style="color: black;">${dto.cv_bigName2 }</h3>
												                            	</n-heading>
												                            	</c:if>
												                            	<c:if test="${dto.cv_num!=3 }">
												                            	<n-heading level="3" class="c-Heading">
												                            		<h3 class="c-Heading__m" title="아이스 프레도 델리카토">${dto.cv_bigName2 }</h3>
												                            	</n-heading>
												                            	</c:if>
												                        	</div>
														                    <div class="c-pdp-header__attributes">
														                    	<div class="c-pdp-header__attributes__img">
														                        	<img loading="lazy" src="${dto.cv_aticleCoffee2 }" alt="아이스 프레도 델리카토 " title="아이스 프레도 델리카토 ">
														                        </div>
                            													<div class="c-pdp-header__attributes__first">
													                                <n-properties-attributes heading="" level="0"></n-properties-attributes>
													                                <n-properties-attributes heading="" level="0"></n-properties-attributes>
            											...
            											<n-container styles="background-color: transparent" contrast="dark" width="996" class="" slot="<div class=&quot;c-pdp-description&quot; style=&quot;background-color: #75a6b8&quot;>
											                <div class=&quot;c-pdp-description__info&quot;>
											                 	<div class=&quot;c-pdp-description__info__heading&quot;>
											                 		<n-heading level=&quot;2&quot;>${dto.cv_atContent1 }</n-heading>
											                 	</div>
											                    <div class=&quot;c-pdp-description__info__subheading&quot;>
											                    	<n-heading level=&quot;3&quot;></n-heading>
                        										</div>
                    											<p>${dto.cv_atContent2 }</p>
                    											<img loading=&quot;lazy&quot; class=&quot;c-pdp-description__info__icon&quot; src=&quot;${dto.cv_aticleCoffee3 }	&quot; alt=&quot;&quot; title=&quot;&quot;>
                    											<p class=&quot;c-pdp-description__info__details&quot;>${dto.cv_atContent3 }</p>
                											</div></div>">
            												<section class="c-Container " data-contrast="dark" style="background-color: transparent">
																<div class="c-Container__inner c-Container__inner__" style="width: auto;max-width: 996px">
												                    <div class="c-pdp-description" style="background-color: ${dto.cv_bgColor }">
												                		<div class="c-pdp-description__info">
												                			<c:if test="${dto.cv_num==3 }">
												                    		<div class="c-pdp-description__info__heading">
												                    			<n-heading level="2" class="c-Heading">
												                    				<h2 class="c-Heading__l" title="산뜻한 아이스커피로 즐기기에 좋은 달콤한 과일향의 커피" style="color: black;">${dto.cv_atContent1 }</h2>
												                    			</n-heading>
												                    		</div>
												                    		</c:if>
												                    		<c:if test="${dto.cv_num!=3 }">
												                    		<div class="c-pdp-description__info__heading">
												                    			<n-heading level="2" class="c-Heading">
												                    				<h2 class="c-Heading__l" title="산뜻한 아이스커피로 즐기기에 좋은 달콤한 과일향의 커피">${dto.cv_atContent1 }</h2>
												                    			</n-heading>
												                    		</div>
												                    		</c:if>
												                    		<div class="c-pdp-description__info__subheading">
                        													...
                        													<c:if test="${dto.cv_num==3 }">
                    														<p style="color: black;">${dto.cv_atContent2 }</p>
                    														</c:if>
                    														<c:if test="${dto.cv_num!=3 }">
                    														<p>${dto.cv_atContent2 }</p>
                    														</c:if>
                    														<c:if test="${dto.cv_num==2 }">
                    														<p>${dto.cv_atContent3 }</p>
                    														</c:if>
                    														<c:if test="${dto.cv_num==2 }">
                    														<img loading="lazy" class="c-pdp-description__info__icon" src="${dto.cv_aticleCoffee3 }" alt="" title="" style="width: 300px;">
                    														</c:if>
                    														<c:if test="${dto.cv_num!=2 }">
                    														<img loading="lazy" class="c-pdp-description__info__icon" src="${dto.cv_aticleCoffee3 }" alt="" title="">
                    														</c:if>
                    														<c:if test="${dto.cv_num==3 }">
                    														<p style="color: black;">${dto.cv_atContent3 }</p>
                    														</c:if>
                    														<c:if test="${dto.cv_num!=2 && dto.cv_num!=3 }">
                    														<p>${dto.cv_atContent3 }</p>
                    														</c:if>
                    														<p class="c-pdp-description__info__details">${dto.cv_atContent5 }</p>
                														</div>
            														</div>
                												</div>
            												</section>
            									...
            									:&quot;자세히 보기&quot;,&quot;cta_link&quot;:&quot;https://www.nespresso.com/kr/ko/2021-barista-creations-for-ice&quot;,&quot;id&quot;:&quot;n-pdp-banner-95777b72-34ec-634f-fb34-c3b34ae1e529&quot;,&quot;data-wc-order&quot;:&quot;2&quot;}">
            										<n-container styles="background-color:transparent;" contrast="dark" width="996" class="" slot="<div class=&quot;c-pdp-banner&quot;>
                										...
                										<n-cta campaign_id=&quot;null&quot; campaign_name=&quot;null&quot; campaign_position=&quot;null&quot; campaign_creative=&quot;null&quot; look=&quot;primary_transparent&quot; link=&quot;https://www.nespresso.com/kr/ko/2021-barista-creations-for-ice&quot;>${dto.cv_atContent4 }</n-cta></div>">
														<section class="c-Container " data-contrast="dark" style="background-color:transparent;">
															<div class="c-Container__inner c-Container__inner__" style="width: auto;max-width: 996px">
                    											<c:if test="${dto.cv_atContent4!=null }">
                    											<div class="c-pdp-banner">
                													<img loading="lazy" src="${dto.cv_aticleCoffee4 }" alt="자세히 보기" title="자세히 보기">
                													<n-cta campaign_id="null" campaign_name="null" campaign_position="null" campaign_creative="null" look="primary_transparent" link="https://www.nespresso.com/kr/ko/2021-barista-creations-for-ice" slot="자세히 보기">
                														<a href="https://www.nespresso.com/kr/ko/2021-barista-creations-for-ice" target="_self" tabindex="0" title="자세히 보기" class="c-Cta--primary-transparent c-Cta">
                															<span class="c-Cta__text c-Cta__text__undefined">${dto.cv_atContent4 }</span>
                														</a>
                													</n-cta>
																</div>
            													</c:if>
...
<c:if test="${dto.cv_atOrigin!=null }">
<div class="ProductDetailsBodyInformation">
...
<c:if test="${dto.cv_atRoasting!=null }">
<div class="ProductDetailsBodyInformation">
...
<c:if test="${dto.cv_atProfile!=null }">
<div class="ProductDetailsBodyInformation">
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceOrder__list">
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						...
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
							<img alt="" src="https://www.nespresso.com/ecom/medias/sys_master/public/14104824283166/Desktop-Standard-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogaccNesxKia?ao_num=2" 
					data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" 
					data-product-position="1">
						<div class="ProductPush__name">리미티드 에디션 노마드 트래블 머그 스몰</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogaccNesxKia?ao_num=1" 
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/14104871338014/Desktop-Standard-2000x2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogaccNesxKia?ao_num=1" 
					data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" 
					data-product-position="1">
						<div class="ProductPush__name">리미티드 에디션 버츄오 머그 컵</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
							<span class="ProductPush__price">₩ <fmt:formatNumber value="18000" pattern="#,###" /></span>
						</div>
						<div class="ProductPush__add-to-bag AddToBagButton__container">
							<div id="AddToBagButton__button-CremaComponentId-2">
								<button class="AddToBagButton AddToBagButtonSmall" data-focus-id="AddToBagButton__button-CremaComponentId-2" type="button">
