...
<meta name="keywords"
	content="텀블러,네스프레소,머그컵,텀블러추천,보온보냉텀블러,텀블러브랜드,네스프레소텀블러,커피텀블러,머그컵브랜드,머그컵추천,트래블머그,">
<meta name="description"
	content="세가지 색상과 다양한 사이즈의 네스프레소 노마드 트래블 머그 텀블러! 버튼 하나로 어떤 방향에서도 편리하게 커피를 즐겨보세요">
<meta property="og:title" content="노마드 트래블 머그 - 스몰  | 트래블 커피 머그 | 네스프레소">
<meta property="og:url"
	content="https://www.nespresso.com:443/kr/ko/order/accessories/original/small-nomad-travel-mug">
<meta property="og:description"
	content="세가지 색상과 다양한 사이즈의 네스프레소 노마드 트래블 머그 텀블러! 버튼 하나로 어떤 방향에서도 편리하게 커피를 즐겨보세요">
<title>${dto.ao_modelName } | 액세서리 | 네스프레소</title>

<link rel="canonical"
	href="https://www.nespresso.com/kr/ko/order/accessories/original/small-nomad-travel-mug">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:accessories::pdp-accessories-accessorie-name:originalline","pageName":"Accessories PDP","primaryCategory":"ACCESSORY","secondaryCategory":["Nomad Collection"],"segmentBusiness":"B2C","technology":["original","vertuo"],"type":"","variant":""}}};
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624942129877&amp;cv=9&amp;fst=1624942129877&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=9&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6n0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DAccessories%3Becomm_pagetype%3Dproduct%3Becomm_prodid%3D3748%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal%2Fsmall-nomad-travel-mug&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal&amp;tiba=%EB%85%B8%EB%A7%88%EB%93%9C%20%ED%8A%B8%EB%9E%98%EB%B8%94%20%EB%A8%B8%EA%B7%B8%20-%20%EC%8A%A4%EB%AA%B0%20%7C%20%ED%8A%B8%EB%9E%98%EB%B8%94%20%EC%BB%A4%ED%94%BC%20%EB%A8%B8%EA%B7%B8%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624942129898&amp;cv=9&amp;fst=1624942129898&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=9&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6n0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DAccessories%3Becomm_pagetype%3Dcategory%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal%2Fsmall-nomad-travel-mug&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Faccessories%2Foriginal&amp;tiba=%EB%85%B8%EB%A7%88%EB%93%9C%20%ED%8A%B8%EB%9E%98%EB%B8%94%20%EB%A8%B8%EA%B7%B8%20-%20%EC%8A%A4%EB%AA%B0%20%7C%20%ED%8A%B8%EB%9E%98%EB%B8%94%20%EC%BB%A4%ED%94%BC%20%EB%A8%B8%EA%B7%B8%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<iframe target="_self" title="SaleCycle"
	src="https://s.salecycle.com/receiver.html?sc_frame_id=7fcf8651-64a2-40bd-9fd8-ad378218c8e4"
	style="display: none; height: 0px; width: 0px;"></iframe>
<link id="dnsprefetchlink" rel="dns-prefetch"
	href="//3reupyaxfmeygyg2uyxq-f-b8eac3db0-clientnsv4-s.akamaihd.net">
</head>

<body class="livechat-collapsed">
	<!---->
	<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">노마드
		트래블 머그, 스몰</h2>
...
@media screen and (max-width: 767px) {
	...
	<div
		id="respPromotionBannersBlockAccessories_PDP-8802977392400-ec85d9be-3f55-42a0-9b2e-fa273fbdcdff"
		class="crema-ui-container "></div>
	<!-- <script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockAccessories_PDP-8802977392400-ec85d9be-3f55-42a0-9b2e-fa273fbdcdff","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockAccessories_PDP-8802977392400-a72b9faa-ca98-4913-be22-50d7581b352b","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockController/ecommerce-data?componentUid=respPromotionBannersBlockAccessories_PDP"}}});
            </script> -->
	<div
		id="respProductDetailPDPAccessory-8797707577104-a0131e14-a913-45ae-aefa-07939694847a"
		class="crema-ui-container ">
		<div class="ProductDetails" itemtype="http://schema.org/Product"
			itemscope="" id="ProductDetail__erp.kr.b2c/prod/3748">
			<h2 class="VisuallyHidden">노마드 트래블 머그 스몰</h2>
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script>
	<script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(3859);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script>
	<script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5044),google_tag_manager["GTM-WJGQVL"].macro(5045),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(5046)],content_name:google_tag_manager["GTM-WJGQVL"].macro(5047),currency:google_tag_manager["GTM-WJGQVL"].macro(5048)||google_tag_manager["GTM-WJGQVL"].macro(5049),is_live:google_tag_manager["GTM-WJGQVL"].macro(5050),landscape:google_tag_manager["GTM-WJGQVL"].macro(5051),language:google_tag_manager["GTM-WJGQVL"].macro(5052),num_items:google_tag_manager["GTM-WJGQVL"].macro(5054),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(5055)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(5056)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(5057)),user_id:google_tag_manager["GTM-WJGQVL"].macro(5058),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(5065)),
value:google_tag_manager["GTM-WJGQVL"].macro(5066)||0})})(ah.facebook);</script>
	<script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5107),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5108),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5109),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5110).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5111).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5112).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5113)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5114)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5115)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5116)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5117))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5118)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5119)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5120))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5121)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5122)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5123))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5124)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5125)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5126)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5127))}}),pushedGroupTagStrings.push(groupTagString));</script>
	<script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5132),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5133),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5134)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5135),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5136)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
