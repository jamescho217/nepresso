...
<meta name="keywords" content="네스프레소 바리스타, 레시피메이커, 아이스커피,라테아트, 라떼아트, 커피메이커">
<meta name="description" content="카페 레시피를 집에서 즐기는 레시피 메이커, 바리스타. 카페에서 즐기는 다양한 레시피를 이제 집에서도 쉽게 만들어보세요">
<meta property="og:title" content="바리스타 레시피 메이커 | 레시피 메이커 | 네스프레소">
<meta property="og:url" content="/nespresso/product/vtmsBarista?mv_num=13">
<meta property="og:description" content="카페 레시피를 집에서 즐기는 레시피 메이커, 바리스타. 카페에서 즐기는 다양한 레시피를 이제 집에서도 쉽게 만들어보세요">
<meta property="og:image" content="https://www.nespresso.com/ecom/medias/sys_master/public/10649860505630/BaristaVertuoV2-main-684x378.jpg">
<title>${dto.mv_modelName2 } | 레시피 메이커 | 네스프레소</title>
<link rel="canonical" href="/nespresso/product/vtmsBarista?mv_num=13">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:machines::pdp-machines-machine-name:originalline","pageName":"Machine PDP","primaryCategory":"MACHINE","secondaryCategory":["Recipe","Grey","Barista"],"segmentBusiness":"B2C","technology":["vertuo"],"type":"","variant":""}}};
...
<script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624542258689&amp;cv=9&amp;fst=1624542258689&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=376635471%2C2505059651&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=9&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DMachines%3Becomm_pagetype%3Dproduct%3Becomm_prodid%3D111192%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Fvertuo%2Fbarista-recipe-maker-vertuo&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Fvertuo&amp;tiba=%EB%B0%94%EB%A6%AC%EC%8A%A4%ED%83%80%20%EB%A0%88%EC%8B%9C%ED%94%BC%20%EB%A9%94%EC%9D%B4%EC%BB%A4%20%7C%20%EB%A0%88%EC%8B%9C%ED%94%BC%20%EB%A9%94%EC%9D%B4%EC%BB%A4%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624542258750&amp;cv=9&amp;fst=1624542258750&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=9&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DMachines%3Becomm_pagetype%3Dcategory%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Fvertuo%2Fbarista-recipe-maker-vertuo&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Forder%2Fmachines%2Fvertuo&amp;tiba=%EB%B0%94%EB%A6%AC%EC%8A%A4%ED%83%80%20%EB%A0%88%EC%8B%9C%ED%94%BC%20%EB%A9%94%EC%9D%B4%EC%BB%A4%20%7C%20%EB%A0%88%EC%8B%9C%ED%94%BC%20%EB%A9%94%EC%9D%B4%EC%BB%A4%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script><iframe target="_self" title="SaleCycle" src="https://s.salecycle.com/receiver.html?sc_frame_id=cb9ab5de-4c7f-4021-bf55-8edcd6653e8d" style="display: none; height: 0px; width: 0px;"></iframe></head>
<body class="livechat-collapsed"><!---->
<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">바리스타 레시피 메이커</h2>
...
<div id="respProductDetailPDPMachine-8797707511568-7542262d-43a1-4609-a467-944c0b9ed324" class="crema-ui-container ">
	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/4292VL-KR-KIT">
			...
			<div class="ResponsiveContainer ProductDetails__display">
				...
				<div class="ProductDetailsImageSlider">
					...
					<div class="ProductDetailsImage-wrapper" style="display: none;"><!--  ProductDetailsImage-wrapper--not-current"> -->
						<img width="1568" height="608" itemprop="image" srcset="${dto.mv_atMachine2 } 1x, ${dto.mv_atMachine2 } 2x, 
						${dto.mv_atMachine2 } 3x, ${dto.mv_atMachine2 } 4x" src="${dto.mv_atMachine2 }" 
						role="presentation" class="ResponsiveImage ProductDetailsImage ResponsiveImage--flexible" alt="">
					</div>
					<div class="ProductDetailsImage-wrapper" style="display: none;"><!--  ProductDetailsImage-wrapper--not-current"> -->
						<img width="1568" height="608" itemprop="image" srcset="${dto.mv_atMachine3 } 1x, ${dto.mv_atMachine3 } 2x, 
						${dto.mv_atMachine3 } 3x, ${dto.mv_atMachine3 } 4x" src="${dto.mv_atMachine3 }" 
						role="presentation" class="ResponsiveImage ProductDetailsImage ResponsiveImage--flexible" alt="">
					</div>
    		...
    		$('#QuantitySelector__wrapper'+i).css('display','none');
				...
				<div class="ProductDetails__information">
					...
					<div class="ProductDetails__range">
						<span class="ProductDetails__specs">바리스타</span>
					</div>
						...
						<div class="ProductDetailsColorSwitcher">
							...
							<ul class="ProductDetailsColorSwitcher__color-list">
								<li class="ProductDetailsColorSwitcher__color">
									<a href="/nespresso/product/vtmsBarista?mv_num=13" class="ProductDetailsColorSwitcher__color-link ProductDetailsColorSwitcher__color-link--active" style="background-color: rgb(128, 128, 128);">
										<span class="element-visually-hidden">Grey</span>
									</a>
								</li>
							</ul>
						</div>
				...
				<div class="ResponsiveContainer">
					<div class="ProductDetailsBodyInformation">
						<div class="ProductDetailsBodyInformation__description" itemprop="description">
							<div class="FreeHTML">
								<p>${dto.mv_atContent1 }</p>
								<p>${dto.mv_atContent2 }</p>
							</div>
						</div>
					</div>
					<div class="ProductDetailsBodyInformation">
					...
					<div class="ProductDetailsBodyInformation">
						...
						<div class="ProductDetailsBodyInformation__description">
							<ul class="ProductDetailsBodyInformation__specifications-list">
								<li class="ProductDetailsBodyInformation__specification">${dto.mv_weight }</li>
								<li class="ProductDetailsBodyInformation__specification">${dto.mv_size1 }</li>
								<li class="ProductDetailsBodyInformation__specification">${dto.mv_warranty }</li>
							</ul>
							<a class="AccessibleLink DefaultLink ProductDetailsBodyInformation__link DefaultLink--with-right-chevron" href="https://www.nespresso.com/shared_res/manuals/barista/UM_BARISTA_NEW_Z3_PROD_WEB_2019_11_12.pdf">
...
<noscript><img src="https://www.nespresso.com/akam/11/pixel_6235fb8d?a=dD1kNjIzOWE4NWEzNDY0OTE0NTFkMjVhMjgwNWRhMjcxZDkzNDhmZTY1JmpzPW9mZg==" style="visibility: hidden; position: absolute; left: -999px; top: -999px;" /></noscript><script type="text/javascript" src="/Zp15ZNN71tJKDF-Bt0PXqGjF/VuiVQmVz/DS92/CA48c/Vg4InU"></script>
<script type="text/javascript" id="">_mpulsePageGroup=function(c){var a=c.page.pageInfo.breadcrumbUID.split(":"),b=function(){if("customEvent"===google_tag_manager["GTM-WJGQVL"].macro(270)&&"other"!==google_tag_manager["GTM-WJGQVL"].macro(271))return google_tag_manager["GTM-WJGQVL"].macro(272);switch(a[0]){case "account":return a[0]+"-"+(a[1]||"other");case "checkister":return a[0]+"-"+a[3];case "cart":case "shopping bag":return"checkout-shopping-bag";case "multi-step-checkout-summary-page":return"checkout-multi-step-checkout-summary-page";case "checkout":return"shopping bag"===a[3]?"checkout-shopping-bag":
...
"\u01b6":"z","\u0225":"z","\u0240":"z","\u2c6c":"z","\ua763":"z"});</script><script type="text/javascript" id="" src="//d22xmn10vbouk4.cloudfront.net/b924dea2389e11e6bf0212f5c79d2169.js"></script><script type="text/javascript" id="">ah.wrap(function(){function b(a,c){return(a=location.search.match("(\\?|\x26)("+a+")\x3d([^\x26]+)"))&&(c?a[2]+":":"")+a[3]}ah.affiliation(b("aff")||b("utm_id|gclid|dclid",1)||b("utm_source"))})();</script><script type="text/javascript" id="">ah.wrap(function(b,f,e,m,d,c,n,g,p,k){c=b.fbq=b.fbq||function(){b=arguments;c[m]?c[m].apply(c,b):n.push(b)};b._fbq=b._fbq||c;c.push=c;c.version="2.0";n=c.queue=[];b=f.getElementsByTagName(e)[0];e=f.createElement(e);c.loaded=e.async=!0;e.src="//connect.facebook.net/en_US/fbevents.js";b.parentNode.insertBefore(e,b);ah.facebook={split:function(a){return a?a.split(/\|+/):[]},track:function(a){google_tag_manager["GTM-WJGQVL"].macro(4080)&&console.log("FB Deprecated Track Fired");if(a){a=a.split(";");d="product"!==a[3]?{page_type:d=
a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];c(a[2],a[1],d)}},trackSingle:function(a,h){if(a&&h){a=a.split(";");h=h.split(",");google_tag_manager["GTM-WJGQVL"].macro(4081)&&console.log("FB Data: "+a);google_tag_manager["GTM-WJGQVL"].macro(4082)&&console.log("FB Pixels: "+h);d="product"!==a[3]?{page_type:d=a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];
for(var q="track"==a[2]?"trackSingle":"trackSingleCustom",l=0;l<h.length;l++)c(q,h[l],a[1],d)}}};g=google_tag_manager["GTM-WJGQVL"].macro(4083).split(",");for(p=0;k=+g[p++];)c("set","autoConfig",!1,k),c("init",k);0!=google_tag_manager["GTM-WJGQVL"].macro(4084)&&(c("set","autoConfig",!1,google_tag_manager["GTM-WJGQVL"].macro(4085)),c("init",google_tag_manager["GTM-WJGQVL"].macro(4086)))})(window,document,"script","callMethod");</script><script type="text/javascript" id="">ah.wrap(function(a){a.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(4091),google_tag_manager["GTM-WJGQVL"].macro(4092),{content_name:google_tag_manager["GTM-WJGQVL"].macro(4095),content_subsection:google_tag_manager["GTM-WJGQVL"].macro(4098),content_technology:google_tag_manager["GTM-WJGQVL"].macro(4101),is_live:google_tag_manager["GTM-WJGQVL"].macro(4102),landscape:google_tag_manager["GTM-WJGQVL"].macro(4103),language:google_tag_manager["GTM-WJGQVL"].macro(4104),user_id:google_tag_manager["GTM-WJGQVL"].macro(4105),user_owned_machines:a.split(google_tag_manager["GTM-WJGQVL"].macro(4112))})})(ah.facebook);</script>
...
"getAttribute","offsetParent","getElement","innerWidth","innerHeight","clientWidth","clientHeight","length","click","innerHTML","innerText","promotion","roduct","impression","position","Scroll","gtmTracked","Load","load","DOMContentLoaded","EventListener");</script><script type="text/javascript" id="">ah.wrap(function(g,t,w,x,n,y,z,A,u,B,C,p,h,D,l,c){function E(b,d){var a=g[b]=g[b]||function(){e=arguments;a[x]?a[x].apply(a,e):a.queue.push(e)},e=t.getElementsByTagName(w)[0],f=t.createElement(w);g[b="_"+b]=g[b]||a;a.push=a;a.loaded=!0;a.version="1.0";a.queue=[];a.market=google_tag_manager["GTM-WJGQVL"].macro(4153);a.language=google_tag_manager["GTM-WJGQVL"].macro(4154);a.channel=google_tag_manager["GTM-WJGQVL"].macro(4155);f.async=!0;f.src="//www."+("true"===google_tag_manager["GTM-WJGQVL"].macro(4156)?"":"vst.")+"contact.nespresso.com/apps.php?a\x3dcalleo-"+d+(/(msie [1-9]|Trident\/7\.0)/i.test(navigator.userAgent)?
"\x26v\x3die":"");e.parentNode.insertBefore(f,e)}function F(b,d,a,e){a&&a(l);c=function(f,G,q,m,r){m&&m(l);m=m||a;q=q||f.replace(/e?$/,"ed");g[n+b]("add"+b+"Listener",f[z](),D[r=d+q]=y(function(I,J,H,k,v){k=G||"Click";k={eventAction:"Source:"+H+";Action:"+k,eventLabel:q,calleoChatType:d,nonInteraction:+!!G};for(v in l)k[v]=l[v];k[r]=1;m&&m(k,H,I,J);gtmDataObject.push(k)}));l[r=h+r]=e}}l={event:h=n+u,eventRaisedBy:"GTM"};D=ah[h]={};"true"===google_tag_manager["GTM-WJGQVL"].macro(4157)+""&&(E(h,"livechat"),F(u,A),c(C),c("Start"),
c("End"),c("Cancel"),c("Rating",0,"Reviewed",function(b,d){function a(e,f){b[h+A+"Review"+e]=d&&(f||["","Very good","Good","Fairly good","Not acceptable"])[+d[e[z]()]]}a("Delay");a("Quality");a("Satisfaction",["No","Yes"])}),t.addEventListener("click",y(function(b,d){d=b.target;/(^|\s)open-live-chat(\s|$)/.test(d.id+" "+d.className)&&(b.preventDefault(),g[h]("start"+u))})));if("true"===google_tag_manager["GTM-WJGQVL"].macro(4158)+""){E(n+p,"triggers");if(c=google_tag_manager["GTM-WJGQVL"].macro(4159))g[n+p]("NessclubId",c);F(p,B,function(b,d,
...
e&&Array.prototype.forEach.call(document.querySelectorAll(c),function(a){k.test(a.className)||(a.className+=a.className?" "+e:e)}),c}var d,e,k;ah.sessioncam={hide_pii:g,init:function(e,b){function c(){g(b,google_tag_manager["GTM-WJGQVL"].macro(4160),"ignorechanges");g(b,google_tag_manager["GTM-WJGQVL"].macro(4161),"hidetext");var a=document.getElementsByTagName("script")[0],c=document.createElement("script");c.async=!0;c.src="//d2oh4tlt9mrke9.cloudfront.net/Record/js/sessioncam.recorder.js";a.parentNode.insertBefore(c,a)}var a=ah.extend({Channel:google_tag_manager["GTM-WJGQVL"].macro(4162),
DeviceType:google_tag_manager["GTM-WJGQVL"].macro(4163),IsMobileSite:0,Landscape:google_tag_manager["GTM-WJGQVL"].macro(4164),LanguageCode:google_tag_manager["GTM-WJGQVL"].macro(4165),PrimaryCategory:google_tag_manager["GTM-WJGQVL"].macro(4166),Technology:google_tag_manager["GTM-WJGQVL"].macro(4167),UserIsLoggedIn:+("true"===google_tag_manager["GTM-WJGQVL"].macro(4168)),UserID:google_tag_manager["GTM-WJGQVL"].macro(4169)},e);b=b||google_tag_manager["GTM-WJGQVL"].macro(4182);sessioncamConfiguration={SessionCamHostname:location.href.replace(/^([^\/]+\/\/[^\/]+)\/.*$/,"$1."+google_tag_manager["GTM-WJGQVL"].macro(4184)),SessionCamPath:a.PrimaryCategory,SessionCamPageName:google_tag_manager["GTM-WJGQVL"].macro(4185)+":"+b,customDataObjects:Object.keys(a).map(function(b){return[{key:b,
value:a[b]}]}),elementsToRemove:g(b,google_tag_manager["GTM-WJGQVL"].macro(4186))};var d=document.readyState;if("complete"===d||"loading"!==d&&!document.documentElement.doScroll)setTimeout(ah.wrap(c));else{var f=ah.wrap(function(){f&&(document.removeEventListener("DOMContentLoaded",f),window.removeEventListener("load",f),f=0,c())});document.addEventListener("DOMContentLoaded",f);window.addEventListener("load",f)}}}})(eval);</script><script type="text/javascript" id="">ah.wrap(function(){ah.sessioncam.init()})();</script><script type="text/javascript" id="">var pageViewDebug=false&&google_tag_manager["GTM-WJGQVL"].macro(4187);var pageTech=google_tag_manager["GTM-WJGQVL"].macro(4190);var pageSub1=google_tag_manager["GTM-WJGQVL"].macro(4193);var pagePath=google_tag_manager["GTM-WJGQVL"].macro(4194);var isMachinePage=pageSub1==="machines";var isCapsulePage=pageSub1==="coffee";var isAccessoryPage=pageSub1==="accessories"||pagePath.indexOf("accessories")!=-1;var isVertuoPage=pagePath.indexOf("vertuo")!==-1||pageTech==="vertuoline";var isOriginalPage=pageTech==="originalline"&&!isVertuoPage||!isVertuoPage;var isComboSubscriptionPage=pageSub1==="combo-subscription";
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script><script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(4199);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script><script type="text/javascript" id="">_mpulsePageGroup=function(c){var a=c.page.pageInfo.breadcrumbUID.split(":"),b=function(){if("customEvent"===google_tag_manager["GTM-WJGQVL"].macro(4794)&&"other"!==google_tag_manager["GTM-WJGQVL"].macro(4795))return google_tag_manager["GTM-WJGQVL"].macro(4796);switch(a[0]){case "account":return a[0]+"-"+(a[1]||"other");case "checkister":return a[0]+"-"+a[3];case "cart":case "shopping bag":return"checkout-shopping-bag";case "multi-step-checkout-summary-page":return"checkout-multi-step-checkout-summary-page";case "checkout":return"shopping bag"===a[3]?"checkout-shopping-bag":
a[0]+"-"+a[3];case "shop":a[0]="catalog";case "catalog":return/plp|pdp/.test(a[3])?/_plp/.test(c.page.pageInfo.pageName)?a[0]+"-plp":a[0]+"-pdp":a[0]+"-other";case "guest-checkout":return a[0]+"-"+a[3];case "login":return a[0]+"-"+a[3];case "registration-personal-info-page":return"registration";case "store-locator":return"locator";case "services-site-internet-nespresso":return"services";case "personal-info-page":case "brand":case "content":case "country-language":case "home":case "legal":case "locator":case "local-page":case "club":case "maintenance":case "registration":case "landing-page":case "services":case "standalone":case "support":return a[0];
case "page":return"unsubscribe"===a[3]?"page-unsubscribe":a[0]+"-"+a[1]}return"other"}();b=b.replace(/[^0-9a-z-]/g,"-").replace(/-+/g,"-");b=b.split("-");b[0]==b[1]&&(b=b.slice(1));return b.join("-")};mpulsePageGroup=function(){try{return _mpulsePageGroup(padl)}catch(c){}};mpulseBreadcrumbUIDGetter=function(c){return function(){try{return padl.page.pageInfo.breadcrumbUID.split(":")[c]}catch(a){}}};mpulseBreadcrumbUIDType=mpulseBreadcrumbUIDGetter(0);mpulseBreadcrumbUIDCategory=mpulseBreadcrumbUIDGetter(1);
mpulseBreadcrumbUIDSubCategory=mpulseBreadcrumbUIDGetter(2);mpulseBreadcrumbUIDName=mpulseBreadcrumbUIDGetter(3);mpulseBreadcrumbUIDTechnology=mpulseBreadcrumbUIDGetter(4);</script><script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5672),google_tag_manager["GTM-WJGQVL"].macro(5673),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(5674)],content_name:google_tag_manager["GTM-WJGQVL"].macro(5675),currency:google_tag_manager["GTM-WJGQVL"].macro(5676)||google_tag_manager["GTM-WJGQVL"].macro(5677),is_live:google_tag_manager["GTM-WJGQVL"].macro(5678),landscape:google_tag_manager["GTM-WJGQVL"].macro(5679),language:google_tag_manager["GTM-WJGQVL"].macro(5680),num_items:google_tag_manager["GTM-WJGQVL"].macro(5682),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(5683)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(5684)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(5685)),user_id:google_tag_manager["GTM-WJGQVL"].macro(5686),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(5693)),
value:google_tag_manager["GTM-WJGQVL"].macro(5694)||0})})(ah.facebook);</script><script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5735),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5736),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5737),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5738).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5739).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5740).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5741)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5742)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5743)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5744)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5745))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5746)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5747)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5748))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5749)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5750)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5751))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5752)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5753)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5754)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5755))}}),pushedGroupTagStrings.push(groupTagString));</script><script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5761),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5762),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5763)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5764),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5765)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
