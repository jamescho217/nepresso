...
<meta name="keywords" content="네스프레소, 네스프레소캡슐,&nbsp;네스프레소커피머신, 버츄오플러스, 더블 에스프레소 키아로, 네스프레소버츄오캡슐커피추천,">
<meta name="description" content="더블 에스프레소 치아로는 남미산 아라비카의 진한 블렌드 커피, 더블샷 에스프레소에 우유를 첨가하면 치아로 라테를 즐길 수 있음">
<meta property="og:title" content="더블 에스프레소 키아로 | 더블 샷 에스프레소 버츄오 커피 캡슐 | 네스프레소">
<meta property="og:url" content="https://www.nespresso.com:443/kr/ko/order/capsules/vertuo/double-espresso-chiaro-vertuo-coffee-capsules">
<meta property="og:description" content="더블 에스프레소 치아로는 남미산 아라비카의 진한 블렌드 커피, 더블샷 에스프레소에 우유를 첨가하면 치아로 라테를 즐길 수 있음">
<meta property="og:image" content="https://www.nespresso.com/ecom/medias/sys_master/public/10635981389854/DE-Chiaro-PDP.jpg">
<title>${dto.cv_modelName1 } | 더블 샷 에스프레소 버츄오 커피 캡슐 | 네스프레소</title>
<link rel="canonical" href="https://www.nespresso.com/kr/ko/order/capsules/vertuo/double-espresso-chiaro-vertuo-coffee-capsules">
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"catalog:coffee::pdp-coffee-capsule-name:originalline","pageName":"Capsules PDP","primaryCategory":"CAPSULE","secondaryCategory":["Double Espresso","Milk Selection","Double Espresso"],"segmentBusiness":"B2C","technology":["vertuo"],"type":"","variant":""}}};
...
<noscript>
  ...
  <script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-1719248c-8d45-4e07-a456-92a821932544","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<div id="respPromotionBannersBlockCapsules_PDP-8801697212176-ceccb7cc-ddb6-4626-9462-ccce8f8f4886" class="crema-ui-container "></div>
<script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockCapsules_PDP-8801697212176-ceccb7cc-ddb6-4626-9462-ccce8f8f4886","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockCapsules_PDP-8801697212176-7f205459-bdad-47e0-a541-84b3a078cc6e","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockControllerhttps://www.nespresso.com/ecommerce-data?componentUid=respPromotionBannersBlockCapsules_PDP"}}});
</script>
<script type="text/javascript">
...
$(document).keyup(function(e) {
    if (e.keyCode == 27) {
        ...
        <div id="respProductDetailPDPCapsule-8797707544336-abe42c67-1cec-4a94-b3c0-a3a11d989427" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/7378.40">
        					...
        					<div class="ProductDetails__marketingFeatures">
        						<div class="FreeHTML">
        							<div class="ProductDetails__intensity ProductDetails__col-wrapper">
        								<span class="ProductDetails_info">강도: ${dto.cv_intensity }</span>
        							</div>
        				...
        				<div class="ProductDetailsBody">
        					...
        					<div class="ResponsiveContainer">
        						<div class="ProductDetailsBodyInformation">
        							<div class="ProductDetailsBodyInformation__title">${dto.cv_bigName2 }</div>
        							<div class="ProductDetailsBodyInformation__description" itemprop="description">
        								<div class="FreeHTML"><!-- PDP RESPONSIVE CHIARO VERTUO -->
											<span>${dto.cv_atContent1 }</span><p></p>
 											<div class="ResponsiveContainer">
												<link href="https://www.nespresso.com/shared_res/agility/enhancedPDP/vertuo/css/enhancedPDP_responsive_vertuo_double_espresso.css" rel="stylesheet" media="screen">
												 <div class="pdpEnhancement">
												 	<div class="productDescription">
												 		<div class="productVisual">
												 			<img src="${dto.cv_aticleCoffee2 }">
												 		</div>
												 		<ul>
															<li>
																<strong><!--Text to localize-BEGIN-->강도<!--Text to localize-END--></strong>
																<span class="spacing">${dto.cv_atContent2 }</span>
															</li>
															<li>
																<strong><!--Text to localize-BEGIN-->컵 사이즈<!--Text to localize-END--></strong>
																<span><!--Text to localize-BEGIN-->${dto.cv_atContent3 }<!--Text to localize-END--></span>
															</li>
															<li>
																<strong><!--Text to localize-BEGIN-->아로마 프로파일<!--Text to localize-END--></strong>
																<span><!--Text to localize-BEGIN-->${dto.cv_atContent4 }<!--Text to localize-END--></span>
															</li>
															<li>
																<strong><!--Text to localize-BEGIN-->아로마 군<!--Text to localize-END--></strong>
																<span><!--Text to localize-BEGIN-->${dto.cv_atContent5 }<!--Text to localize-END--></span>
															</li>
														</ul>
 														<ul>
														<li>
															<strong><!--Text to localize-BEGIN-->쓴맛<!--Text to localize-END--></strong>
															<span>${dto.cv_bitterness1 }</span>
														</li>
														<li>
															<strong><!--Text to localize-BEGIN-->산미<!--Text to localize-END--></strong>
															<span>${dto.cv_acidity1 }</span>
														</li>
														<li>
															<strong><!--Text to localize-BEGIN-->바디감<!--Text to localize-END--></strong>
															<span>${dto.cv_body1 }</span>
														</li>
														<li>
															<strong><!--Text to localize-BEGIN-->로스팅<!--Text to localize-END--></strong>
															<span>${dto.cv_roastiness1 }</span></li>
														</ul>
 													</div>
													<div class="text-map" style=" padding: 40px; ">
														<p style="text-align: center; line-height: 150%; font-size: 150%;">
															<em>원산지:</em><br>
															<span style="color:#Bf9c5f;">${dto.cv_atContent6 }</span>
														</p>
													</div>
													<div>
														<c:if test="${dto.cv_num==33 }">
														<ul class="map scuro">
															<li class="guatemala"><!--Text to localize-BEGIN-->과테말라<!--Text to localize-END--></li>
															<li class="costarica"><!--Text to localize-BEGIN-->코스타리카<!--Text to localize-END--></li>
														</ul>
														</c:if>
														<c:if test="${dto.cv_num==34 }">
														<ul class="map chiaro">
															<li class="colombia"><!--Text to localize-BEGIN-->콜롬비아<!--Text to localize-END--></li>
															<li class="brazil"><!--Text to localize-BEGIN-->브라질<!--Text to localize-END--></li>
															<li class="costarica2"><!--Text to localize-BEGIN-->코스타리카<!--Text to localize-END--></li>
														</ul>
														</c:if>
													</div>
													<div class="coffeeRange">
														<ul>
															<li style="background-image:url(${dto.cv_aticleCoffee4 })"></li>
															<li>
																<div>
																	<p><!--Text to localize-BEGIN-->${dto.cv_atContent10 }<!--Text to localize-END--></p>
																	<c:if test="${dto.cv_num==33 }">
																	<a href="${articleUrl6}?cv_num=34">
																	<!--Text to localize-BEGIN-->${dto.cv_atContent11 }<!--Text to localize-END-->
																	</a></c:if>
																	<c:if test="${dto.cv_num==34 }">
																	<a href="${articleUrl6}?cv_num=33">
																	<!--Text to localize-BEGIN-->${dto.cv_atContent11 }<!--Text to localize-END-->
																	</a></c:if>
																</div>
															</li>
...
<!--div class="recipes">
<ul>
<li><img src="https://www.nespresso.com/shared_res/agility/enhancedPDP/vertuo/images/Double_espresso_1_335x335.jpg"></li>
<li><img src="https://www.nespresso.com/shared_res/agility/enhancedPDP/vertuo/images/Double_espresso_2_335x335.jpg"></li>
<li><img src="https://www.nespresso.com/shared_res/agility/enhancedPDP/vertuo/images/Double_espresso_335x335.jpg"></li>
<li><div><p><Text to localize-BEGIN>DOUBLE ESPRESSO COFFEE RECIPES<Text to localize-END></p><a href="#"><Text to localize-BEGIN>Try now!<!--Text to localize-END--></div>
</div> 
<!-- END PDP RESPONSIVE CHIARO VERTUO --></div></div></div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceDisplay__list">
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpEspresso2?cv_num=29">
					<span class="VisuallyHidden">디아볼리토</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10386861522974/C-0114-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">디아볼리토</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpEspresso2?cv_num=30">
					<span class="VisuallyHidden">알티시오</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10386860933150/C-0110-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">알티시오</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpEspresso2?cv_num=32">
					<span class="VisuallyHidden">디카페나토 인텐소</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10588177596446/C-0112-2000x2000.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">디카페나토 인텐소</div>
				</a>
			</li>
		</ul>
	</div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceOrder__list">
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						<a class="AccessibleLink ProductPush__link track-product-click" href="/nespresso/product/ogaccView?ao_num=22" 
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
							<img src="https://www.nespresso.com/ecom/medias/sys_master/public/10392979341342/A-0075-VIEW-Lungo-2000X2000-2.png?impolicy=product&imwidth=100">
						</a>
					</div>
					<a class="AccessibleLink ProductPush__link-name track-product-click" href="/nespresso/product/ogaccView?ao_num=22" 
					data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" 
					data-product-position="1">
						<div class="ProductPush__name">뷰 룽고 컵 세트</div>
					</a>
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
...
<script type="text/javascript" src="/GVnF44mcKIns/K6SNIXOXTh/Pz/NY1kVkt0VO/UFlZ/MSYGdl/cCED8"></script>
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script><script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(4257);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script><link rel="stylesheet" type="text/css" href="https://www.contact.nespresso.com/apps.php?a=calleo-livechat.css"><link rel="stylesheet" type="text/css" href="https://www.contact.nespresso.com/apps.php?a=calleo-triggers.css"><script type="text/javascript" id="">ah.wrap(function(b){var a=b.split;b.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5859),google_tag_manager["GTM-WJGQVL"].macro(5860),{content_ids:[google_tag_manager["GTM-WJGQVL"].macro(5861)],content_name:google_tag_manager["GTM-WJGQVL"].macro(5862),currency:google_tag_manager["GTM-WJGQVL"].macro(5863)||google_tag_manager["GTM-WJGQVL"].macro(5864),is_live:google_tag_manager["GTM-WJGQVL"].macro(5865),landscape:google_tag_manager["GTM-WJGQVL"].macro(5866),language:google_tag_manager["GTM-WJGQVL"].macro(5867),num_items:google_tag_manager["GTM-WJGQVL"].macro(5869),product_range:a(google_tag_manager["GTM-WJGQVL"].macro(5870)),product_technology:a(google_tag_manager["GTM-WJGQVL"].macro(5871)),product_type:a(google_tag_manager["GTM-WJGQVL"].macro(5872)),user_id:google_tag_manager["GTM-WJGQVL"].macro(5873),user_owned_machines:a(google_tag_manager["GTM-WJGQVL"].macro(5880)),
value:google_tag_manager["GTM-WJGQVL"].macro(5881)||0})})(ah.facebook);</script><script type="text/javascript" id="">for(var products=google_tag_manager["GTM-WJGQVL"].macro(5922),PURCHASE_EVENT_NAME="customTransaction",event=google_tag_manager["GTM-WJGQVL"].macro(5923),isTransactionEvent=event===PURCHASE_EVENT_NAME,pushedCategories,pushedGroupTagStrings=[],checkoutStepName=google_tag_manager["GTM-WJGQVL"].macro(5924),checkoutStepLookup={"checkout delivery":"del","shopping bag":"crt","checkout payment":"pay","checkout recap":"sum"},prefixLookup={addToCart:"add",productClick:"clk",detailView:"dtl",impression:"imp",checkout:checkoutStepLookup[checkoutStepName],customTransaction:"sal"},
technologyLookup={original:"ol",vertuo:"vl"},groupTagStringPrefix=prefixLookup[event],standardSuffix=isTransactionEvent?"t":"s",isCartEvent="crt"===groupTagStringPrefix,i=0;i<products.length;i++){var dimension56Technology=products[i].dimension56?products[i].dimension56.toLowerCase().match(/\w+/)[0]:"original",technologySuffix=technologyLookup[dimension56Technology],isSubscription="70000"===products[i].id||-1!=products[i].name.toLowerCase().indexOf("subscription")||"sub"==products[i].id||-1!=google_tag_manager["GTM-WJGQVL"].macro(5925).indexOf("subscription")||
"SUB"===products[i].dimension53||"subscription_range"===products[i].dimension55,productCategory=products[i].category,categorySuffix;!isSubscription||-1==google_tag_manager["GTM-WJGQVL"].macro(5926).indexOf("machine")&&-1==productCategory.indexOf("machine")?isSubscription&&(-1!=google_tag_manager["GTM-WJGQVL"].macro(5927).indexOf("capsule")||-1!=productCategory.indexOf("capsule"))||isSubscription?categorySuffix="cs":isSubscription?google_tag_manager["GTM-WJGQVL"].macro(5928)&&console.error("GTM ERROR: Unidentified subscription product type\n"+JSON.stringify(products[i])):
/machine/g.test(productCategory)?categorySuffix="ma":/capsule/g.test(productCategory)?categorySuffix="ca":/accessor/g.test(productCategory)?categorySuffix="acc":google_tag_manager["GTM-WJGQVL"].macro(5929)&&console.log("Unknown product type:\n"+JSON.stringify(products[i])):categorySuffix="ms";groupTagString="acc"==categorySuffix?groupTagStringPrefix+categorySuffix+standardSuffix:groupTagStringPrefix+categorySuffix+technologySuffix+standardSuffix;var categoryGroupTagString=groupTagStringPrefix+categorySuffix+standardSuffix;
"cs"===categorySuffix&&(isTransactionEvent||isCartEvent)&&(categoryGroupTagString=groupTagStringPrefix+"cc"+standardSuffix);pushedGroupTagStrings.includes(categoryGroupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5930)&&console.log("Pushing Group tag string: "+categoryGroupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:categoryGroupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5931)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5932))}}),
pushedGroupTagStrings.push(categoryGroupTagString));pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5933)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5934)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5935))}}),pushedGroupTagStrings.push(groupTagString))}
var standardEventSuffix=isTransactionEvent?"e":"s";groupTagString=groupTagStringPrefix+standardEventSuffix;pushedGroupTagStrings.includes(groupTagString)||(google_tag_manager["GTM-WJGQVL"].macro(5936)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5937)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5938))}}),pushedGroupTagStrings.push(groupTagString));
isTransactionEvent&&google_tag_manager["GTM-WJGQVL"].macro(5939)&&(groupTagString="salnct",google_tag_manager["GTM-WJGQVL"].macro(5940)&&console.log("Pushing Group tag string: "+groupTagString+"\nproduct: "+JSON.stringify(products[i])),gtmDataObject.push({event:event+"_floodlightEcommerce",groupTagString:groupTagString,newClientTransaction:1,ecommerce:{detail:google_tag_manager[google_tag_manager["GTM-WJGQVL"].macro(5941)].dataLayer.get(google_tag_manager["GTM-WJGQVL"].macro(5942))}}),pushedGroupTagStrings.push(groupTagString));</script><script type="text/javascript" id="">ah.wrap(function(){var f=google_tag_manager["GTM-WJGQVL"].macro(5948),e={event:"recommendations_ai_ready",eventRaisedBy:"GTM",automl:{eventType:google_tag_manager["GTM-WJGQVL"].macro(5949),productEventDetail:{productDetails:f}}},v=f.filter(function(b){return b.recommendationToken})[0];v&&(e.automl.eventDetail={recommendationToken:v});"purchase-complete"===google_tag_manager["GTM-WJGQVL"].macro(5950)&&(e.automl.productEventDetail.purchaseTransaction={revenue:google_tag_manager["GTM-WJGQVL"].macro(5951),currencyCode:google_tag_manager["GTM-WJGQVL"].macro(5952)});window.napi&&window.napi.catalog?Promise.all(f.map(function(b){b=
