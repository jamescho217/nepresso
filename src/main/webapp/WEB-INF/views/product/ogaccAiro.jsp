	...
	$.ajax({
		...
		success : function(data) {
			...
			if( data == 0) {
				...
				window.location.href = "<%=cp%>/product/ogaccAiro?ao_num=" + num;
			}			
		}
	});
}
        				...
        				<div class="ResponsiveContainer">
        					<div class="ProductDetailsBodyInformation">
        						<div class="ProductDetailsBodyInformation__description" itemprop="description">
        							<c:if test="${dto.ao_num!=7 }">
        							<div class="FreeHTML">
        								<p>${dto.ao_atContent1 }</p><br/>
        								<p>${dto.ao_atContent2 }</p>
        								<p>${dto.ao_atContent3 }</p>
        								<p>${dto.ao_atContent4 }</p>
										<table border="0" cellspacing="0" cellpadding="0" style="margin-top:20px;">
											<tbody>
												<tr>
													<td align="left" valign="middle" style="border-bottom-style: none !important; text-align: left !important; width: 30px;">
														<a href="${dto.ao_atContent5 }" target="_blank">
															<img class="nes_l-float" src="${dto.ao_atContent6 }" border="0" width="30" height="30" alt="">
														</a>
													</td>
													<td align="left" valign="middle" style="border-bottom-style: none !important; text-align: left !important;">
														<a href="https://www.nespresso.com/shared_res/manuals/aeroccino/www_Aeroccino4_Z3(EN_KR_CN_HK_TW).pdf" target="_blank">
														${dto.ao_atContent7 }</a>
													</td>
												</tr>
												<tr>
													<td align="left" valign="middle" style="border-bottom-style: none !important; text-align: left !important; width: 30px;">
														<img class="nes_l-float" src="${dto.ao_atContent8 }" border="0" width="30" height="30" alt="">
													</td>
													<td align="left" valign="middle" style="border-bottom-style: none !important; text-align: left !important;">
														<a href="http://www.nespresso.com/kr/ko/machine-assistance#!/Aeroccino-4" target="_blank">${dto.ao_atContent9 }</a>
													</td>
												</tr>
											</tbody>
										</table>
