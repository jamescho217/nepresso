			...
			<div class="ResponsiveContainer ProductList__container">
				...
				<div class="ProductList__content">
					<div class="ProductListTechnologies">
						<a href="/nespresso/product/originalacc" class="AccessibleLink ProductListTechnologies__link">
							<div class="ProductListTechnologies__element">
								<img width="120" height="80" src="https://www.nespresso.com/ecom/medias/sys_master/public/13009459740702/respCapsuleTechnoFilterOriginal.png?impolicy=small&amp;imwidth=120"
						...
						<a href="/nespresso/product/vertuoacc" class="AccessibleLink ProductListTechnologies__link ProductListTechnologies__link--selected">
							<div class="ProductListTechnologies__element">
								<img width="120" height="80" src="https://www.nespresso.com/ecom/medias/sys_master/public/10866892931102/respCapsuleTechnoFilterVertuoOn.png?impolicy=small&amp;imwidth=120"
									role="presentation" class="ResponsiveImage ProductListTechnologies__image" alt="">
									...
									<div
										...
										<div class="AddToBagButton__container">
											<div id="AddToBagButton__button-CremaComponentId-2">
												<button class="AddToBagButton AddToBagButtonLarge"
													data-focus-id="AddToBagButton__button-CremaComponentId-2">
													<span class="AddToBagButtonLarge__basketIcon"> <i
														aria-hidden="true" class="Glyph Glyph--basket"></i>
													</span> <span class="VisuallyHidden">고객님의 장바구니에 리미티드 에디션
														버츄오 머그 컵 가 없습니다. 구매를 원하시면, 해당 상품을 담으세요.</span> <span
														class="AddToBagButtonLarge__label" aria-hidden="true">장바구니
														담기</span> <i aria-hidden="true"
														class="Glyph Glyph--plus AddToBagButtonLarge__plusIcon"></i>
												</button>
											</div>
										</div>
