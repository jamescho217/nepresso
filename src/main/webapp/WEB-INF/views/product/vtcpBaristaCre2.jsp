...
<meta name="keywords" content="바닐라, 바닐라향, 바닐라커피, 네스프레소바닐라, 바닐라에클레어, 바닐라향에클레어커피, 네스프레소, 캡슐커피">
<meta name="description" content="새로워진 네스프레소 바리스타 크리에이션 바닐라향 에클레어 커피를 만나보세요. 커피 전문성을 담은 바리스타 스타일의 바닐라향 에클레어 커피 레시피를 집에서 쉽게 즐길 수 있습니다.">
<meta property="og:title" content="바닐라향 에클레어 캡슐 커피 | 바리스타 크리에이션  캡슐 커피 | 네스프레소">
<meta property="og:url" content="https://www.nespresso.com:443/kr/ko/order/capsules/original/vanilla-eclair-coffee-capsule">
<meta property="og:description" content="새로워진 네스프레소 바리스타 크리에이션 바닐라향 에클레어 커피를 만나보세요. 커피 전문성을 담은 바리스타 스타일의 바닐라향 에클레어 커피 레시피를 집에서 쉽게 즐길 수 있습니다.">
<meta property="og:image" content="https://www.nespresso.com/ecom/medias/sys_master/public/13045071806494/C-0600-media-684x378px.jpg">
<title>${dto.cv_modelName1 } 캡슐 커피 | 바리스타 크리에이션  캡슐 커피 | 네스프레소</title>
<link rel="canonical" href="https://www.nespresso.com/kr/ko/order/capsules/original/vanilla-eclair-coffee-capsule">
...
<div id="respPromotionBannersBlockCapsules_PDP-8801697212176-7ee24743-a895-4b6e-89fa-6187ba20553a" class="crema-ui-container "></div>
<script>
              window.ui = window.ui || [];
              window.ui.push({"id":"respPromotionBannersBlockCapsules_PDP-8801697212176-7ee24743-a895-4b6e-89fa-6187ba20553a","module":"PromotionBanner","configuration":{"translations":{"promotionbannersrespblock.a11y.title":"프로모션 배너","promotionbannersrespblock.npm.choose.button":"선택하기"},"props":{"meta":{"uid":"respPromotionBannersBlockCapsules_PDP-8801697212176-6b599fe9-3201-42e5-938d-6d7ef4d71059","restrictions":[],"tracking":null},"shouldHaveBackgroundColor":true,"bannerElements":[]},"eCommerceData":{"promotions":[],"sourceUrl":"/kr/ko/view/responsive/promotionBannersBlockControllerhttps://www.nespresso.com/ecommerce-data?componentUid=respPromotionBannersBlockCapsules_PDP"}}});
            </script>
<script type="text/javascript">
...
$(document).keyup(function(e) {
    if (e.keyCode == 27) {
        ...
        <div id="respProductDetailPDPCapsule-8797707544336-8b5a9a03-bf9a-4666-8035-72c1a02a66d6" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/7553.40">
        			...
        			<div class="ResponsiveContainer ProductDetails__display">
        				...
        				<div class="ProductDetails__information">
        					...
        					<div class="ProductDetails__flavors">
        						<span class="ProductDetails__specs">바닐라향</span>
        					</div>
        					<div>
        		...
        		<div>
        			<c:if test="${dto.cv_cupSize6!=null }">
        			...
        			<div class="ProductDetailsBody" style="background-image: url(${dto.cv_bg});">
        				<h3 class="VisuallyHidden">상품 설명</h3>
        				<div class="ResponsiveContainer">
        					<div class="ProductDetailsBodyInformation">
        						<div class="ProductDetailsBodyInformation__title">벨벳 같은 바닐라 향이 더해진 부드러운 커피</div>
        						<div class="ProductDetailsBodyInformation__description" itemprop="description">
        							<div class="FreeHTML">
										<link rel="stylesheet" href="https://www.nespresso.com/shared_res/mos/free_html/int/barista-flavoured/coffee-pdp/css/pdp-vanilla-eclair.css">
										<div class="wrapper-ResponsiveContainer background-vanilla">
										    <div>
										        <div class="pdpEnhancement">
										            <div class="barista-logo">
										                <img src="${dto.cv_bigName1 }" alt="Barista Creations Logo">
										            </div>    
													<h1 class="header-title"><!--Text to localize-BEGIN-->${dto.cv_bigName2 }<!--Text to localize-END--></h1>
													<div class="flex-container capsule-attribute">
										                <div class="flex-item capsule-attribute__properties">
										                    <div class="left">
										                        <ul>
										                            <li><h3><!--Text to localize-BEGIN-->${dto.cv_roastiness1 }<!--Text to localize-END--></h3><span>${dto.cv_roastiness2 }</span></li>
										                            <li><h3><!--Text to localize-BEGIN-->${dto.cv_acidity1 }<!--Text to localize-END--></h3><span>${dto.cv_acidity2 }</span></li>
										                        </ul>
										                    </div>                
										                </div>
										                ...
										                <div class="flex-item capsule-attribute__properties">
										                    <div class="right">
										                        <ul>
                            <li><h3><!--Text to localize-BEGIN-->쓴맛<!--Text to localize-END--></h3><span>■ □ □ □ □</span></li>
            ...
            <div class="capsule-attribute__buy">
				<div class="add-to-bag" data-product-id="7553.40" data-button-size="large" data-initialized="true">
					<div class="AddToBagButton__container">
						<div id="AddToBagButton__button-CremaComponentId-2">
							<button class="AddToBagButton AddToBagButtonLarge" data-focus-id="AddToBagButton__button-CremaComponentId-2">
								...
								<span class="VisuallyHidden">고객님의 장바구니에 바닐라향* 에클레어 커피 가 없습니다. 구매를 원하시면, 해당 상품을 담으세요.</span>
            ...
            <div class="section-text" style="background-color: ${dto.cv_bgColor }">
                <img src="${dto.cv_aticleCoffee3 }" alt="Vanilla Eclair Coffee" class="section-vanilla__logo">
				<p><!--Text to localize-BEGIN-->${dto.cv_atContent1 }<!--Text to localize-END--></p>
				<div class="icon-milk">
                    <img src="${dto.cv_aticleCoffee4 }" alt="Flavoured icon">
                </div>
                <div class="section-profile">
                    <h4><!--Text to localize-BEGIN-->${dto.cv_atContent2 }</h4>
                </div>
                <p class="copy-small">${dto.cv_atContent3 }</p>
            </div>     
            <div class="section-recipes" style="background-image: url(${dto.cv_aticleCoffee5 });"></div>
        </div>
    </div>
</div>
<!-- END PDP Vanilla Eclair OL --></div></div></div>
	...
	<div class="ResponsiveContainer">
		...
		<ul class="ProductDetailsReferenceDisplay__list">
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpBaristaCre2?cv_num=7">
					<span class="VisuallyHidden">캐러멜향* 쿠키 커피</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/13044219248670/C-0604-Responsive-Standard-2000x2000-.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">캐러멜향* 쿠키 커피</div>
				</a>
			</li>
			<li class="ProductDetailsReferenceDisplay__element">
				...
				href="/nespresso/product/vtcpBaristaCre2?cv_num=8">
					<span class="VisuallyHidden">헤이즐넛향* 머핀 커피</span>
					<img src="https://www.nespresso.com/ecom/medias/sys_master/public/12923686879262/C-0605-Responsive-Standard-2000x2000-.png?impolicy=product&imwidth=60">
					<div class="ProductDetailsReferenceDisplay__name">헤이즐넛향* 머핀 커피</div>
				</a>
			</li>
		</ul>
	</div>
