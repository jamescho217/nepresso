...
<title>${dto.co_modelName1 } | 바리스타 크리에이션  캡슐 커피 | 네스프레소</title>
...
<script>
        ...
        <div id="respProductDetailPDPCapsule-8797707544336-8b5a9a03-bf9a-4666-8035-72c1a02a66d6" class="crema-ui-container ">
        	<div class="ProductDetails" itemtype="http://schema.org/Product" itemscope="" id="ProductDetail__erp.kr.b2c/prod/7553.40">
        		...
        		<div>
        			<c:if test="${dto.co_cupSize4!=null }">
										    ...
										    <div>
										        <div class="pdpEnhancement">
										            <div class="barista-logo">
										                <img src="${dto.co_bigName1 }" alt="Barista Creations Logo">
										            </div>    
													...
													<div class="flex-container capsule-attribute">
										                <div class="flex-item capsule-attribute__properties">
										                    <div class="left">
										                        <ul>
										                            <li><h3><!--Text to localize-BEGIN-->${dto.co_roastiness1 }<!--Text to localize-END--></h3><span>${dto.co_roastiness2 }</span></li>
										                            <li><h3><!--Text to localize-BEGIN-->${dto.co_acidity1 }<!--Text to localize-END--></h3><span>${dto.co_acidity2 }</span></li>
										                        </ul>
										                    </div>                
										                </div>
            ...
            <div class="section-text" style="background-color: ${dto.co_bgColor };">
                <img src="${dto.co_aticleCoffee3 }" alt="Vanilla Eclair Coffee" class="section-vanilla__logo">
				<p><!--Text to localize-BEGIN-->${dto.co_atContent1 }<!--Text to localize-END--></p>
				<div class="icon-milk">
                    <img src="${dto.co_aticleCoffee4 }" alt="Flavoured icon">
                </div>
                <div class="section-profile">
                    <h4><!--Text to localize-BEGIN-->${dto.co_atContent2 }</h4>
                </div>
                <p class="copy-small">${dto.co_atContent3 }</p>
            </div>     
            <div class="section-recipes" style="background-image: url(${dto.co_aticleCoffee5 });"></div>
        </div>
    </div>
</div>
			...
			<li class="ProductDetailsReferenceOrder__element">
				<article class="ProductPush ProductDetailsReferenceOrder__article">
					<div class="ProductPush__image">
						...
						data-product-code="4192-KR-SI-NE2" data-product-item-id="4192-KR-SI-NE2" data-product-section="이 제품도 함께 즐겨보세요!" data-product-position="1">
							<img alt="" src="https://www.nespresso.com/ecom/medias/sys_master/public/11905775173662/A-0397-2000.png?impolicy=product&imwidth=100">
						</a>
					</div>
					...
					<div class="ProductPush__informations">
						<div class="ProductPush__details">
							<span class="ProductPush__price">₩ <fmt:formatNumber value="28000" pattern="#,###" /></span>
						</div>
						<div class="ProductPush__add-to-bag AddToBagButton__container">
							<div id="AddToBagButton__button-CremaComponentId-2">
								<button class="AddToBagButton AddToBagButtonSmall" data-focus-id="AddToBagButton__button-CremaComponentId-2" type="button">
