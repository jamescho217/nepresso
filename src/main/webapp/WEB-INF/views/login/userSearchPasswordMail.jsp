...
<body data-new-gr-c-s-check-loaded="14.1014.0" data-gr-ext-installed=""
	...
	<c:choose>
		<c:when test="${empty sessionScope.param.email }">
    ...
    config.labels.outOfStock = '일시 품절';
		...
		<div id="discovery-offers">
			<div class="discovery-intro">
				<img
					src="https://www.nespresso.com/ecom/medias/sys_master/public/10229474492446/picto.png"
					alt=""><br />
				<br />
				<div class="discovery-intro__baseline">
					<h2 class="discovery-intro__title">
						입력하신 이메일로 임시 비밀번호를 보냈습니다. 비밀번호 재설정을 <br>
						<br /> 마무리 하시려면 해당 이메일로 가셔서 작업을 해주시기 바랍니다. <br>
					</h2>
					<span class="discovery-intro__sub-title"> <br> 받으신 이메일에
					임시 비밀번호로 로그인 후 마이 페이지에서 비밀번호를 바꿔주시기 바랍니다.
			...
			<form id="welcomeOffer" novalidate="novalidate"
				...
				<div id="discovery-tabs"
					...
					<input type="hidden" id="previousSelectedProductCodes" value=""
						style=""> <span class="discovery-offers__title"></span>
