...
<meta name="description" content="개인정보를 확인해보세요">
<meta property="og:title" content="개인 정보 | 네스프레소 클럽 | 네스프레소">
<meta property="og:url"
	content="https://www.nespresso.com:443/kr/ko/myaccount/editPersonalInformations">
<meta property="og:description" content="개인정보를 확인해보세요">
<title>개인 정보 | 네스프레소 클럽 | 네스프레소</title>
...
<script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"true","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-87deb149-a435-461a-84ba-2e457ec8261f","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624343541052&amp;cv=9&amp;fst=1624343541052&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=44&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_pagetype%3Dother%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D4908990&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2FeditPersonalInformations&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fhome&amp;tiba=%EA%B0%9C%EC%9D%B8%20%EC%A0%95%EB%B3%B4%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%ED%81%B4%EB%9F%BD%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<iframe target="_self" title="SaleCycle"
	src="https://s.salecycle.com/receiver.html?sc_frame_id=456d200c-f1e3-4c46-82e0-b5ff4ef3dcd1"
...
<body data-new-gr-c-s-check-loaded="14.1016.0" data-gr-ext-installed=""
	...
	<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">개인
		정보 | 네스프레소 클럽 | 네스프레소 | Mosaic Site KR</h2>
			...
			<div id="welcome-box" class="welcome-box">
				...
				<ul class="nav myaccount-menu__item-list" id="my-account-menu">
					...
					<li class="menu-item myaccount-menu__item"><a
						...
						id="ta-my-account-links-1" class=" myaccount-menu__link"> <img
							...
							srcset="https://www.nespresso.com/ecom/medias/sys_master/public/10595071524894/adress.svg?impolicy=medium&amp;imwidth=34 1x, /ecom/medias/sys_master/public/10595071524894/adress.svg?impolicy=medium&amp;imwidth=68 2x, /ecom/medias/sys_master/public/10595071524894/adress.svg?impolicy=medium&amp;imwidth=102 3x, /ecom/medias/sys_master/public/10595071524894/adress.svg?impolicy=medium&amp;imwidth=136 4x"
					...
					<li class="menu-item myaccount-menu__item"><a
						...
						id="ta-my-account-links-2" class="activated myaccount-menu__link">
					...
					<li class="menu-item myaccount-menu__item"><a
						...
						id="ta-my-account-links-3" class=" myaccount-menu__link"> <img
							...
							srcset="https://www.nespresso.com/ecom/medias/sys_master/public/10595071655966/machines-ol.svg?impolicy=medium&amp;imwidth=34 1x, /ecom/medias/sys_master/public/10595071655966/machines-ol.svg?impolicy=medium&amp;imwidth=68 2x, /ecom/medias/sys_master/public/10595071655966/machines-ol.svg?impolicy=medium&amp;imwidth=102 3x, /ecom/medias/sys_master/public/10595071655966/machines-ol.svg?impolicy=medium&amp;imwidth=136 4x"
					...
					<li class="menu-item myaccount-menu__item"><a
						...
						id="ta-my-account-links-4" class=" myaccount-menu__link"> <img
							...
							srcset="https://www.nespresso.com/ecom/medias/sys_master/public/10595071787038/contact-pref.svg?impolicy=medium&amp;imwidth=34 1x, /ecom/medias/sys_master/public/10595071787038/contact-pref.svg?impolicy=medium&amp;imwidth=68 2x, /ecom/medias/sys_master/public/10595071787038/contact-pref.svg?impolicy=medium&amp;imwidth=102 3x, /ecom/medias/sys_master/public/10595071787038/contact-pref.svg?impolicy=medium&amp;imwidth=136 4x"
				...
				<div id="account-menu" class="dropdown">
					<button type="button"
						...
						<span class="button__content"> 개인 정보</span> <i
					...
					<ul class="menu-items">
						...
						<li><a class="dropdown-link"
							href="<%=cp%>/login/myPage/pinfo">
								개인 정보<span class="visually-hidden"> selected</span>
						</a></li>
					<li><a class="dropdown-link"
							href="<%=cp%>/login/myPage/myMachine"> 나의
								머신</a></li>
						<li><a class="dropdown-link"
							href="<%=cp%>/login/myPage/infoAlarm">
								정보 수신 항목 설정</a></li>
		...
		<div class="main">
			<div id="my-account-personal-info" class="ng-scope">
				...
				<form id="editPersonalInfoForm" novalidate="novalidate"
					action="<%=cp %>/login/myPage/pinfo/update" method="post"
				...
				<form action="<%=cp%>/login/myPage/pinfo/updatePwd" method="post">
					<div class="form-separator personal-info__form-container">
						...
						<div class="clearfix field-line nes_bloc_pass input-group empty">
							<div class="input-row">
								<label for="confirmPassword" class="input-label"> 새 비밀번호<span
					...
					<input id="jeton" name="jeton" type="hidden"
						value="1d4fa1ca-4f99-406c-82f0-66362cd82194" style=""
...
<![endif]-->
	...
	<script type="text/javascript"
		src="/T7bmxN_sOnhGS/f8ry/btVXBWBmQA/h9iDtcbr7u9Y/Zmw1TEs/dhZHXhU/CYg4"></script>
...
"\u01b6":"z","\u0225":"z","\u0240":"z","\u2c6c":"z","\ua763":"z"});</script>
	...
	<script type="text/javascript" id="">ah.wrap(function(b,f,e,m,d,c,n,g,p,k){c=b.fbq=b.fbq||function(){b=arguments;c[m]?c[m].apply(c,b):n.push(b)};b._fbq=b._fbq||c;c.push=c;c.version="2.0";n=c.queue=[];b=f.getElementsByTagName(e)[0];e=f.createElement(e);c.loaded=e.async=!0;e.src="//connect.facebook.net/en_US/fbevents.js";b.parentNode.insertBefore(e,b);ah.facebook={split:function(a){return a?a.split(/\|+/):[]},track:function(a){google_tag_manager["GTM-WJGQVL"].macro(5279)&&console.log("FB Deprecated Track Fired");if(a){a=a.split(";");d="product"!==a[3]?{page_type:d=
a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];c(a[2],a[1],d)}},trackSingle:function(a,h){if(a&&h){a=a.split(";");h=h.split(",");google_tag_manager["GTM-WJGQVL"].macro(5280)&&console.log("FB Data: "+a);google_tag_manager["GTM-WJGQVL"].macro(5281)&&console.log("FB Pixels: "+h);d="product"!==a[3]?{page_type:d=a[3],content_category:a[4]||d}:{content_type:d=a[3],content_category:a[4]||d};b=arguments;for(e=b.length+1;--e;)if(f=b[e])for(g in f)d[g]=f[g];
for(var q="track"==a[2]?"trackSingle":"trackSingleCustom",l=0;l<h.length;l++)c(q,h[l],a[1],d)}}};g=google_tag_manager["GTM-WJGQVL"].macro(5282).split(",");for(p=0;k=+g[p++];)c("set","autoConfig",!1,k),c("init",k);0!=google_tag_manager["GTM-WJGQVL"].macro(5283)&&(c("set","autoConfig",!1,google_tag_manager["GTM-WJGQVL"].macro(5284)),c("init",google_tag_manager["GTM-WJGQVL"].macro(5285)))})(window,document,"script","callMethod");</script>
	<script type="text/javascript" id="">ah.wrap(function(a){a.trackSingle(google_tag_manager["GTM-WJGQVL"].macro(5290),google_tag_manager["GTM-WJGQVL"].macro(5291),{content_name:google_tag_manager["GTM-WJGQVL"].macro(5294),content_subsection:google_tag_manager["GTM-WJGQVL"].macro(5297),content_technology:google_tag_manager["GTM-WJGQVL"].macro(5300),is_live:google_tag_manager["GTM-WJGQVL"].macro(5301),landscape:google_tag_manager["GTM-WJGQVL"].macro(5302),language:google_tag_manager["GTM-WJGQVL"].macro(5303),user_id:google_tag_manager["GTM-WJGQVL"].macro(5304),user_owned_machines:a.split(google_tag_manager["GTM-WJGQVL"].macro(5311))})})(ah.facebook);</script>
...
"getAttribute","offsetParent","getElement","innerWidth","innerHeight","clientWidth","clientHeight","length","click","innerHTML","innerText","promotion","roduct","impression","position","Scroll","gtmTracked","Load","load","DOMContentLoaded","EventListener");</script>
	<script type="text/javascript" id="">ah.wrap(function(g,t,w,x,n,y,z,A,u,B,C,p,h,D,l,c){function E(b,d){var a=g[b]=g[b]||function(){e=arguments;a[x]?a[x].apply(a,e):a.queue.push(e)},e=t.getElementsByTagName(w)[0],f=t.createElement(w);g[b="_"+b]=g[b]||a;a.push=a;a.loaded=!0;a.version="1.0";a.queue=[];a.market=google_tag_manager["GTM-WJGQVL"].macro(5352);a.language=google_tag_manager["GTM-WJGQVL"].macro(5353);a.channel=google_tag_manager["GTM-WJGQVL"].macro(5354);f.async=!0;f.src="//www."+("true"===google_tag_manager["GTM-WJGQVL"].macro(5355)?"":"vst.")+"contact.nespresso.com/apps.php?a\x3dcalleo-"+d+(/(msie [1-9]|Trident\/7\.0)/i.test(navigator.userAgent)?
"\x26v\x3die":"");e.parentNode.insertBefore(f,e)}function F(b,d,a,e){a&&a(l);c=function(f,G,q,m,r){m&&m(l);m=m||a;q=q||f.replace(/e?$/,"ed");g[n+b]("add"+b+"Listener",f[z](),D[r=d+q]=y(function(I,J,H,k,v){k=G||"Click";k={eventAction:"Source:"+H+";Action:"+k,eventLabel:q,calleoChatType:d,nonInteraction:+!!G};for(v in l)k[v]=l[v];k[r]=1;m&&m(k,H,I,J);gtmDataObject.push(k)}));l[r=h+r]=e}}l={event:h=n+u,eventRaisedBy:"GTM"};D=ah[h]={};"true"===google_tag_manager["GTM-WJGQVL"].macro(5356)+""&&(E(h,"livechat"),F(u,A),c(C),c("Start"),
c("End"),c("Cancel"),c("Rating",0,"Reviewed",function(b,d){function a(e,f){b[h+A+"Review"+e]=d&&(f||["","Very good","Good","Fairly good","Not acceptable"])[+d[e[z]()]]}a("Delay");a("Quality");a("Satisfaction",["No","Yes"])}),t.addEventListener("click",y(function(b,d){d=b.target;/(^|\s)open-live-chat(\s|$)/.test(d.id+" "+d.className)&&(b.preventDefault(),g[h]("start"+u))})));if("true"===google_tag_manager["GTM-WJGQVL"].macro(5357)+""){E(n+p,"triggers");if(c=google_tag_manager["GTM-WJGQVL"].macro(5358))g[n+p]("NessclubId",c);F(p,B,function(b,d,
...
e&&Array.prototype.forEach.call(document.querySelectorAll(c),function(a){k.test(a.className)||(a.className+=a.className?" "+e:e)}),c}var d,e,k;ah.sessioncam={hide_pii:g,init:function(e,b){function c(){g(b,google_tag_manager["GTM-WJGQVL"].macro(5359),"ignorechanges");g(b,google_tag_manager["GTM-WJGQVL"].macro(5360),"hidetext");var a=document.getElementsByTagName("script")[0],c=document.createElement("script");c.async=!0;c.src="//d2oh4tlt9mrke9.cloudfront.net/Record/js/sessioncam.recorder.js";a.parentNode.insertBefore(c,a)}var a=ah.extend({Channel:google_tag_manager["GTM-WJGQVL"].macro(5361),
DeviceType:google_tag_manager["GTM-WJGQVL"].macro(5362),IsMobileSite:0,Landscape:google_tag_manager["GTM-WJGQVL"].macro(5363),LanguageCode:google_tag_manager["GTM-WJGQVL"].macro(5364),PrimaryCategory:google_tag_manager["GTM-WJGQVL"].macro(5365),Technology:google_tag_manager["GTM-WJGQVL"].macro(5366),UserIsLoggedIn:+("true"===google_tag_manager["GTM-WJGQVL"].macro(5367)),UserID:google_tag_manager["GTM-WJGQVL"].macro(5368)},e);b=b||google_tag_manager["GTM-WJGQVL"].macro(5381);sessioncamConfiguration={SessionCamHostname:location.href.replace(/^([^\/]+\/\/[^\/]+)\/.*$/,"$1."+google_tag_manager["GTM-WJGQVL"].macro(5383)),SessionCamPath:a.PrimaryCategory,SessionCamPageName:google_tag_manager["GTM-WJGQVL"].macro(5384)+":"+b,customDataObjects:Object.keys(a).map(function(b){return[{key:b,
value:a[b]}]}),elementsToRemove:g(b,google_tag_manager["GTM-WJGQVL"].macro(5385))};var d=document.readyState;if("complete"===d||"loading"!==d&&!document.documentElement.doScroll)setTimeout(ah.wrap(c));else{var f=ah.wrap(function(){f&&(document.removeEventListener("DOMContentLoaded",f),window.removeEventListener("load",f),f=0,c())});document.addEventListener("DOMContentLoaded",f);window.addEventListener("load",f)}}}})(eval);</script>
	<script type="text/javascript" id="">ah.wrap(function(){ah.sessioncam.init()})();</script>
	<script type="text/javascript" id="">var pageViewDebug=false&&google_tag_manager["GTM-WJGQVL"].macro(5386);var pageTech=google_tag_manager["GTM-WJGQVL"].macro(5389);var pageSub1=google_tag_manager["GTM-WJGQVL"].macro(5392);var pagePath=google_tag_manager["GTM-WJGQVL"].macro(5393);var isMachinePage=pageSub1==="machines";var isCapsulePage=pageSub1==="coffee";var isAccessoryPage=pageSub1==="accessories"||pagePath.indexOf("accessories")!=-1;var isVertuoPage=pagePath.indexOf("vertuo")!==-1||pageTech==="vertuoline";var isOriginalPage=pageTech==="originalline"&&!isVertuoPage||!isVertuoPage;var isComboSubscriptionPage=pageSub1==="combo-subscription";
...
if((isMachinePage||isCapsulePage||isAccessoryPage)&&isOriginalPage)dlPush("pagols");if(!isSubscriptionPage&&isVertuoPage)dlPush("pagvls");if(isMachinePage)dlPush("pagmas");if(isCapsulePage)dlPush("pagcas");function dlPush(groupTagString){gtmDataObject.push({"event":"floodlightPageview","groupTagString":groupTagString})};</script>
	<script type="text/javascript" id="">ah.wrap(function(){var a=google_tag_manager["GTM-WJGQVL"].macro(5395);if(void 0!=a){a=a.replace(/GAX\d*\.\d*\./,"").split("!");for(var c=0;c<a.length;c++){var b=a[c],d=b.split(".")[0];b=b.split(".")[2];d={key:"GoogleOptimize",value:d+"-"+b};window.sessioncamConfiguration.customDataObjects.push(d)}}})();</script>
