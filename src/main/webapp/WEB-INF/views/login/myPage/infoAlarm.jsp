...
<meta name="keywords" content="네스프레소소식, 네스프레소클럽,커피머신, 커피캡슐, 네스프레소">
<meta name="description"
	content="네스프레소 소식을 이메일로 받아보세요. 한정판 커피 출시와 새로운 프로모션 등의 소식을 이메일로 안내 받아 보실 수 있습니다.">
<meta property="og:title" content="네스프레소 소식 | 네스프레소 클럽 | 네스프레소">
<meta property="og:url"
	content="https://www.nespresso.com:443/kr/ko/myaccount/showMySubscriptions">
<meta property="og:description"
	content="네스프레소 소식을 이메일로 받아보세요. 한정판 커피 출시와 새로운 프로모션 등의 소식을 이메일로 안내 받아 보실 수 있습니다.">
<title>네스프레소 소식 | 네스프레소 클럽 | 네스프레소</title>
...
<script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-293d5b1e-d989-42e7-87ff-9274c723a2a8","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<link id="dnsprefetchlink" rel="dns-prefetch"
	href="//v542hf3ijk7q6ygr7izq-f-6cf4c7a59-clientnsv4-s.akamaihd.net">
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624373811140&amp;cv=9&amp;fst=1624373811140&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=5&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_pagetype%3Dother%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D4908990&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2FshowMySubscriptions%3Fsaved%3Dtrue&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2FshowMySubscriptions&amp;tiba=%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%EC%86%8C%EC%8B%9D%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%ED%81%B4%EB%9F%BD%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<iframe target="_self" title="SaleCycle"
	src="https://s.salecycle.com/receiver.html?sc_frame_id=ee5614f1-d97c-45e9-9cb1-dda435e47857"
...
<body data-new-gr-c-s-check-loaded="14.1016.0" data-gr-ext-installed=""
	...
	<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">네스프레소
		소식 | 네스프레소 클럽 | 네스프레소 | Mosaic Site KR</h2>
	<span tabindex="-1" id="a11y-message-area" class="visually-hidden">
	...
	<div class="clearfix account">
			...
			<div id="welcome-box" class="welcome-box">
				...
				<div class="welcome">
					<div class="clearfix">
						<div class="col">
							...
							<p class="member welcome-box__label sessioncamhidetext">${sessionScope.userSession.lName }${sessionScope.userSession.name }님
								환영합니다.</p>
				...
				<div id="account-menu" class="dropdown">
					<button type="button"
						...
						<span class="button__content"> 정보 수신 항목 설정</span> <i
					...
					<ul class="menu-items">
						...
						<li><a class="dropdown-link"
							href="<%=cp %>/login/myPage/infoAlarm"> 정보 수신 항목 설정<span
								class="visually-hidden"> selected</span>
						</a></li>
					</ul>
				</div>
		...
		<div class="main">
			<form id="contactMeans" novalidate="novalidate"
				class="my-account-contact-preferences clearfix" action="" method="">
				<p class="heading">정보 수신 항목 설정</p>

				<script type="text/javascript">
	    config.displayDelay = 10;
	</script>
	<script type="text/javascript">
	 ...
	 $(document).ready(function(){
			...
			$('#showSave').click(function(){
				...
				$('#jin').show();
				setTimeout(function(){
				    document.getElementById('jin').className = 'waa';
				}, 5000);
	...
	<div id="jin" style="display: none; color: green; font-size: 3ex; ">&nbsp;&nbsp;*설정이 저장되었습니다*</div>

				<div class="confirmation-message" aria-hidden="true" id="confirmation-message"
					style="display: none;">
					<i
						class="responsive-icon Glyph Glyph--check confirmation-message__icon"
						aria-hidden="true"></i> 설정이 저장되었습니다.
				</div>
				...
				<div
					class="contact-preferences-content contact-methods__global-optin-container"
					id="my-account-my-news">

					&nbsp;
					<p class="contact-methods__global-optin-separator">
						<input id="contact-methods-global-optin"
							name="groupedOptinAuthorized" type="checkbox" value="true"><input
							type="hidden" name="_groupedOptinAuthorized" value="on" style=""><label
							for="contact-methods-global-optin"> <strong>네스프레소에서
				...
				<div id="saveSuccess" style="display: none; color: green; font-size: 15em">&nbsp;&nbsp;&nbsp;
				설정이 저장되었습니다</div>
				<div class="my-account-save-preferences clearfix">
					<button type="button" id="showSave"
