...
<meta name="keywords" content="머신정보수정, 네스프레소클럽, 네스프레소">
<meta name="description" content="네스프레소 클럽에서 나의 머신 정보를 수정하세요">
<meta property="og:title" content="나의 머신 정보 수정하기 | 네스프레소 클럽 | 네스프레소">
<meta property="og:url"
	content="https://www.nespresso.com:443/kr/ko/myaccount/editMachine">
<meta property="og:description" content="네스프레소 클럽에서 나의 머신 정보를 수정하세요">
<title>나의 머신 정보 수정하기 | 네스프레소 클럽 | 네스프레소</title>
...
window[padlNamespace].dataLayer.page = {"page":{"pageInfo":{"language":"ko","breadcrumbUID":"account:my-machines::edit-machine:","pageName":"Account Edit Machine","primaryCategory":"","secondaryCategory":[],"segmentBusiness":"B2C","technology":[],"type":"","variant":""}}};

window[padlNamespace].dataLayer.pageInstanceID = {"pageInstanceID":"account:my-machines::edit-machine::NC2-mosaic:true:B2C:KR:ko"};
...
<script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-51185161-38a2-475c-9a8c-f15d942da024","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624424003827&amp;cv=9&amp;fst=1624424003827&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=6&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DMachines%3Becomm_pagetype%3Dcategory%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D4908990&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2FeditMachine%3FmachinePk%3Dc1d16b0f-1aee-4792-a5f8-075647885a61&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2Fmachines&amp;tiba=%EB%82%98%EC%9D%98%20%EB%A8%B8%EC%8B%A0%20%EC%A0%95%EB%B3%B4%20%EC%88%98%EC%A0%95%ED%95%98%EA%B8%B0%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%ED%81%B4%EB%9F%BD%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<iframe target="_self" title="SaleCycle"
	src="https://s.salecycle.com/receiver.html?sc_frame_id=bd505fde-94ac-4848-82c5-57c6b3bccd8f"
...
<body data-new-gr-c-s-check-loaded="14.1016.0" data-gr-ext-installed=""
	...
	<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">나의
		머신 정보 수정하기 | 네스프레소 클럽 | 네스프레소 | Mosaic Site KR</h2>
...
config.machine = {
    ...
    texts: {
        errors: {
			...
			<div id="my-account-my-machine-edit"
				class="my-machines my-machine ng-scope">

				<div class="heading">나의 머신</div>


				<form id="machine-edit-form"
					action="<%=cp %>/login/myPage/myMachine/updateMachineDate_ok"
					method="post">
					<input name="email" type="hidden" value="${dto.email }">
					<input name="num" type="hidden" value="${dtom.num }">
					
					<div data-ng-controller="MachineEditCtrl" data-machine=""
						data-backend-url="/kr/ko/" data-page-type="myAccountEdit"
						class="ng-scope">

						<div class="machine-form-container my-machine__container">
							<div class="machine-form-wrapper clearfix">
								<div class="title">
									<h2 class="my-machine__subtitle">
										<span class="italic"><span>${dtom.fileName }&nbsp;${dtom.pName }</span></span>
									</h2>
								...
								<div
									...
									<img src="${dtom.fileImage }" class="" width="240" height="240">
								</div>
								...
								<div class="machine-info-form pull-left my-machine__info">
									<div class="input-group empty">
										<div class="input-row">
											<label for="machineRegistrationmachineNumbervalue"
												...
												class="input-label my-machine__serial-number-label">머신
												시리얼 번호 : </label><input id="machineRegistrationmachineNumbervalue"
									...
									<fieldset
										...
										<legend id="purchaseDate" class="w190 legend-label">머신
											구매일* :</legend>
										<div class="my-machine__purchase-date-container">
											<div class="first my-machine__purchase-date-field">
												<label for="machineRegistrationdayvalue"
													class="visually-hidden"> 일</label> <select id="pDate"
													name="pDate"
													class="selectmenu xxsmall my-machine__purchase-date-field select--expendable-label ng-pristine ng-untouched ng-valid ng-not-empty"><option
														value="01">01</option>
													<option value="" selected="selected" style="display: none;">${dtom.pDate }</option>
											...
											<div class="my-machine__purchase-date-field">
												<label for="machineRegistrationmonthvalue"
													class="visually-hidden"> 월</label> <select id="pMonth"
													name="pMonth"
													...
													aria-required="true"
													data-ng-class="{error: !machineRegistration.year.valid}">
													<option value="" selected="selected" style="display: none">${dtom.pMonth }월</option>
											...
											<div class="my-machine__purchase-date-field">
												<label for="machineRegistrationyearvalue"
													class="visually-hidden"> 연도</label> <select id="pYear"
													name="pYear"
													class="selectmenu xxsmall my-machine__purchase-date-field select--expendable-label ng-pristine ng-untouched ng-valid ng-not-empty"
													data-ng-model="machineRegistration.year.value"
													aria-required="true"
													data-ng-class="{error: !machineRegistration.year.valid}">
													<option value="" selected="selected" style="display: none;">${dtom.pYear }</option>
									...
									<div class="pull-left first input-group"
										...
										<div class="input-row">
											<label for="machineRegistrationstoreTypevalue"
												...
												머신 구입처*</label> <select id="machineRegistrationstoreTypevalue"
												name="machineRegistration.storeType"
												class="selectmenu regular my-machine__location-dropdown select--separate-label ng-pristine ng-untouched ng-valid ng-not-empty"
												data-ng-model="machineRegistration.storeType.value"
												aria-required="true"
												data-ng-class="{error: !machineRegistration.storeType.valid}"><option
													value="ONLINE">온라인으로 구매</option>
												<option value="GIFT" selected="selected">선물 받음</option>
									...
									<input id="machineRegistrationmachineIdvalue"
										name="machineRegistration.machine.code"
										data-ng-value="machineRegistration.machineId.value"
										type="hidden" value="GCB2-KR-MB-KIT2" style=""
										...
										<div class="content">
											<div id="block-8807213651445" class="free-html" data-label="">
												<div style="padding: 0 80px 40px 80px; color: #000;">
													<div
														style="background: url('/mosaichttps://www.nespresso.com/_ui/img/popin-title-sep.png') bottom no-repeat; line-height: 22px; margin: 0 0 15px 0; padding: 0 0 25px 0; text-align: center;">
								...
								<div class="machine-info-img pull-right my-machine__img">
									<img src="${dtom.fileImage }" alt="" width="240" height="240"
										class="pic">
								</div>
							</div>
						</div>

						<div id="register-machine-store-filter"
							class="section-slide machine-store-filter register-machine-store__filter">

							<fieldset class="machine-location-wrapper">
								<legend class="title register-machine-store__filter-title">
									머신 구매 장소를 선택해주세요.</legend>
								<div class="input-group my-machine__store-locator"
									data-ng-class="{error: !machineRegistration.storeId.valid}">

									<div class="input-row my-machine__store-name-container">
										<label for="storeNameFilter" id="storeNameFilterLabel"
											class="my-machine__dropdown-label input-label label--for-select">주소
											수정<span aria-hidden="true" class="required-indicator"> *</span>
										</label><select id="storeNameFilter"
											name="machineRegistration.storeNameFilter"
											class="selectmenu regular register-machine-store__filter-dropdown"
											aria-required="true"
											data-ng-class="{error: !machineRegistration.storeId.valid}"><option
												value="" selected="selected"></option>
											<option value="2901">AK PLAZA</option>
											<option value="35">Asianfoodchannel</option>
											<option value="54">BHG</option>
											<option value="49">BaBaiBan</option>
											<option value="3319">Beutii</option>
											<option value="3307">Breeze</option>
											<option value="2806">CN Bailian Group</option>
											<option value="2824">CN Cuiwei</option>
											<option value="2800">CN Friendship Store</option>
											<option value="2821">CN Gift Company</option>
											<option value="2803">CN Grand Pacific</option>
											<option value="2832">CN Grandbuy</option>
											<option value="2815">CN Han Guang</option>
											<option value="2804">CN Hangzhou Tower</option>
											<option value="2834">CN HengLong</option>
											<option value="2813">CN Hisense</option>
											<option value="2816">CN House of Fraser</option>
											<option value="2831">CN IFS</option>
											<option value="2820">CN Izumiya Group</option>
											<option value="2817">CN JD.com China</option>
											<option value="2823">CN JiFen</option>
											<option value="2830">CN Jindi</option>
											<option value="2829">CN Joy City</option>
											<option value="2818">CN Lei Shing Hong Group</option>
											<option value="2808">CN Matro Department Store</option>
											<option value="2822">CN MeiLiHui Group</option>
											<option value="2898">CN POS Independent</option>
											<option value="2810">CN Parkson</option>
											<option value="2828">CN RuiAn</option>
											<option value="2826">CN SOGO</option>
											<option value="2807">CN Servimex</option>
											<option value="2827">CN Shin Kong</option>
											<option value="2812">CN Shuang An Department Store</option>
											<option value="2833">CN Sundan</option>
											<option value="2801">CN Suning</option>
											<option value="2814">CN TMall China</option>
											<option value="2802">CN Takashimaya</option>
											<option value="2809">CN U Living</option>
											<option value="2899">CN WeChat Store</option>
											<option value="2819">CN Yong Da Group</option>
											<option value="2811">CN Youyi</option>
											<option value="2805">CN Zhuozhan Plaza</option>
											<option value="2825">CN_ZhongHai</option>
											<option value="8">CRC</option>
											<option value="24">Casamia</option>
											<option value="11">City Super</option>
											<option value="3315">Crate &amp; Barrel</option>
											<option value="42">DFASS</option>
											<option value="47">Daegu</option>
											<option value="2902">Electro Mart</option>
											<option value="3308">Eslite</option>
											<option value="55">Far Eastern</option>
											<option value="3303">Fayaque</option>
											<option value="36">Galleria</option>
											<option value="2">Gift</option>
											<option value="2613">HK Asia Miles</option>
											<option value="12">HK Broadway</option>
											<option value="2607">HK Built In Pro</option>
											<option value="2602">HK Chung Yuen</option>
											<option value="2609">HK City Super</option>
											<option value="13">HK Fortress</option>
											<option value="2612">HK HKTV</option>
											<option value="2601">HK Jusco</option>
											<option value="2605">HK Kitchen Square</option>
											<option value="2611">HK Lane Crawford</option>
											<option value="2608">HK New Yaohan</option>
											<option value="2606">HK Pantry Magic</option>
											<option value="2604">HK Royal Electronics Square Co</option>
											<option value="2610">HK SOGO</option>
											<option value="2614">HK The Club HKT</option>
											<option value="17">HK Towngas</option>
											<option value="2603">HK Wing On</option>
											<option value="15">HK Yata</option>
											<option value="3312">HOLA</option>
											<option value="3301">Hankyu</option>
											<option value="3304">Hanshin</option>
											<option value="25">Hanssem</option>
											<option value="51">Harbour House</option>
											<option value="21">Hi-Mart</option>
											<option value="3314">Highspeed Digital</option>
											<option value="2703">Hooked on Home Pte Ltd</option>
											<option value="20">Hyundai</option>
											<option value="40">Hyundai &amp; Galleria</option>
											<option value="39">I-Park Yongsan</option>
											<option value="3306">I-Zung</option>
											<option value="3318">I-Zung_New</option>
											<option value="14">LANE CRAWFORD</option>
											<option value="22">LG Best Shop</option>
											<option value="37">Linko</option>
											<option value="18">Lotte</option>
											<option value="45">MEGA Discount Store</option>
											<option value="4703">MY Best Denki</option>
											<option value="4706">MY E.S.H Electric</option>
											<option value="4701">MY Harvey Norman</option>
											<option value="4702">MY Parkson</option>
											<option value="4704">MY Robinsons</option>
											<option value="4707">MY Sogo</option>
											<option value="4705">MY TBM</option>
											<option value="50">Media Market</option>
											<option value="26">Modern House</option>
											<option value="34">Mustafa</option>
											<option value="5">Nespresso Boutique</option>
											<option value="27">Online</option>
											<option value="48">Oriental</option>
											<option value="3">Overseas</option>
											<option value="6">POS Independent</option>
											<option value="33">ParisSilk</option>
											<option value="52">Parkson</option>
											<option value="3310">QSquare</option>
											<option value="2706">SG Amazon</option>
											<option value="2707">SG BHG</option>
											<option value="41">SG Best Denki</option>
											<option value="28">SG Courts</option>
											<option value="2702">SG Gain City</option>
											<option value="43">SG Harvey Norman</option>
											<option value="2704">SG Lazada</option>
											<option value="29">SG Metro Asia</option>
											<option value="2701">SG OG</option>
											<option value="31">SG Robinsons</option>
											<option value="2705">SG Shopee</option>
											<option value="2708">SG Synthesis Marketing</option>
											<option value="30">SG Tangs</option>
											<option value="16">SOGO</option>
											<option value="46">STI</option>
											<option value="23">Samsung Digital Plaza</option>
											<option value="3302">Shin Kong Mitsukoshi</option>
											<option value="19">Shinsegae</option>
											<option value="53">Sundan</option>
											<option value="4708">Synthesis Marketing</option>
											<option value="4509">TH - Boonthavorn</option>
											<option value="4508">TH - Chic</option>
											<option value="4512">TH - Index Living Mall</option>
											<option value="4507">TH - JD Central</option>
											<option value="4506">TH - K Bank</option>
											<option value="4510">TH - King Power</option>
											<option value="4511">TH - Siam Discovery</option>
											<option value="4501">TH – Central</option>
											<option value="4503">TH – HomePro</option>
											<option value="4502">TH – Power Buy</option>
											<option value="4504">TH – Power Mall</option>
											<option value="4505">TH – Robinson</option>
											<option value="3311">TOTT Singapore</option>
											<option value="3309">TPE 101</option>
											<option value="3316">TW MOMO</option>
											<option value="3317">TW PChome</option>
											<option value="3305">Tsann Quen</option>
											<option value="1">Unknown</option>
											<option value="3313">Yahoo</option>
											<option value="38">Youngpoong</option>
											<option value="32">iWannagohome</option></select>
									</div>

									<fieldset
										class="input-group my-machine__purchase-city-wrapper empty">
										<div class="input-row my-machine__purchase-city-container">
											<label for="storeCityFilter" id="storeCityFilterLabel"
												class="input-label">구매 장소(도시)<span
												aria-hidden="true" class="required-indicator"> *</span></label><input
												id="storeCityFilter" name="machineRegistration.cityFilter"
												aria-reqired="true"
												class="pull-left register-machine-store__filter-input"
												type="text" value="">
										</div>

										<button type="button"
											class="btn-container btn button-primary   my-machine-search-store my-machine__search-store-button"
											data-ng-click="searchStores()"
											data-ng-hide="storeLocator.loading">
											<span class="button__content"> 찾기</span>
										</button>
									</fieldset>

									<!-- ngIf: !machineRegistration.storeId.valid -->

								</div>
							</fieldset>

							<div class="search-store-loading ng-hide"
								data-ng-show="storeLocator.loading">
								<img class="my-machine__search-store-loader"
									src="https://www.nespresso.com/_ui/img/ajax-loader.gif"
									alt="로딩"> Searching for stores…
							</div>

						</div>

						<div id="register-machine-store-results"
							class="find-us shopfinder section-slide machine-store-results register-machine-store_results ng-hide"
							data-ng-show="storeLocator.complete">
							<fieldset>
								<legend class="visually-hidden">머신 구매 매장을 아래에서 선택해주세요.</legend>
								<div class="results">
									<div
										class="results-header my-machine__store-locator-result-header">
										<span data-ng-bind="storeLocator.stores.length"
											class="ng-binding">0</span>&nbsp;<span>가까운 지역의 매장</span>
									</div>
									<ul id="store-locator-results"
										class="my-machine__store-locator-list ng-hide"
										data-ng-show="storeLocator.stores.length">
										<!-- ngRepeat: store in storeLocator.stores track by $index -->
									</ul>
								</div>
							</fieldset>
						</div>
						...
						<div class="my-machine__buttons-container">
							...
							<a href="<%=cp %>/login/myPage/myMachine"
								class="btn-container my-machine__back-button"> <span
								class="btn button-primary  "> <span> 내 머신 메뉴로 돌아가기</span>
							</span>
							</a>
						</div>
					</div>
