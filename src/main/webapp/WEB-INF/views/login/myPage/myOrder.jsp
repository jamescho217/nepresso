	...
	<div class="clearfix account">
		...
		<div class="main">
			<div class="account-title border f20">
				...
				<c:if test="${orderNumCount ==0 }">
				<div class="myorders-empty" style="display: block;">
			...
			<div class="myorders-empty-box centered">
				...
				<p>
					<a href="<%=cp %>/product/originalcapsule" id="ta-link-order"
						...
						<dl class="my-orders-list__cell my-orders-list__amount">
							...
							<dd class="my-orders-list__cell--description">
								<fmt:formatNumber value="${myOrder.totalPrice }" pattern="#,###" />
									...
									<input type="hidden" name="orderNum" value="${myOrder.orderNum }" id="orderNum">
									<span
									class="btn button-primary button-left-icon "> <i
										class="responsive-icon Glyph Glyph--search" aria-hidden="true"></i>
										<span> <span class="visually-hidden"> 선택된 주문 상세
												내역 확인</span> <span class="narrow-and-medium-only"
											aria-hidden="true"> 상세 내역</span>
									</span>
								</span>
								...
								function main(num){
									...
									$.ajax({
										...
										success : function(data) {
											...
											location.href="<%=cp%>/login/myPage/orderList?orderNum=" + num;
											console.log(num);
										}
									});
