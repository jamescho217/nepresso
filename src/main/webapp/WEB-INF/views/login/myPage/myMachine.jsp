...
<meta name="keywords" content="나의커피머신, 네스프레소클럽, 네스프레소">
<meta name="description" content="나의 커피머신">
<meta property="og:title" content="나의 커피머신 | 네스프레소 클럽 | 네스프레소">
<meta property="og:url"
	content="https://www.nespresso.com:443/kr/ko/myaccount/machines">
<meta property="og:description" content="나의 커피머신">
<title>나의 커피머신 | 네스프레소 클럽 | 네스프레소</title>
...
<script src="https://www.nespresso.com/_ui/generated/allHeaderNonBlocking.js?v=b68e98c89fd319126d2eb64ae2105aaaa6c5c125"
	defer=""></script>
...
<script>(window.BOOMR_mq=window.BOOMR_mq||[]).push(["addVar",{"rua.upush":"false","rua.cpush":"false","rua.upre":"false","rua.cpre":"false","rua.uprl":"false","rua.cprl":"false","rua.cprf":"false","rua.trans":"SJ-731bcbd1-eace-4f42-8bcd-2662e936bccc","rua.cook":"true","rua.ims":"false","rua.ufprl":"false","rua.cfprl":"false","rua.isuxp":"false","rua.texp":"norulematch"}]);</script>
...
<link id="dnsprefetchlink" rel="dns-prefetch"
	href="//ahvnchtijk7q6ygstlwq-f-09de7cf7c-clientnsv4-s.akamaihd.net">
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/966523418/?random=1624414959350&amp;cv=9&amp;fst=1624414959350&amp;num=1&amp;label=28k8CJ_rulwQ8Yj0zAM&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;eid=2505059650&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=6&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2wg6g0&amp;sendb=1&amp;ig=1&amp;data=ecomm_category%3DMachines%3Becomm_pagetype%3Dcategory%3Becomm_totalvalue%3D0%3Bgoogle_user_id%3D4908990&amp;frm=0&amp;url=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2Fmachines&amp;ref=https%3A%2F%2Fwww.nespresso.com%2Fkr%2Fko%2Fmyaccount%2FeditMachine%3FmachinePk%3Dc1d16b0f-1aee-4792-a5f8-075647885a61&amp;tiba=%EB%82%98%EC%9D%98%20%EC%BB%A4%ED%94%BC%EB%A8%B8%EC%8B%A0%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C%20%ED%81%B4%EB%9F%BD%20%7C%20%EB%84%A4%EC%8A%A4%ED%94%84%EB%A0%88%EC%86%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
<iframe target="_self" title="SaleCycle"
	src="https://s.salecycle.com/receiver.html?sc_frame_id=2294c380-dc03-4037-bbc9-4442b6cc2618"
...
<body data-new-gr-c-s-check-loaded="14.1016.0" data-gr-ext-installed=""
	...
	<h2 id="a11y-main-heading" class="visually-hidden" tabindex="-1">나의
		커피머신 | 네스프레소 클럽 | 네스프레소 | Mosaic Site KR</h2>
	...
	<div class="clearfix account">
		...
		<div class="main">
			<div id="my-account-machines-repertory" class="myMachines__container">
				<h2 class="heading">내 머신</h2>

				<div class="myMachines__list">

					<c:forEach var="dtom" items="${list }" varStatus="status">
						<c:if test="${not empty dtom.fileImage}">
							<div class="myMachines__item">
								<div id="lists">

									<div class="myMachines__item-image-container">
										<img src="${dtom.fileImage }" class="myMachines__item-image"
											width="300" height="300">
									</div>
									<div class="myMachines__item-infos">
										<div
											class="myMachines__item-infos-line myMachines__item-technology-name">
											<span class="myMachines__item-technology-name-value">
												${dtom.fileName }</span>
										</div>
										<h3 class="myMachines__item-title">${dtom.pName }</h3>
										<br /> 구입 일자<span class="myMachines__item-purchase-date-value">
											${dtom.pYear }년&nbsp;${dtom.pMonth }월&nbsp;${dtom.pDate }일</span> <input
											type="hidden" value="${dtom.num }" name="num">
								...
								<div class="myMachines__item-buttons">
									<a
										href="<%=cp %>/login/myPage/myMachine/updateMachine?num=${dtom.num}"
										class="btn-container myMachines__edit-button" role="button">
										<span class="btn button-primary  "> <span> 머신 정보
												수정하기</span>
									</span>
									</a>
									<button type="button" id="deleteMachine"
										onclick="deleteMachine(${dtom.num})"
										class="btn-container btn button-primary   myMachines__remove-button delete-machine-btn"
										data-machinedeleteurl="/kr/ko/myaccount/deleteMachineRegistration/c1d16b0f-1aee-4792-a5f8-075647885a61"
										data-machine-name="버츄오 플러스 매트 블랙 &amp; 트래블 머그">
										<span class="button__content"> 머신 삭제하기</span>
									</button>
						...
						function deleteMachine(num){
						
						console.log(num);
															
								location.href ='${pageContext.request.contextPath}/login/myPage/myMachine/deleteMachine_ok?num=' + num;
					...
					<a href="<%=cp %>/login/myPage/myMachine/addMachine"
