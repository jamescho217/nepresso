...
<article class="v_articlePage v_articleId5"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/5/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>커피 테이스팅의 예술</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">커피 테이스팅을 통해 전문가처럼 커피의 맛을 평가해 보세요.</p><p class="v_paragraph">테이스팅은 특별한 커피를 만드는 데 있어서 매우 중요한 과정이며, 우리의 커피 품질을 보여주는 크레마, 바디감, 부드러움 및 아로마의 강도 등을 평가해볼 수 있는 방법입니다. </p><p class="v_paragraph">후르릅 소리를 내면서 마시거나 향을 맡는 정교한 과정을 통해, 네스프레소 커피 전문가들은 <a class="innerLink" href="../the-coffee-experience/why-terroir-matters-to-coffee-taste">커피의 특징</a>을 판단하고, 엄격한 기준을 충족하는지 여부를 빠르게 확인할 수 있습니다. </p><p class="v_paragraph">이것은 과학이면서 예술이라고 할 수 있지만 오랜 경험이 없더라도 최상의 커피를  구별할 수 있는 전문가가 될 수 있습니다. </p><p class="v_paragraph">커피를 제대로 평가하는 방법을 알고 싶다면, 아래와 같이 간단한 3단계 커피 테이스팅 가이드를 따라해 보세요. </p><blockquote class="v_emphasis">커피 테이스팅은 과학이자 예술입니다. </blockquote><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/5/gif_study_crema_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span>01</span><span>크레마 확인하기</span></h3> <p>커피 표면 위의 거품 층인 크레마가 균일하고 부드러운가요? 크기가 작은 거품이 풍부해야  섬세하고 진한 크레마가 만들어집니다. 거품의 크기가 크고 양이 적다면 커피를 너무 빠르게 추출된 것을 의미합니다. 반대로 거품이 너무 쫀쫀하다면 커피를 너무 천천히 추출하거나 커피가 탄 경우일 수도 있습니다. </p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/5/gif_inhale_deeply_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span>02</span><span>깊이 들이마셔 보세요</span></h3> <p>커피가 담긴 컵에서 흘러 나오는 향을 맡아 보세요. 어떤 냄새가 나나요? 향기를 맡아 본 후 커피를 부드럽게 저어주고 다시 냄새를 맡아보세요. 몇 초 간 깊게 들이마셔 코 안쪽까지 냄새를 들이켜 보세요. 냄새와 맛은 서로 아주 밀접하게 연결되어 있어 처음 느낀 냄새가 커피 맛에 대한 판단에 아주 중요하게 작용합니다. </p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/5/gif_evaluate_taste_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span>03</span><span>맛을 평가해 보세요</span></h3> <p>재미있는 실험을 하나 해 볼까요 - 커피를 스푼 가득 담아 후루룩 소리내어 마셔 보세요! 부끄러워 하지 마세요. </p> <!----> <!----></figcaption></figure></div></div> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/the-coffee-experience/italy" class="">이탈리아에서 커피 주문하는 방법: <br>규칙 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/the-coffee-experience/terroir" class="">테루아 테이스팅 노트: <br>커피에 있어 중요한 이유 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
