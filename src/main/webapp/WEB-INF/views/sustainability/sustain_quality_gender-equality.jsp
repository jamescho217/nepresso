...
<article class="v_articlePage v_articleId11"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/11/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>에티오피아 여성 농학자들의<br>성평등 개선 노력 </h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">커피로 인해 전국적으로 여성들의 영향력이 커지고 있습니다.</p><p class="v_paragraph">Hunkute 마을의 Kebebushe Fissa는 커피 나무를 재생하는 방법을 농부에게 가르치고 있습니다. 농부는 그녀의 말에 집중합니다. 농촌 여성이 커피 생산에 이와 같은 영향력을 미치는 일은 드문 일이지만, 이제 에티오피아의 문화도 변화하고 있습니다.  </p><p class="v_paragraph">Kebebushe는 최고의 농법으로 40,000명 이상의 커피 농부를 지원하기 위해 네스프레소와 함께 일하고 있는 79명의 농학자 중 한명입니다. 한 사람의 농학자가 농부를 만나 더 좋은 커피를 생산하기 위해 커피 <a class="innerLink" href="../the-coffee-experience/6-fascinating-facts-about-coffee-harvesting">수확</a>, 토양 관리 및 퇴비에 대해 가르치면서 금방 그 가족들에게 친구가 됩니다. 이러한 농학자들 중 35%는 여성입니다. </p><figure class="v_image v_woman1 v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/11/wide_woman1_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">첫번째 여성 image</span> <figcaption><p>에티오피아의 성평등 개선을 돕는 여성 농학자들</p></figcaption></figure><p class="v_paragraph">에티오피아에서 여성이 전체 커피 생산량의 75%를 책임집니다. 그러나 전체 소득의 43%를 차지합니다.  </p><aside class="v_side_block"><strong>네스프레소의 AAA <br>지속가능 품질™ 프로그램</strong> <small></small> <p>2003년에 도입한 <a class="innerLink" href="../sustainable-coffee-quality/the-secret-to-sustainable-and-quality-coffee">네스프레소의 AAA 지속가능 품질™ 프로그램</a>은 열대우림동맹과 협업하여 출범했습니다. 이 맞춤형 커피 프로그램은 환경을 보존하고, 농부와 지역 사회가 지속가능한 삶을 유지하도록 지원하면서, 동시에 더 좋은 커피를 고객에게 제공할 수 있게 합니다. </p></aside><p class="v_paragraph">여성 농학자들은 우리의 파트너인 TechnoServe가 운영하는 팀의 일원입니다. TechnoServe는 농학과 농업 경영으로 농민들을 지원하는 동시에, 성평등 개념을 교육하고 있습니다. 2006년 이후 네스프레소의 AAA 지속가능 품질™ 프로그램의 일원으로 함께 일하고 있습니다.   </p><p class="v_paragraph">"초기 통계 자료에 따르면, 에티오피아에서 여성이 전체 커피 생산량의 75%를 책임집니다. 그러나 전체 소득의 43%를 차지합니다."라고 에티오피아 TechnoServe의 디렉터, Mefthe Tedesse는 이야기합니다.     </p><p class="v_paragraph">"우리가 겪는 어려움 중에 하나는 수입 측면에서 공급 사슬의 가치가 클수록 '남자의 수확량'이 더 증가하는 경향이 있습니다. 여성은 실제로 커피 열매를 따서 관리하는 일을 더 많이 하고, 남성들은 시장에서 커피를 거래하는 일을 합니다."라고 이야기합니다.   </p><figure class="v_image v_woman2 v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/11/wide_woman2_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">두번째 여성 image</span> <figcaption><p>TechnoServe, 성평등을 홍보하는 이티오피아의 파트너</p></figcaption></figure><blockquote class="v_emphasis">에티오피아에서 여성이 전체 커피 생산량의 75%를 책임집니다. 그러나 전체 소득의 43%를 차지합니다.  </blockquote><aside class="v_side_block"><strong>TechnoServe</strong> <small>우리의 파트너</small> <p><a class="innerLink" href="../sustainable-coffee-quality/the-secret-to-sustainable-and-quality-coffee">Technoserve</a>는 에티오피아 또는 케냐와 같은 나라에서 여성에게 농학과 농업 경영을 가르치며, 삶을 변화시키는 비영리 단체와 협력하고 있습니다. </p></aside><p class="v_paragraph">TechnoServe는 여성들을 훈련시켜 농학자로 키울 뿐만 아니라, 커피 협력 사업에서 리더십을 갖도록 합니다. 네스프레소의 AAA 지속가능 품질™ 프로그램에서 여성의 참여를 확대하기 위해서 여성 뿐만 아니라, 지역 사회의 남성들의 참여도 중요하다는 것을 알게 되었습니다. 예를 들면, 남편들이 부인들이 참여하는 교육 프로그램에 참여하도록 장려합니다. 이는 여성들은 종종 남편들과 함께 교육에 참여하는 것을 편안하게 느끼기 때문입니다. 이러한 전략은 효과가 있었습니다. 에티오피어에서 여성 농부들의 참여율은 1%에서 30% 이상으로 증가했습니다. </p><p class="v_paragraph">농부들은 Kebebushe의 교육 결과와 함께, 자신들의 수확량도 개선되었다는 것을 알고 있습니다.  </p><div class="v_media_text v_asideRight"><div class="v_clearboth"></div> <figure class="v_image v_woman3 v_floatImage"><div><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/11/float_woman3_L.jpg" alt="woman3"></div> <span class="v_visually_hidden">세번째 여성 image</span> <figcaption><p>에티오피아의 여성들은 커피 산업에서 리더십을 갖을 수 있도록 장려되고 있습니다.</p></figcaption></figure><p class="v_paragraph">"저는 커피를 생산하는 곳에서 자랐으나, 농업 경영은 배우지 못했습니다."라고 Hunkute에 살고 있는 농학자는 이야기합니다. "네스프레소의 AAA 지속가능 품질™ 프로그램의 농학자로써, 배웠던 것을 그대로 실천했고, 이를 통해 더 많은 수입과 함께, 농장은 더 개선되고 확장되었습니다. 여기에서 태어난 것이 너무 기쁘고, 여기에서 가족들을 가르치고 있습니다." </p><p class="v_paragraph">에티오피아에서 여성농학자가 많은 것은 장소가 특별해서가 아닙니다. 또한 이곳은 아라비카의 원산지이기도 합니다.  </p><p class="v_paragraph">대부분의 농부들은 정원에서 커피를 재배합니다. 또한 야생에서도 재배하는 것을 볼 수 있습니다. 우리는 감사의 표시로, 그 커피를 부킬라 카 에티오피아라고 명명했습니다. 자세한 내용은 여기에서 확인 가능합니다. </p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/partnership" class="">영향력을 발휘하는 파트너십 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/trees-affect" class="">커피 품질에 영향을 미치는 나무들 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/secret" class="">완벽한 커피를 재배하는 비결 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 

<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/secret" class="" tabindex="-1" aria-label="완벽한 커피를 재배하는 비결.vue  {word-break:keep-all !important;}"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/42/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>완벽한 커피를 재배하는 비결<style>.vue  {word-break:keep-all !important;}</style></h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
