...
<article class="v_articlePage v_articleId51"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/51/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>인도 해안의 로부스타 : 몬순 가공법의 인디아 커피</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">주목받지 못했던 커피의 재발견. 강렬한 풍미와 놀라운 아로마를 만나다.</p><p class="v_paragraph">유럽인들이 커피를 즐기던 초기, 생두를 가득 싫은 배가 유럽에 도착하는 데는 6개월이나 걸렸습니다. 항해 도중 습도가 높은 날에는 생두가 팽창하고 화창한 날에는 말라서 수축이 됐습니다. 항로를 따라 이동하는 과정에 이처럼 팽창과 수축을 반복한 생두는 물리적인 형태뿐만 아니라 내부의 화학적 특성에도 변화가 생겨 시럽처럼 진하고 풍부한 향을 가진 커피가 됩니다.</p><figure class="v_image v_monsooning v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/51/wide_monsooning_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">인도의 기후와 환경은 몬순 가공법으로 알려진 전통적인 커피 건조 과정을 재현하기에 완벽한 조건을 제공합니다. image</span> <figcaption><p>인도의 기후와 환경은 몬순 가공법으로 알려진 전통적인 커피 건조 과정을 재현하기에 완벽한 조건을 제공합니다.</p></figcaption></figure><p class="v_paragraph">이 커피는 여전히 많은 사람들이 찾고 있어 오늘날에도 인도 해안에서 가공되고 있습니다. 몬순 가공으로 불리는 이 가공법은 인기 품종인 아라비카에 주로 적용됩니다. 네스프레소는 아라비카를 많이 활용하고 다양한 커피 캡슐을 선보였지만, 아라비카의 자매종인 로부스타에는 관심이 그다지 높지 않다는 점을 알게 되었습니다. 그래서 로부스타에 몬순 가공을 적용하면 어떨까하는 생각을 갖게 됐고, 그 결과 강렬하고 풍부한 향을 가진 놀라운 커피를 만들게 되었습니다.</p><blockquote class="v_emphasis">네스프레소는 아라비카를 주로 활용하고 다양한 커피 캡슐을 선보였지만, 아라비카의 자매종인 로부스타에는 충분히 관심을 쏟지 않았다는 것을 알게 되었습니다.&nbsp;</blockquote><figure class="v_image v_meticulous v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/51/wide_meticulous_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">몬순 가공법은 올바른 생두 건조를 위해 철저하고 세심한 관리를 요구합니다. image</span> <figcaption><p>몬순 가공법은 올바른 생두 건조를 위해 철저하고 세심한 관리를 요구합니다.</p></figcaption></figure><p class="v_paragraph">세심한 관리를 요구하는 몬순 가공법은 열대 해안 지역에서 남서 계절풍이 가장 강하게 부는 시기인 6월부터 9월까지 진행됩니다. 잘 익은 커피체리를 선별 수확해 분류, 건조, 껍질 제거 작업을 거쳐 생두 상태로 만듭니다. 생두는 그런 다음 양 옆이 트여 바람이 잘 통하는 창고로 옮겨지며 해안 기후의 습기를 충분히 흡수할 수 있도록 바닥에 펼쳐 놓습니다.</p><div class="v_media_text v_imageProduct v_floatImageProduct"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/51/product_india-capsule_L.jpg" alt="product_india-capsule"> <div><h3>마스터 오리진 인디아</h3> <strong>진한 풍미와 스파이시향</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7712.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p class="g_productPrice">₩ 690</p> <div class="g_addToCartCustom">
<button class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">인디아제품 0개가 장바구니에 담겨 있습니다. 지금 주문하기</span> <span aria-hidden="true" class="g_labelAdd">지금 주문하기</span> <span aria-hidden="true" class="g_labelUpdate">장바구니 업데이트</span> <span aria-hidden="true" class="g_labelPhantom">장바구니 업데이트</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">이 과정에서 생두는 2주째부터 크기가 두 배로 커지고 색깔은 연노란색으로 변합니다. 형태 변형이 없는 완벽한 생두를 얻기 위해서는 갈퀴질과 섞음질을 계속해야 하는 등 세심한 관리와 주의가 요구됩니다. 이러한 가공법은 자연과 커피 농부의 협업 과정으로 3개월 동안 지속됩니다. 결국 서둘러서 완벽하게 될 수 있는 것은 아무것도 없습니다.</p><p class="v_paragraph">그렇다면 마스터 오리진 인디아 몬순 가공 로부스타는 어떤 맛일까요? 복합적이고 풍부한 아로마를 가진 이 커피는 옛날 유럽인들이 즐겨 마시던 커피의 향을 고스란히 간직하고 있습니다. 깊은 우디향과 스파이시향과 함께 강렬한 풍미를 가진 이 커피는 로부스타에는 새로 발견할 게 많다는 점도 깨닫게 합니다. 이 커피는 새로운 기회와 기회를 찾는 사람, 그리고 사람들의 사랑과 관심을 기다리고 있습니다.</p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>
<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/monsooned-malabar" class="">달콤함과 지속가능성 : 블랙허니 가공법의 니카라과 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/volluto" class="">볼루토 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul>
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/women-agronomists" class="" tabindex="-1" aria-label="여성 커피 농학자들이 에티오피아에 가져온 변화.vue  {word-break:keep-all !important;}"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/43/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>여성 커피 농학자들이 에티오피아에 가져온 변화<style>.vue  {word-break:keep-all !important;}</style></h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li></ul>
</aside> 
