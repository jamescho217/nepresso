...
<script src="/nespresso/resources/_ui/generated/frontend-polyfills/SetFromOf.js?v=f9480793ef095cc9cb8d"></script>
...
<header class="nlc-header"><div class="nlc-wrapper"><div class="nlc-icon"><!----> <img alt="Icon" width="24px" height="24px" src="https://www.contact.nespresso.com/apps/calleo-livechat/img/icon-chat.svg"></div> <div class="nlc-title"><h6>채팅 상담이 필요하신가요?</h6></div> <div class="nlc-action"><!----> <a href="javascript:void(0)" class="nlc-action-collapse"><img src="https://www.contact.nespresso.com/apps/calleo-livechat/img/icon-collapse.svg" alt="Icon" width="24px" height="24px"></a> <!----></div></div></header> 

<div class="nlc-wrapper"><div class="nlc-main"><!----> <!----> <!----> <div id="nlc-main-scrollable" class="nlc-main-scrollable" style="padding-bottom: 0px;"><!----> <div><ul class="nlc-livechat"> <!----> <!----></ul> <div id="nlc-spacer-on-scroll-zone" class="nlc-spacer-on-scroll-zone"></div></div> <!----> <!----></div></div></div> <footer class="nlc-footer"><!----> <div><!----> <!----> <div class="nlc-message"><textarea placeholder="메세지를 입력해 주세요." class="nlc-input" style="min-height: 2em; overflow-x: hidden; overflow-wrap: break-word;"></textarea> <button class="nlc-bt nlc-bt-main nlc-bt-send"><span>보내기</span></button> <!----></div></div> <!----> <!----> <!----> <!----></footer></section>
...
<article class="v_articlePage v_articleId9">
<header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>커피 수확에 관한<br>6가지 흥미로운 사실들</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> 

<div class="v_article"><p class="v_headline">네스프레소의 커피 열매는 다양한 이야기를 품고 있습니다. </p><p class="v_paragraph">커피는 농장 규모나 지형에 따라 수작업 또는 기계로 수확합니다. 그러나 생각처럼 쉽지만은 않습니다. 같은 가지에 있는 커피 열매라도 서로 익는 시기가 다르기 때문에 수확하기가 쉽지 않습니다.</p><p class="v_paragraph">더 알고 싶으신가요? 커피 수확과 관련된 흥미로운 이야기를 지금 공개합니다.</p><div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/listicle_harvest_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>01</span></div> <div class="v_cell"><h3></h3> <p>커피 열매가 익어 수확할 때가 되었는지의 여부를 판단하는 것은 어렵지 않습니다. 바로 밝은 빨간색이 될 때가 바로 그 때입니다. 열매가 녹색인 경우는 수확하기에는 이른 시기이고, 만약 검은색이라면 너무 늦은 것입니다.</p></div></div></figcaption></figure></div><div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/listicle_kenya_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>02</span></div> <div class="v_cell"><h3></h3> <p>케냐와 같은 나라에서는 일년에 두 차례 커피를 수확합니다. 이는 더 많은 커피를 수확할 수 있다는 것을 의미합니다. 농부들이나 우리 모두에게 행운이죠. </p></div></div></figcaption></figure></div><div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/listicle_farmers_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>03</span></div> <div class="v_cell"><h3></h3> <p>농부들은 최상의 커를 위해 대부분의 커피 열매를 핸드 피킹(수작업) 방식으로 수확합니다. 같은 가지에서 자라더라도 익는 정도가 다르고 일정 시간이 소요되기 때문에 세 번에서 다섯 번까지 수확을 해야 합니다.</p></div></div></figcaption></figure></div><blockquote class="v_emphasis">커피 열매가 익어 수확할 때가 되었는지의 여부를 판단하는 것은 어렵지 않습니다. 바로 밝은 빨간색이 될 때가 바로 그 때입니다. 열매가 녹색인 경우는 수확하기에는 이른 시기이고, 만약 검은색이라면 너무 늦은 것입니다.</blockquote><div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/listicle_stripping_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>04</span></div> <div class="v_cell"><h3></h3> <p>"스트리핑"은 또 다른 수확 방법입니다. 이것은 나무 가지를 따라 손을 쓸어 내리면서 익었는지에 상관없이 커피 열매를 따는 방법입니다. 열매가 나무 아래 방수포 위로 떨어진 후 덜 익은 콩이 커피 풍미에 영향을 미치지 않도록 기계나 수작업을 통해 정확하게 분류합니다. </p></div></div></figcaption></figure></div><div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/listicle_brazil_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>05</span></div> <div class="v_cell"><h3></h3> <p>대규모 농장이 있고 평지가 많은 <a class="innerLink" href="../the-coffee-experience/why-terroir-matters-to-coffee-taste">브라질 같은 나라</a>의 경우 기계를 이용해 수확을 합니다. 기계가 나무를 따라 지나가면서 가지를 흔들어 열매를 떨어뜨립니다. 그런 다음 안 익은 커피 열매를 골라내는 다른 기계에서 분류합니다.  </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/9/listicle_weather_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>06</span></div> <div class="v_cell"><h3></h3> <p>수확할 때 반드시 좋은 날씨여야만 하는 것은 아닙니다. 사실, 7월에 비가 많이 내리는 브라질 북부 아열대 지역의 에스피리토 산토에서는 우산이 필요할 수도 있습니다. 7월은 카자르 커피 수확을 위해 코닐론을 사용하는 시기입니다. 이 시기에는 농부들이 밖에서 커피 열매를 건조할 수 없기 때문에 손상을 주지 않기 위해 간접적으로 열을 발산하는 기계를 사용합니다. </p></div></div></figcaption></figure></div><footer class="v_footer"></footer>
...
<li><a href="/nespresso/sustainability/the-coffee-experience/italy" class="">이탈리아에서 커피 주문하는 방법: <br>규칙 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
