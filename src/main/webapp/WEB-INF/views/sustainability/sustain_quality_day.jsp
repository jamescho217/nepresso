...
<article class="v_articlePage v_articleId59"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/59/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>농학자의 하루</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> 
<button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span>닫기</span></button></div> 
<button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article">
<p class="v_headline">코스타리카 센트럴 밸리(the Central Valley)의 AAA농학자 페르난도 세구라(Fernando Segura)의 일을 이해하는 것</p><p class="v_paragraph">이른 아침, 페르난도 세구라는 차에 시동을 겁니다. 산등성이 능선 위로 해가 막 떠오른 시간이지만, 페르난도는 오늘의 하루 일과가 어떻게 펼쳐질지 이미 알고 있습니다. 그는 기온이 오르고 공기 중 습도가 높아지는 것을 감지하며, 오후에 몇 시간 비가 올 것도 예상합니다. 그는 방금 막 심은 나무들의 뿌리와, 물이 불어나 넘치는 강물을 떠올리며 미소를 짓습니다. 그에게 자연은 동료와 같고, 커피 농부들과 함께 열정을 쏟아냅니다. 차 기어를 넣고 루이스 에밀리오(Luis Emilio)의 농장인 오아시스로 향합니다. 오늘은 좋은 날이 될 것입니다.</p><blockquote class="v_emphasis">그는 자연 속에서 커피 농부들과 함께 열정을 쏟고 있습니다.</blockquote><p class="v_paragraph">페르난도 세구라는 전세계 커피 농장에서 하루 하루 일하는 400명의 네스프레소의 파트너 농학자 중 한 명입니다. 농학자라는 의미는 그가 토양 관리 및 작물 생산의 전문가라는 뜻이며, 울창한 경관과 풍부한 토양을 자랑하는 코스타리카의 센트럴 밸리라는 위치는 그의 인생과 직업을 꽤 매력적으로 만듭니다. 세구라의 차가 루이스의 커피 농장 입구로 들어가면서 그는 미소를 짓습니다. 그가 바로 여기서 많은 일을 이루었기 때문입니다. 수백 시간 동안 땅을 연구하고 가지 치기를 하고, 작물을 심으며, 자연과 싸우기 보다는 생태계 안에서 해결책을 찾았습니다. 그것은 결코 쉽지 않은 일이었고, 좌절도 있었습니다. 그가 대지의 자비만을 바라던 순간도 있었습니다. 그러나 네스프레소의 ‘AAA 지속 가능한 품질™ 프로그램(AAA Sustainable Quality™ Program)’의 일원으로서 모든 단계의 지식을 갖추고 매 단계 지원을 받으면서, 그는 이제 루이스 에밀리오와 같은 농부들에게 그 지식과 지원을 전수해줍니다.</p><figure class="v_image v_luis-fernando v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/59/wide_luis-fernando_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">대화하며 산책하는 페르난도와 루이스 image</span> <figcaption><p>AAA 농학자인 페르난도(우)는 루이스(좌)의 절친한 친구이자 믿을만한 조언자가 되었습니다. 그들은 지속가능한 농업의 표본이 되는 농장을 만들기 위해 함께 일하며, 다른 농부들 에게도 이와 같은 지속가능한 관행을 실행하도록 영감을 주고 있습니다.</p></figcaption></figure><p class="v_paragraph">페르난도는 차 밖으로 나와 산비탈을 바라보고 있습니다. 이제 해가 중천에 떴지만, 그 뒤로 구름이 바짝 다가오고 있습니다. 오늘 그는 루이스와 함께 커피 농장 전체를 돌아보며 새로 심은 구아바 나무를 점검할 예정입니다. 문이 닫히는 소리를 듣고 위를 올려다보니 그가 방문할 때마다 항상 볼 수 있는 미소와 친절한 눈빛이 그를 맞이합니다. 루이스는 친구이자 멘티, 그리고 파트너이며, 그의 땅은 최고의 기술로 커피 농장이 생산적이고 지속가능하며 기후 변화에 대응할 수 있다는 걸 보여줍니다.</p><p class="v_paragraph">이들은 초록 빛이 가득한 서식지의 소리를 들으며 한동안 조용히 걷습니다. 새들은 머리 위에서 날며 지저귀고, 곤충들은 분주히 움직이며 바람에 흔들리는 나뭇잎과 조화를 이루는 낮은 속삭임을 만들어냅니다. 루이스의 농장, 이 곳은 참으로 아름답습니다. 이 농장은 인간과 자연 사이에 가능한 자연스런 조화를 보여주는 완벽한 예입니다. 이들이 새로 심은 나무에 다가가 무릎을 굽히자, 무릎 사이로 이제 막 개간된 토양의 흙이 파고듭니다. 심지어 이 곳은 흙마저도 향기롭습니다. 이 나무들이 커피 농장을 지속가능하게 만들어주는 주요 자원입니다. 이 나무들이 커피 작물을 바람으로부터 지켜주고 태양을 가려주는 그늘 역할을 할 것입니다. 이 나무들로부터 떨어지는 낙엽은 천연 퇴비가 될 것이고, 나무들이 자라면서 새들은 그 안에 집을 짓고, 이 새들은 농작물에 해를 끼치는 해충들을 없애줄 것입니다. 이는 생태계의 균형을 맞춰 지속 가능한 선순환을 만들어 냅니다.</p><figure class="v_image v_luis v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/59/wide_luis_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">커피 체리를 수확하는 루이스 image</span> <figcaption><p>루이스의 농장은 자연과 인간의 자연스러운 하모니의 완벽한 예입니다. 그와 페르난도는 커피 농장 안에 자연 생태계를 조성함으로써 지속 가능한 커피 농장을 만들어 내었습니다.</p></figcaption></figure><p class="v_paragraph">페르난도와 루이스는 함께 협력하여 농장의 변화를 이루어내었습니다. 루이스의 농장은 이미 전국 평균 생산량보다 두 배 더 높은 생산성을 가지고 있고, 그러기에 더 이상 개선의 여지가 없다고 볼 수도 있지만 그렇지 않습니다. 이는 시작에 불과합니다. 페르난도는 자연이 끊임없이 변화하고 있다는 사실을 잘 알고 있으며, 지속 가능한 농법으로 농장의 성공을 유지하기 위해서 이 농장 안에 자리잡고 있는 자연 환경을 가꾸어야 한다는 사실도 잘 알고 있습니다.</p><blockquote class="v_emphasis">페르난도는 자연이 끊임없이 변화하고 있다는 사실을 잘 알고 있으며, 농장에서 성공을 지속 가능한 방식으로 유지하려면 이 농장 안에 자리잡은 자연 환경을 가꾸어야 합니다.</blockquote><div class="v_media_text v_asideRight"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/59/product_fortissio-lungo-capsule_L.jpg" alt="product_fortissio-lungo-capsule"> <div><h3>포티시오 룽고</h3> <strong>풍부한 맛과 바디감</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7834.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p data-disabled="true" class="g_productPrice">₩ 630</p> <div class="g_addToCartCustom">
<button disabled="disabled" class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">포티시오 룽고제품은 현재 품절 입니다.</span> <span aria-hidden="true" class="g_labelAdd">일시 품절</span> <span aria-hidden="true" class="g_labelUpdate"></span> <span aria-hidden="true" class="g_labelPhantom">일시 품절</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">이들은 루이스가 가족과 함께 살고 있는 농가로 돌아가고 있습니다. 나머지 하루 일과는 커피 체리 수확량을 높은 수준으로 유지하고 나무의 건강을 지키기 위해 가지치기가 필요한 커피 나무를 식별하는 것입니다. 이후 이들은 함께 앉아 루이스 농장의 노동자들을 위한 급여 계획을 검토할 것입니다.- 페르난도는 괜찮은 임금을 지급할 수 있는 사업 제안을 루이스에게 보여주고 교육의 투자 가치가 있다는 것을 알려줄 예정입니다.</p><p class="v_paragraph">긴 하루 일과를 다시 시작하기 전에, 그들은 완벽한 간격으로 산비탈을 껴안고 있는 커피 나무들이 내려다 보이는 루이스의 현관에 앉습니다. 비가 코앞까지 엄습해 옵니다. 루이스는 페르난도의 어깨에 손을 얹고 그에게 커피 한 잔을 건네줍니다. 그들은 잔을 들어 커피 한 모금을 마십니다. 페르난도는 눈을 감고 맛의 풍미를 음미합니다. 페르난도는 행동이 중요하다는 것을 알고 있으며, 고된 노동이 가치가 있다는 것을 잘 알고 있습니다. 그의 커피 한 잔에서 느낄 수 있습니다.</p> <div class="v_clearboth"></div></div><p class="v_paragraph">여성들이 어떻게 노동력을 변화시키고 있으며, 후대를 위한 평등을 어떻게 만들어가고 있는지 네스프레소의 AAA 농학자들에 대해 <a class="innerLink" href="../sustainable-coffee-quality/women-agronomists-gender-equality"> 더 자세히 알아보세요.</a></p> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/heroes" class="">에티오피아의 커피 영웅들<style>.vue  {word-break:keep-all !important;}</style> <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/certify-program" class="">인증 프로그램을 통한 협력 : <br>지속 가능한 품질의 비밀 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/kr/ko/our-choices/sustainable-coffee-quality/how-trees-affect-our-quality-of-coffee" class="">커피 품질에 영향을 미치는 나무들 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 

<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/indonesia" class="" tabindex="-1" aria-label="인도네시아에 커피 협력공동체를 만들다"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>인도네시아에 커피 협력공동체를 만들다</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/columbia" class="" tabindex="-1" aria-label="콜롬비아의 커피협력공동체"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>콜롬비아의 커피협력공동체</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/monsooned-malabar" class="" tabindex="-1" aria-label="인도 해안의 로부스타 : 몬순 가공법의 인디아 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/51/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>인도 해안의 로부스타 : 몬순 가공법의 인디아 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li></ul>
</aside> 
