...
<article class="v_articlePage v_articleId48"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/48/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>오랜 시간을 이어온 전통 : 건식 가공법의 에티오피아 커피</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> 
<button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">한 잔의 커피에 담긴 수세기 동안 이어진 장인의 기술</p><p class="v_paragraph">모든 것이 끊임없이 변하는 것 같은 세계에서 수 세대를 거쳐 살아남은 풍습을 발견하면 신선한 느낌을 받을 때가 많습니다. 원형에 가까운 방식으로 유지된 전통을 보면 인상적입니다. 젊은 세대까지 정성스레 이어지고 있는 유산에서는 선조들의 지혜를 느끼게 합니다. 기원을 논할 때는 발생지, 즉 수 세기 전 커피가 처음 발견된 지역인 에티오피아를 기억해야 합니다.</p><figure class="v_image v_natural-process v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/48/wide_natural-process_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">커피체리를 건조하는 에티오피아의 천연 가공법은 수 세대에 걸쳐 이어진 전통적인 방식입니다. image</span> <figcaption><p>커피체리를 건조하는 에티오피아의 천연 가공법은 수 세대에 걸쳐 이어진 전통적인 방식입니다.</p></figcaption></figure><aside class="v_side_block"><strong>네스프레소 AAA 지속가능 품질™ 프로그램</strong> <small></small> <p>네스프레소 AAA 지속가능 품질™ 프로그램은 2003년 비영리기관인 열대우림연맹과 함께 시작되었습니다. 이는 맞춤화된 커피 프로그램으로 네스프레소가 소비자에게 최상의 커피를 제공하는 동시에, 커피 농부의 생계와 이들의 협력공동체가 지속가능하도록 지원하고 환경을 보호한다는 취지가 담겨 있습니다.</p></aside><p class="v_paragraph">일부 커피 산지에서는 관개 농업이 쉽지 않기 때문에 에티오피아 서부와 같은 지역에서는 비세척 방식으로 와일드한 풍미가 강한 커피를 오랫동안 재배해 왔습니다. "건식” 가공이란 수확한 커피체리를 통째로 펴서 뜨거운 열대의 태양 아래 놓아 말리는 방식입니다.</p><p class="v_paragraph"> 건식 가공법의 생산 과정은 매우 단순해 보일 수 있지만, 각각의 커피체리가 높은 품질을 유지하도록 하는 것은 어려운 일입니다. 습식 가공을 하면 덜 익은 생두나 결함두를 기계적으로 쉽게 골라낼 수 있는 기회가 있습니다. 그러나 건식 가공법에서는 가공 작업이 시작되는 시점에서부터 품질이 유지되어야 합니다. 결국 건강한 나무에서 자란  건강한 커피체리가 필요합니다. </p><p class="v_paragraph">이런 상황에서 커피 공급 품질의 지속가능성과 생산성을 보장하기 위해 네스프레소가 적용한 AAA 지속가능 품질™ 프로그램과 현지 농부들간의 파트너십이 성과를 발휘하고 있습니다. 이러한 파트너십 덕분에 지역 특유의 전통을 그대로 유지하면서 가공 과정의 시작부터 품질을 보장하고 수확량까지 늘릴 수 있습니다. 궁극적으로 건식 가공법은 원형 그대로의 방식으로 네스프레소가 세계와 공유하고자 하는 커피 가공법입니다.</p><blockquote class="v_emphasis">궁극적으로 건식 가공법은 전통적인 방식 그대로 네스프레소가 세계와 공유하고자 하는 커피 가공법입니다.</blockquote><figure class="v_image v_layers v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/48/wide_layers_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">건식 가공법은 건조 과정에서 생두를 둘러싼 과육이 유지되기 때문에 과육의 달콤함과 풍미가 생두에 더해집니다. image</span> <figcaption><p>건식 가공법은 건조 과정에서 생두를 둘러싼 과육이 유지되기 때문에 과육의 달콤함과 풍미가 생두에 더해집니다.</p></figcaption></figure><div class="v_media_text v_imageProduct v_floatImageProduct"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/48/product_ethiopia-capsule_L.jpg" alt="product_ethiopia-capsule"> <div><h3>마스터 오리진 에티오피아</h3> <strong>꽃향과 산미</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7714.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p class="g_productPrice">₩ 690</p> <div class="g_addToCartCustom">
<button class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">에티오피아제품 0개가 장바구니에 담겨 있습니다. 지금 주문하기</span> <span aria-hidden="true" class="g_labelAdd">지금 주문하기</span> <span aria-hidden="true" class="g_labelUpdate">장바구니 업데이트</span> <span aria-hidden="true" class="g_labelPhantom">장바구니 업데이트</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button><span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">건식 가공된 아라비카로 만든 마스터 오리진 에티오피아는 과육을 벗기지 않고 건식 가공하기 때문에 잘 익은 과육의 달콤함과 풍미가 생두에 전달됩니다. 뛰어난 솜씨로 건식 가공된 에티오피아산 아라비카는 섬세한 꽃향기와 와일드한 머스크향이 일품인 탁월한 아로마를 선사합니다. 와일드한 풍미가 은은하게 퍼지는 향기로운 커피를 즐겨보세요. 수 세기 동안 이어진 장인의 기술이 한 잔의 커피로 전해집니다.</p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>
<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/high-altitude" class="">손 닿지 않던 곳의 커피 : 마스터 오리진 버츄오 콜롬비아 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/sustainability//main/coffee-origins-and-blends/double-washed" class="">두 번의 완벽함 : 이중 습식가공의 마스터 오리진 멕시코 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
