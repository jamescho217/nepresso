...
<article class="v_articlePage v_articleId19"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/19/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>커피 그라인딩이 과학인 이유</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">올바른 그라인딩은 완벽한 커피를 만드는 핵심 요소입니다.</p><p class="v_paragraph">커피 그라인딩이라는 마법같은 과정을 통해, 로스팅한 커피 원두는 가루로 변신합니다. 섬세한 그라인딩은 커피의 끝맛을 결정합니다. </p><p class="v_paragraph"><strong>누구보다 까다롭습니다.</strong><br>올바른 그라인딩 과정을 통해 네스프레소 커피 맛을 향상시키는데는 다년간의 경험이 필요합니다. 그라인딩은 정확도와 함께 일관성이 필요합니다. 바로 이 점 때문에 마스터 그라인더가 필요합니다. 이를 통해 완벽한 커피 한 잔을 완성합니다. </p><p class="v_paragraph">커피 입자가 지나치게 크면 물이 빠른 속도로 입자 사이를 통과하게 되면 충분한 풍미를 얻지 못하게 됩니다. 커피 입자가 지나치게 미세하면, 물이 빠져나가지 못해 커피가 쓰고 진해집니다. 입자 크기가 일정하지 않으면 커피 잔에 너무 많은 침전물이 남게 됩니다.</p><blockquote class="v_emphasis">올바른 그라인딩 과정을 통해 네스프레소 커피 맛을 향상시키는데는 다년간의 경험이 필요합니다. </blockquote><figure class="v_image v_working-out v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/19/wide_working-out_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">Working Out image</span> <figcaption><p>그라인딩은 정확도와 함께 일관성이 필요합니다. 바로 이 점 때문에 마스터 그라인더가 필요합니다. 이를 통해 우리만큼이나 까다로운 기술로 완벽한 커피 한 잔을 뽑아냅니다.</p></figcaption></figure><aside class="v_side_block"><strong>전체 커피 보기</strong> <small></small> <p> <a href="../../grands-crus-coffee-range">다양한 종류의 네스프레소 커를 확인해보세요</a> 고객님께 맞는 커피와 함께 최상의 커피 경험을 즐겨보시기 바랍니다.</p></aside><p class="v_paragraph"><strong>마스터 그라인더</strong><br>네스프레소 그라인더는 4개의 롤링 실린더로 구성된 거대한 피라미드와 같습니다. 먼저 열매가 부서진 뒤에, 실린더의 "피라미드"로 내려가면서 더 미세한 입자로 분쇄됩니다. 그라인딩 테크놀로지는 항상 변화하고, 정교해지며, 지속적으로 업데이트 됩니다. </p><aside class="v_side_block"><strong>매혹적인 크레마</strong> <small>크레마</small> <p>크레마는 커피 표면에 생성되는 거품층입니다.</p></aside><!----><figure class="v_image v_cup-coffee v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/19/wide_cup-coffee_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">한 잔의 커피 image</span> <figcaption><p>크레마, 부드럽고 풍부한 공기방울이 만들어낸 환상적인 레이어</p></figcaption></figure> 
...
<li><a href="/nespresso/sustainability/the-coffee-experience/volluto-secret" class="">볼루토 커피가 간직하고 있는 비밀 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience/lean-in-and-listen" class="">네스프레소의 이야기에 귀 기울여 보세요. <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 

<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/naturally-processed" class="" tabindex="-1" aria-label="오랜 시간을 이어온 전통 : 건식 가공법의 에티오피아 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/48/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>오랜 시간을 이어온 전통 : 건식 가공법의 에티오피아 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/the-coffee-experience/lean-in-and-listen" class="" tabindex="-1" aria-label="네스프레소의 이야기에 귀 기울여 보세요."><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/58/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>네스프레소의 이야기에 귀 기울여 보세요.</h4> <p class="v_category">커피 경험</p> <time></time></div></div></div></a></article></li></ul></aside> 
