...
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality" class="">지속 가능한 품질</a></li>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends" class="">원산지와 블렌드</a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience" class="router-link-exact-active router-link-active">커피 경험</a></li></ul></div></div></div></nav>

<article class="v_articlePage v_articleId58"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/58/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>네스프레소의 이야기에 귀 기울여 보세요.</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> 
<button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> 
...
<p class="v_headline">커피 머신에 네스프레소 캡슐을 넣기 전, 당신의 완벽한 커피 한 잔 안에 깃든 많은 이야기들을 떠올리는 시간을 가져 보세요.</p><p class="v_paragraph">네스프레소와 함께 잠시 상상해봅니다. 당신이 선택한 캡슐을 커피 머신에 넣습니다. 그 다음 어떤 소리가 들려올까요? 레버가 닫히고 캡슐을 관통하면서 딸각 소리가 납니다. 버튼이 눌리고, 버튼에 불이 켜집니다. 완벽하게 균형 잡힌 온도의 물은 파이프와 캡슐을 통과하고 커피가 추출되는 소리가 들립니다. 작은 거품 형태의 황금빛 갈색 크레마가 생겨나며, 향긋한 커피향이 당신의 공간을 가득 채웁니다. 방금 상상했듯이 짧은 시간 안에 많은 일이 발생합니다. 그러나 이보다 더 많은 일들이 당신이 즐기는 커피 모먼트 안에 있습니다.</p><p class="v_paragraph">네스프레소의 커피는 단순한 커피 캡슐이나 커피 머신이 아닌 그 이상의 가치를 담고 있습니다. 네스프레소의 이야기는 당신이 마시는 커피 한 잔, 커피 원두의 가공을 넘어, 심지어 커피 씨앗 한 알이 심겨지기 전부터 시작됩니다. 네스프레소의 이야기는 커피 농부들과 농학자들, 그들이 경작하는 땅, 그리고 그들에게 커피 농사의 전통을 전수해준 선대들로부터 시작됩니다.</p><blockquote class="v_emphasis">네스프레소 이야기는 커피 씨앗 한 알이 심겨지기 전부터 시작됩니다.</blockquote><figure class="v_image v_farmers1 v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/58/wide_farmers1_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">(좌)이즈완디(Iswandi) 및 (우)알바 마리아(Alba Maria)가 커피 열매를 수확하는 사진 image</span> <figcaption><p>(좌)이즈완디는 인도네시아의 커피 농부로, 아체(Aceh)지역의 신설 커피 협동 조합을 통해 공동체 및 결속의 장점을 직접 경험한 1,800 여 명의 커피 농부 중 한명입니다. (우) 알바 마리아와 장년의 커피 농부들은 든든한 미래를 보장할 수 있는 생계 수단이 자리 잡혔기에 자녀들에게도 이제 커피 농사를 물려줄 수 있다는 확신이 생겼습니다.</p></figcaption></figure><p class="v_paragraph">네스프레소 이야기는 네스프레소, 국제 공정무역 기구(Fairtrade International), 커피 무역업체 올람(Olam)의 도움으로 신설된 아체 지역의 커피 협동조합을 통해 그가 속한 공동체와 결속력을 확인한 이즈완디 지역의 인도네시아 커피농부의 온화한 미소 속에 담겨 있습니다. 그는 해당 지역의 사회/경제적 여건 개선, 농장의 생산성 향상, 커피 품질의 일관성을 경험한 1,800 여 명의 아체 지역 농부 중 한 명입니다.</p><p class="v_paragraph">네스프레소의 이야기는 커피 농업의 불확실성으로 인해 7,200 그루의 커피 나무가 심어진 커피 농장을 한 때 떠나려 했던 알바 마리아가 살고 있는 콜롬비아의 칼다스(Caldas) 산악 지대에서 시작됩니다.  그녀는 기후 변화로 인한 예측 불가능한 날씨 패턴과 이런 상황이 작물에 끼치는 여파 등, 자연의 섭리 만으로는 농사를 짓기가 어려운 상황이었습니다.  하지만 네스프레소가 블루 마블 마이크로 인슈어런스(Blue Marble Micro insurance)와 함께 진행하는 시범 작물 보험에 가입한 후로 그녀는 더 이상 미래에 대해 불안해 할 이유가 없어졌습니다. 이제 그녀는 자신의 땅과, 그 땅의 흙으로 돌아와 자신의 딸과 손녀, 그리고 후대들에게 물려줄 커피의 전통을 지켜줄 수 있습니다.</p><blockquote class="v_emphasis">되살아나는 땅과 함께 공동체도 새롭게 살아납니다.</blockquote><div class="v_media_text v_undefined"><div class="v_clearboth"></div> <figure class="v_image v_farmers2 v_floatImage"><div><img src="https://www.nespresso.com//shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/58/float_farmers2_L.jpg" alt="farmers2"></div> <span class="v_visually_hidden">농부들을 교육하고 있는 니아쿠체나(Nyakucena)  image</span> <figcaption><p>짐바브웨의 AAA 농학자인 타파즈와 니아쿠체나 (Tafadzwa Nyakuchena)는 그가 속한 지역의 커피 농부들과 함께 현지에서 진두지휘하면서 긍정적인 변화와 성장에 도움을 주고, 실제로 그 변화를 확인했습니다.</p></figcaption></figure><p class="v_paragraph">짐바브웨의 커피 산업은 가뭄과 경제 위기로 사라질 뻔 했습니다. 네스프레소의 이야기는 이 위기를 목격하고 네스프레소와 함께 헤쳐 낸 짐바브웨의 농학자, 타파즈와 니아쿠체나의 두 손에서 시작됩니다. 니아쿠체나는 네스프레소의 ‘AAA 지속가능한 품질™ 프로그램(AAA Sustainable Quality™ Program)’ 테두리 안에서 커피 농장을 직접 순회하며 농장마다 유용한 자문을 제공해 주었습니다. 그는 종자를 심기 위한 토양 준비, 가지치기, 해충 및 질병 검사와 같은 필수 영역에서 꼭 필요한 지식과 정보를 전달하고 지원했습니다. 2년 여의 노력 끝에, 니아쿠체나는 커피 농사로 증가한 이윤 덕분에 교육, 의료 및 전반적인 경제 발전에 긍정적인 변화가 생겨나고 있음을 확인하고 있습니다.</p><p class="v_paragraph">네스프레소는 전세계에서 사랑받고 있는 네스프레소의 모든 커피에 대한 이야기를 함께 나눌 수 있기를 바랍니다. 네스프레소는 당신이 커피를 선택할 때, 커피에 담겨 있는 이야기를 함께 느낄 수 있기를 소망합니다. 네스프레소의 커피 한 잔에는 농학자들이 농부에게 전달한 교육과 농부들의 삶의 질 향상, 되살아난 공동체의 끈끈한 결속력, 그리고 가문의 전통을 회복한 후대 농가들의 이야기가 담겨 있습니다.  이러한 이야기들은 계속될 것입니다. 네스프레소의 커피는 모두 무한한 가능성을 가지고 있으며, 한 가지 이야기에 뿌리를 두고 있습니다. 네스프레소는 커피의 품질을 중시하고, 이는 되살아나는 땅과 농가를 통해 회복된 공동체에 기반하여 만들어진다는 것입니다.  </p><p class="v_paragraph">바로 이 이야기말로 전할 만한 가치가 있는 것입니다.</p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer> 

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/the-coffee-experience/grinding" class="">커피 그라인딩이 과학인 이유 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience/tasting" class="">커피 테이스팅의 예술 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience/volluto-secret" class="">볼루토 커피가 간직하고 있는 비밀 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
