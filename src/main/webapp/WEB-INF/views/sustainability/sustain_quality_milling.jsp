...
<article class="v_articlePage v_articleId20"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/20/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>지난 100년의 커피 제조 방식을 바꾼 커피협력공동체</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">네스프레소 AAA 프로그램에 참여하는 콜롬비아 자르뎅의 <br>커피 농부들은 커피협력공동체 덕분에 더 많은 수입과 함께, <br>더 많은 여가 시간을 가족과 보낼 수 있고, 소중한 물을 절약할 수 있게 되었습니다.</p><p class="v_paragraph">"할아버지와 아버지 모두 커피 농부였습니다. 저도 커피 재배를 하고 있습니다" 콜롬비아 자르뎅에 울창한 농장을 돌아보면서 움베르토는 말했습니다. </p><p class="v_paragraph">이전 농장은 이와 같지 않았습니다. </p><p class="v_paragraph">"할아버지 세대에서 숲의 나무를 베어버려 야생 동식물들이 사라져 버렸습니다."라고 그는 인정했다.   </p><p class="v_paragraph">자르뎅에서 커피 열매를 가공하기 시작하면서부터, 움베르토는 수질이 개선되고 있다는 것을 잘 알고 있습니다. 2010년 <a class="innerLink" href="../sustainable-coffee-quality/explore-our-central-coffee-mill-in-colombia">커피협력공동체</a>를 세우기 이전에 지역의 농민들은 자신의 커피 열매를 직접 가공하였습니다. 가공 표준이 모두 다르기 때문에, 커피 품질이 일정하지 않았습니다. 열매를 씻기 위해 많은 물을 사용했고, 폐수를 제대로 처리하지 않아 강이 오염되었습니다. </p><p class="v_paragraph">지속적으로 좋은 커피를 제공하면서, 환경을 보호하고 농부의 수입을 증대시킬 수 있는 방법을 찾고 있었습니다. 그리고 Antioquia에 커피협력공동체를 세우기로 결정했습니다. 이 또한 네스프레소의 AAA 지속가능 품질™ 프로그램의 일부입니다. </p>
<figure class="v_embed_video v_isPlaying"><iframe aria-label="test" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/VG-Tz2DiKo8?enablejsapi=1&amp;rel=0&amp;fs=0&amp;autoplay=false&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=5" id="widget6" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true"></iframe> <figcaption aria-hidden="true" tabindex="-1"><p>환경의 수호자</p></figcaption> <!----></figure>
<aside class="v_side_block"><strong><strong class="v_brand" term="nespresso">Nespresso</strong>의 AAA<br>지속가능한 품질 프로그램</strong> <small></small> <p>2003년에 도입한 네스프레소의 AAA 지속가능 품질™ 프로그램은 열대우림동맹과 협업하여 출범했습니다. 이 맞춤형 커피 프로그램은 환경을 보존하고, 농부와 지역 사회가 지속가능한 삶을 유지하도록 지원하면서, 동시에 더 좋은 커피를 고객에게 제공할 수 있게 합니다. </p></aside><p class="v_paragraph">우리의 파트너들은 수출 업체 Expocafé, the Andes Coffee Cooperative, USAID, the non-profit development agency ACDI/VOCA, Cenicafé, 콜롬비아 커피 리서치 센터, Colombian Coffee Growers Federation (FNC)가 있습니다. 자세한 내용을 확인하세요.  </p>
<figure class="v_embed_video v_isPlaying"><iframe aria-label="test" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/g2dtsuapodU?enablejsapi=1&amp;rel=0&amp;fs=0&amp;autoplay=false&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=7" id="widget8" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true"></iframe> <figcaption aria-hidden="true" tabindex="-1"><p>커피협력공동체</p></figcaption> <!----></figure>
<p class="v_paragraph">약 200명의 농부는 가공을 위해 지역의 안데스 협동조합에 의해 운영되는 공장으로 커피 열매를 가져갑니다. 농부들은 하루에 4시간을 절약하고 있습니다. 공장에서 제조되는 고품질의 커피는 높은 프리미엄을 받고 있기 때문에 더 많은 돈을 벌고 있습니다. </p><p class="v_paragraph">주변 환경 또한 커피협력공동체 덕분에 나아지고 있습니다. 이전에 사용했던 물 양의 69% 정도만 사용하며 폐수도 적절하게 처리되어 물의 오염 줄어들게 되었습니다.</p><p class="v_paragraph">"커피를 집에서 씻지 않고, 커피협력공동체 가져가면 물을 오염시키지 않습니다,"라고 움베르토는 이야기합니다. 그리고 "이것은 후손들에게 물려줄 유산입니다"라고 말하며 그의 농장을 응시합니다. </p>
<figure class="v_embed_video v_isPlaying"><iframe aria-label="test" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/Cu_ZEhQLoCI?enablejsapi=1&amp;rel=0&amp;fs=0&amp;autoplay=false&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=9" id="widget10" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true"></iframe> <figcaption aria-hidden="true" tabindex="-1"><p></p></figcaption> <!----></figure>
<p class="v_paragraph">네스프레소의 AAA 지속가능 품질™ 프로그램으로 더 많은 나무를 재배할 수 있게 되었고, 농장에는 더 많은 야생 동물이 모여들게 되었습니다. 농장에 다양한 생물이 존재하는 환경은 토양을 더욱 비옥하게 만들고, 장기적으로는 커피의 품질을 개선시킵니다. </p><p class="v_paragraph">커피협력공동체 덕분에 커피 농부들의 삶이 바뀌었고, 농사를 짓는 동안 가족을 돌보는데 어려움을 겪었던 Esteban Suarez는 두 자녀의 아버지로서의 삶을 살 수 있게 되었습니다. 자르뎅의 농장에서 12시간 이상 동안 커피 열매를 따고, 다시 저녁까지 커피 열매의 껍질을 벗겼으며, 다음 날 아침 해뜨기 전에 다시 열매를 씻기 위해 일찍 일어나곤 했습니다. </p><p class="v_paragraph">이제 더 이상 그렇게 하지 않습니다. 34세의 Esteban은 커피협력공동체에 커피 열매를 가져가면 됩니다. 부인과 7세, 10세의 자녀들과 더 많은 시간을 보낼 수 있을 뿐만 아니라, 소방대원으로 자원해서 일을 할 수 있습니다. </p><p class="v_paragraph">"이제는 오후 6시에 커피협력공동체에 갈 수 있습니다. 시간을 절약할 수 있어, 아침 6시에 일어납니다. 그리고 다음 날 더 많은 열매를 딸 수 있습니다. 이제는 집에서 아내와 아이들과 더 많은 시간을 보낼 수 있습니다."라고 이야기합니다.  </p><p class="v_paragraph">"저도 사람들을 돕기 위해 소방대원으로 일을 했어요. 도움을 필요로 하는 사람들을 도와야겠다는 마음이 저절로 들었죠. 아무 것도 하지 않고 가만히 있을 수가 없었어요."</p>
<figure class="v_embed_video v_isPlaying"><iframe aria-label="test" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/w-QPx-MvhWU?enablejsapi=1&amp;rel=0&amp;fs=0&amp;autoplay=false&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=11" id="widget12" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true"></iframe> <figcaption aria-hidden="true" tabindex="-1"><p>The fisherman</p></figcaption> <!----></figure>
<p class="v_paragraph">커피협력공동체는 농부인 Luiz Angel에게 시간을 절약할 수 있어 낚시를 할 수 있는 여가 시간을 주었습니다. "기계에서 벗겨낸 껍질은 물을 발효시킵니다. 그리고 커피 열매에는 우리가 점액질이라고 부르는 끈적끈적한 것이 있는데, 우리가 그것을 직접 씻어 내곤 했는데, 그것이 강을 오염시켰습니다."  </p><p class="v_paragraph">오늘날, 놀라운 변화가 일어났습니다.</p><blockquote class="v_emphasis">"커피협력공동체는 지역 사회에 큰 영향을 미쳤습니다," 그래서 "우리는 오늘날 강을 깨끗하게 보존하며, 환경을 보호할 수 있습니다."라고 이야기합니다.  </blockquote> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/hope" class="">커피 경작 공동체가 품은 희망의 힘 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/milling" class="">지난 100년의 커피 제조 방식을 바꾼 커피협력공동체 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 

<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/the-coffee-experience/grinding" class="" tabindex="-1" aria-label="커피 그라인딩이 과학인 이유"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/19/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>커피 그라인딩이 과학인 이유</h4> <p class="v_category">커피 경험</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/high-altitude" class="" tabindex="-1" aria-label="손 닿지 않던 곳의 커피 : 마스터 오리진 버츄오 콜롬비아 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/53/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>손 닿지 않던 곳의 커피 : 마스터 오리진 버츄오 콜롬비아 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/indonesia" class="" tabindex="-1" aria-label="인도네시아에 커피 협력공동체를 만들다"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>인도네시아에 커피 협력공동체를 만들다</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li></ul>
