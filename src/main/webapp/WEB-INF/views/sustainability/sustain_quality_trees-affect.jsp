...
<article class="v_articlePage v_articleId13"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/13/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>커피 품질에 영향을 미치는 나무들</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">나무는 토양을 비옥하게 하고 <br>커피 농장에 중요한 그늘을 제공합니다. <br>그러나 이것은 나무의 긍정적 영향의 일부에 불과합니다. </p><p class="v_paragraph">일정한 온도는 커피의 품질에 영향을 주는 가장 중요한 환경적 요소 가운데 하나입니다. 이러한 의미에서 나무는 커피 농장의 완벽한 파트너입니다. 뿌리가 토양의 부식을 방지하는 동안 파라솔이 들판을 덮어주듯이, 나뭇잎은 커피 나무에 자연적인 그늘을 만들어 주며, 동시에 폭우로부터 커피 나무를 보호합니다. </p><p class="v_paragraph">하지만 이것이 전부는 아닙니다. </p><aside class="v_side_block"><strong>삼림농업</strong> <small></small> <p>산림농업은 나무를 이용해 농업 시스템과 결합한 것으로 생산물의 품질에서부터 농부의 복지와 지속가능한 커피 생산에 이르기까지 모든 것을 개선하는데 기여합니다.   </p></aside><p class="v_paragraph">나무는 목재, 과일, 향신료, 약초를 제공하여 커피 농부에게 부가 수입을 만들어줍니다. 유기물로 토양을 비옥하게 하고, 이산화탄소를 흡수해 야생 동식물의 서식지를 만들어 주기 때문에 생물 다양성을 회복시켜 줍니다. </p><p class="v_paragraph">이것이 바로 나무를 열심히 심어온 이유입니다. <br>이것은 부분에 지나지 않습니다.</p><div class="v_infography v_powerOfTrees"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/13/infography_power-of-trees_L.jpg&quot;);"></div> <div class="v_section v_first"><div class="v_sectionRestrict"><div class="v_sectionContent"><h3>나무의 힘</h3> <p>왜 네스프레소가 커피를 만들기 위해 나무를 심으려고 하며, <br>산림농업은 기후 복원력에 얼마나 도움이 될까요? </p></div></div></div> <div class="v_section v_sectionFull"><div class="v_sectionRestrict"><div class="v_sectionContent"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/13/svg_plant-protectors.svg&quot;);"></div> <h4>커피 나무의 보호</h4> <p>2009년 이후 네스프레소는 모든 사업에 있어 커피 한잔 당 탄소 배출량을 20%까지 줄여왔습니다. </p> <p>저희의 목표는 2020년까지 사업을 하고 있는 커피 생산 지역에서 1,000만 그루의 나무를 심는 것입니다. </p></div></div></div> <div class="v_section v_sectionFull"><div class="v_sectionRestrict"><div class="v_sectionContent"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/13/svg_trees-absorb.svg&quot;);"></div> <h4>나무는 이산화탄소를 흡수합니다. </h4> <p>산소를 다시 공기중으로 배출하면서 이산화탄소를 제거하고 저장합니다. 그래서 기후 변화에 대처하는데 도움을 줍니다. </p></div></div></div> 
<div class="v_section v_last"><div class="v_sectionRestrict">
<div class="v_sectionContent"><h4>나무가 실제로 어떻게 유용한가요?</h4> <p class="h4"></p> <div>
<ul>
<i class="fas fa-check" style="color:#a7c996;font-size:1.5em;position:absolute;-webkit-transform:scaleX(1);transform:scaleX(1)"></i><li>낙엽과 같은 유기물로 토양을 비옥하게 합니다. </li>
<i class="fas fa-check" style="color:#a7c996;font-size:1.5em;position:absolute;-webkit-transform:scaleX(1);transform:scaleX(1)"></i><li>열대의 태양이나 폭우와 같은 악천후로부터 커피나무를 보호합니다.</li>
<i class="fas fa-check" style="color:#a7c996;font-size:1.5em;position:absolute;-webkit-transform:scaleX(1);transform:scaleX(1)"></i><li>토양을 제자리에 있게 하기 때문에 토양의 부식을 방지하고 산이나 비탈에서 토양의 유실을 막아줍니다. </li>
<i class="fas fa-check" style="color:#a7c996;font-size:1.5em;position:absolute;-webkit-transform:scaleX(1);transform:scaleX(1)"></i><li>목재, 과일, 향신료, 약초를 농민에게 제공하여 커피농부에게 부가수입을 만들어 줍니다. </li>
<i class="fas fa-check" style="color:#a7c996;font-size:1.5em;position:absolute;-webkit-transform:scaleX(1);transform:scaleX(1)"></i><li>협력업체 PUR Project와 함께 저희는 이미 이디오피아, 콰테말라, 콜롬비아, 인도네시아에 1,400만 그루의 나무를 심었습니다. </li></ul></div></div></div></div></div> 
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/certify-program" class="">인증 프로그램을 통한 협력 : 지속 가능한 품질의 비밀 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/farmers-future" class="">커피 농부들의 안전한 미래 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/partnership" class="" tabindex="-1" aria-label="영향력을 발휘하는 파트너십"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/28/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>영향력을 발휘하는 파트너십</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li></ul></aside>
