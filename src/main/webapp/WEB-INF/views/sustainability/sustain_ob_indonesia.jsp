...
<li><a href="/nespresso/sustainability/coffee-origins-and-blends" class="router-link-exact-active router-link-active">원산지와 블렌드</a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience" class="">커피 경험</a></li></ul></div></div></div></nav>

<article class="v_articlePage v_articleId49"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>인도네시아에 커피 협력공동체를 만들다</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">작은 협동조합에 큰 변화를 만든 AAA 지속가능 품질™ 프로그램과 공정무역 파트너십</p><p class="v_paragraph">네스프레소라는 단어를 처음 들었을 때 대부분의 사람들이 가장 먼저 떠올리는 것은 커피입니다. 물론 네스프레소가 하는 일의 중심에는 언제나 커피가 자리하고 있지만, 커피는 좀 더 크고 훨씬 더 복잡하면서 보람을 창출하는 협력공동체의 핵심입니다. 커피는 협력공동체를 단결시키는 공통의 접점으로 작용하며, 어떤 경우에는 협력공동체를 형성하는 구심점 역할을 합니다. 실제로 인도네시아의 수마트라섬에서 이런 역할을 확인할 수 있었습니다. 인도네시아는 마스터 오리진 인도네시아 습식탈곡 가공 아라비카의 산지입니다. </p><blockquote class="v_emphasis">네스프레소가 하는 일의 중심에는 언제나 커피가 자리하고 있지만, 커피는 좀 더 크고 훨씬 더 복잡하면서 보람을 창출하는 협력공동체의 핵심입니다. </blockquote><figure class="v_image v_cooperative v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/wide_cooperative_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">1800명의 현지 농부들은 아라 카하야니 가요(Ara Cahayani Gayo) 협동조합에 참여해, 공정무역과 책임있고 지속가능한 커피 재배를 위한 기반을 마련하고 있습니다.  image</span> <figcaption><p>1800명의 현지 농부들은 아라 카하야니 가요(Ara Cahayani Gayo) 협동조합에 참여해, 공정무역과 책임있고 지속가능한 커피 재배를 위한 기반을 마련하고 있습니다. </p></figcaption></figure><aside class="v_side_block"><strong>습식탈곡 가공법</strong> <small></small> <p>다습한 수마트라 섬의 기후로 인해 이곳의 커피 농부들은 습식탈곡으로 불리는 인도네시아의 독특한 가공법을 사용합니다. 이들은 커피체리를 수확해 과육을 제거하고 밤새 자루 안에서 발효시킨 뒤 다음날 아침에 세척합니다. 세척된 생두는 건조시키지 않고 젖어있는 상태에서 탈곡을 합니다. 이 과정에서 생두가 뭉개지고 모양이 변형되기도 하지만, 우윳빛 청색이나 녹색을 띄는 생두에서는 신선하고 달콤한 냄새가 납니다. 이러한 과정에서 생두는 햇빛에 직접 노출돼 커피의 건조가 더욱 빠르게 진행됩니다. 그 결과 완벽한 풍미를 지난 커피가 만들어집니다.</p></aside><p class="v_paragraph">2017년 7월, 수마트라의 최북단 아체 주에서는 처음부터 네스프레소의 AAA 지속가능 품질™ 프로그램과 파트너십을 체결하면서 새로운 공정무역 협동조합이 조성됐습니다. 네스프레소는 AAA 지속가능 품질™ 프로그램을 통해 농업 협력공동체를 지원하고 이들의 권한을 강화하고 있습니다. 현지 협동조합은 이러한 사명을 실천하는 데 최적의 기회였습니다. </p><p class="v_paragraph">커피 협동조합의 일원이 된다는 것은 단지 사업을 운영하는 것 이상의 의미가 있습니다. 협력공동체의 일원이 되면 지속가능한 농법 교육, 필요한 도구와 장비의 합리적 조달 등 소규모 자영농이 혼자서는 쉽게 얻을 수 없는 다양한 혜택을 이용할 수 있습니다. 이를 통해 농부들은 커피를 가공하고 최상의 품질을 도출할 수 있으며, 동시에 국제공정무역 인증을 획득할 수 있습니다. </p><figure class="v_image v_wethulled v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/wide_wethulled_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">습식탈곡된 생두는 수확후 우윳빛 청색이 감돌게 하는 가공 기술 덕분에 매우 특별한 풍미를 선사합니다.  image</span> <figcaption><p>습식탈곡된 생두는 수확후 우윳빛 청색이 감돌게 하는 가공 기술 덕분에 매우 특별한 풍미를 선사합니다. </p></figcaption></figure><aside class="v_side_block"><strong>네스프레소와 공정무역</strong> <small></small> <p>"네스프레소와 공정무역의 도움으로 마을의 사회적 보장과 복지에 대한 현실을 제대로 파악할 수 있었습니다. 수천명의 농부들은 협동조합을 통해 혜택을 입고 있습니다." - 공정무역</p></aside><p class="v_paragraph">1800명의 농부들이 가입한 협동조합은 아라 (이것은) 카하야니 (태양 또는 빛) 가요 (현지 지명-가요 고산지대)로 불립니다. 여기에는 이곳 농부들이 일정한 커피 품질을 유지하기 위해 책임감을 갖고 지속가능한 농법을 장려함으로써 지역의 빛이 될 수 있다는 희망이 있습니다. </p><div class="v_media_text v_imageProduct v_floatImageProduct"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/product_indonesia-capsule_L.jpg" alt="product_indonesia-capsule"> <div><h3>마스터 오리진 인도네시아</h3> <strong>깊은 풍미와 우디향</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7711.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p class="g_productPrice">₩ 690</p> <div class="g_addToCartCustom">
<button class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">인도네시아제품 0개가 장바구니에 담겨 있습니다. 지금 주문하기</span> <span aria-hidden="true" class="g_labelAdd">지금 주문하기</span> <span aria-hidden="true" class="g_labelUpdate">장바구니 업데이트</span> <span aria-hidden="true" class="g_labelPhantom">장바구니 업데이트</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">이들의 협동조합은 습식탈곡이라고 불리는 독특한 수확 기법을 통해 하나의 작품과 같은 멋진 커피를 만들어냈습니다. 네스프레소의 마스터 오리진 인도네시아 습식탈곡 아라비카는 짙고 풍부한 바디감과 싱그러운 열대우림의 향을 가진 매우 특별힌 커피입니다. 네스프레소는 이러한 커피를 재배, 수확, 캡슐화하는 과정에 참여하고 있습니다. 한 아이를 키우는 데 마을 전체가 필요하다는 말이 있습니다. 네스프레소는 이를 커피에 적용하고 있으며 기쁜 마음으로 마을의 일원이 되고자 합니다.</p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>
<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/volluto" class="">볼루토 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/double-washed" class="">두 번의 완벽함 : 이중 습식가공의 마스터 오리진 멕시코 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/black-honey" class="">달콤함과 지속가능성 : 블랙허니 가공법의 니카라과 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul>
</aside> 
<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/colombia" class="" tabindex="-1" aria-label="콜롬비아의 커피협력공동체"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>콜롬비아의 커피협력공동체</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
...
<button tabindex="-1" aria-hidden="true" class="v_btnBackToTop"><i class="fas fa-chevron-up"></i> <span>맨위로</span></button></div></article></div>
