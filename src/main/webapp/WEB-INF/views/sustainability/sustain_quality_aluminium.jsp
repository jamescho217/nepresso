...
<article class="v_articlePage v_articleId3"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/3/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>영원히 재생 가능한 알루미늄 </h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">커피의 신선함을 지키는<br>네스프레소의 알루미늄 캡슐의 선순환 구조. </p><p class="v_paragraph">네스프레소는 커피의 신선도를 완벽하게 유지하기 위해 알루미늄 캡슐을 사용합니다. 알루미늄 소재는 산소, 빛, 습기를 완벽하게 차단합니다.   </p><p class="v_paragraph">그러나 그것은 시작에 불과합니다.<br>알루미늄은 100% 무한 재생 가능할 뿐만 아니라, 끊임없이 재활용됩니다. 자세한 내용은 아래를 확인하세요.   </p><blockquote class="v_emphasis"><center>알루미늄은 100% 무한으로 재활용할 수 있습니다. </center></blockquote><div class="v_infography v_aluminium"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/3/infography_aluminium_L.jpg&quot;);"></div> <div class="v_section v_first"><div class="v_sectionRestrict"><div class="v_sectionContent"><h3>알루미늄의 영속성 </h3> <p>네스프레소 커의 섬세한 맛을 지키기 위한<br>최상의 방법 </p></div></div></div> <div class="v_section v_sectionFull"><div class="v_sectionRestrict"><div class="v_sectionContent"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/3/svg_battery-icon.svg&quot;);"></div> <h4>알루미늄은 1차 금속 생산 대비,<br>재활용시 에너지 사용량을 95% 이하까지 줄일 수 있습니다.</h4> <p class="v_big">알류미늄은 수차례 재활용해도 재료 고유의 성분은 유지됩니다.</p></div></div></div> <div class="v_section v_sectionDouble"><div class="v_sectionRestrict"><div class="v_sectionContent"><div class="v_cell"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/3/svg_recycling-icon.svg&quot;);"></div> <p class="v_big">캡슐은 음료 캔, 자전거, 컴퓨터, <a class="innerLink" href="../sustainable-coffee-quality/7-ways-coffee-capsules-are-recycled">픽시 머신의 컬러 사이드 패널과 새로운 캡슐로 재활용</a>될 수 있습니다.</p></div> <div class="v_cell"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/3/svg_capsule-icon.svg&quot;);"></div> <h4>알루미늄 탄소 배출량의 86%는 채굴과 생산 과정에서 발생합니다. <br>모든 클럽 회원은 2020년까지 편리한 재활용 방법을 이용할 수 있게 됩니다.  </h4> <p class="v_big">2020년까지 100%의 클럽 회원이 <br>편리하게 재활용에 참여 하도록 솔루션 마련 계획</p></div></div></div></div> <div class="v_section v_last"><div class="v_sectionRestrict"><div class="v_sectionContent"><p class="v_small">국제 알루미늄 협회, The Positive Cup, Gloess, A.N., Schönbächler, B., Klopprogge, B 등. <br>Eur Food Res Technol (2013) 236: 607. doiL10.10007/s00217-013-1917-x</p></div></div></div></div><p class="v_paragraph"><center>알루미늄 캡술의 재활용은 최고 품질의 커피와 <br>지속가능한 환경 조성에 기여하는 가장 중요한 요소입니다. <a href="https://www.nespresso.com/kr/ko/storeLocator#RECYCLING">이 곳</a>을 눌러 가까운 캡슐 재활용 장소를 확인해보세요.<center></center></center></p> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/secret" class="">콜롬비아의 커피협력공동체 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
