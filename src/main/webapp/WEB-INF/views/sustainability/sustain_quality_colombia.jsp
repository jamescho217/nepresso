...
<article class="v_articlePage v_articleId12"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>콜롬비아의 커피협력공동체</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">콜롬비아의 자르뎅의 지역 사회는 <br>어떻게 농부들이 가족들과 더 많은 시간을 보내게 하고, <br>소중한 물을 절약할 수 있도록 했을까? </p><p class="v_paragraph">오랫동안 콜롬비아의 커피 농부들은 개별적으로 커피를 생산해 왔습니다. 이 과정은 수공업으로 많은 시간이 소요됩니다. 올바른 절차나 장비 없이 진행할 경우, 필요 이상으로 많은 물을 낭비하게 되고, 농부가 주의하지 않으면 폐수로 강을 오염시킬 수 있습니다.  </p><p class="v_paragraph">스스로 일관성을 유지하는 것은 쉽지 않아, 일부 농부들은 고품질 커피 생산함으로써 얻을 수 있는 프리미엄을 놓치는 경우가 종종 발생합니다. </p><aside class="v_side_block"><strong>콜롬비아 지역 커피 공장</strong> <small></small> <p>커피협력공동체의 커피 농부는 네스프레소의 AAA 지속가능 품질™ 프로그램을 통해 17%까지 순이익이 상승했습니다. </p></aside><p class="v_paragraph">커피 품질의 일관성을 유지하면서, 동시에 커피 공정 과정에 환경적인 영향을 줄이기 위해, 네스프레소와 핵심 파트너들은 커피 농장의 영속성을 위해 새로운 커피협력공동체를 세웠습니다. </p><p class="v_paragraph">안데스 깊은 산맥의 콜롬비아 자르뎅에 커피협력공동체는 중앙 집중 제조 공정을 통해 효율성을 개선해서, 약 200명의 농부를 한꺼번에 투입할 수 있고, 하루 제조 공정 과정 중 약 4시간의 소요 시간을 절약할 수 있습니다. 이 공장에서는 일관성 있는 제조 공정을 통해 더 좋은 원두를 생산합니다. 이 곳에서는 이전에 사용된 물의 양의 약 60%를 절약할 수 있을 뿐만 아니라, 오염을 방지할 수 있습니다. 서로 윈윈입니다. </p><p class="v_paragraph">또한 <a class="innerLink" href="../sustainable-coffee-quality/community-milling-in-jardin-colombia">커피협력공동체</a>의 기술력은 완벽한 커피의 맛과 아로마를 보존하는데 기여했습니다. </p>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_delivery_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>01</span></div> <div class="v_cell"><h3>운반</h3> <p>농부는 손으로 붉은 커피 열매를 따는 즉시 공장으로 운반하는데, <br>이것은 협동조합 단위로 이루어집니다. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_inspection_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>02</span></div> <div class="v_cell"><h3>검사</h3> <p>협동조합의 조합원은 열매의 샘플을 선별해, 붉은색과 초록색 열매가 얼마나 들어있는지를 평가합니다. <br>붉은색 열매가 최상급으로 잘 익은 것이며 과즙이 많습니다. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_buying-cherries_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>03</span></div> <div class="v_cell"><h3>구매</h3> <p>구매한 것 중 품질이 좋은, 붉은색 열매의 비율에 따라 비용을 지불합니다. <br>커피협력공동체를 통해 농부가 가능한 많은 양의 붉은색 열매를 수확하기 때문에, 네스프레소의 거부율은 50% 이하입니다.  </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_depulping_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>04</span></div> <div class="v_cell"><h3>디펄핑(껍질 벗기기)</h3> <p>열매는 껍질과 과육의 외피를 제거하는 롤러를 가진 기계에 넣습니다. <br>과육은 가공된 후에 친환경 퇴비로 사용하기 위하여 농부들에게 배분됩니다. 철저히 통제된 생산 과정을 통해 완벽한 원두를 생산할 수 있습니다. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_fermenting_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>05</span></div> <div class="v_cell"><h3>발효</h3> <p>커피 열매가 "점액질" (끈적한 층)에 싸여 있거나 이를 제거할 때도 과일향을 유지할 수 있도록 12시간에서 24시간 동안 발효 탱크에 보관합니다. 발효 탱크는 실린더형인데 청소하기 쉽고 물을 덜 사용하게 됩니다. 이러한 가공을 거친 커피 원두를 파치먼트 커피라고 합니다 </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_drying_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>06</span></div> <div class="v_cell"><h3>건조</h3> <p>커피 원두는 커피협력공동체에서 약 20분 정도 떨어진 곳의 파티오(patios) 위 햇빛에 말립니다. <br>파티오에는 플라스틱 지붕과 옆문들이 있어, 낮에는 열고 기온이 떨어지는 밤에는 문을 닫을 수 있는 구조입니다. 파치먼트 커피를 햇빛에 말리는데 약 5일 정도 소요됩니다.  </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/12/listicle_cleaning_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>07</span></div> <div class="v_cell"><h3>세척과 물 절약 </h3> <p>커피협력공동체에서 열매를 가공할 때 생긴 폐수를 처리합니다. 따라서 폐수 오염은 없습니다.<br>농부가 가공을 하지 않을 때는 연간 420만 리터의 엄청난 양의 물을 절약합니다.</p></div></div></figcaption></figure></div><p class="v_paragraph">앞으로 네스프레소는 커피협력공동체를 계속해서 개선해 나갈 것입니다. 그렇게 되면 더 많은 농부들에게 혜택을 줄 수 있을 것입니다. Gigante Huila 지역에 두번째 공동체를 준비하고 있고, 기후 친화적인 해결책을 가지고, 새로운 공동체를 지원하고 있습니다.    </p> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/day" class="">농학자의 하루 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/certify-program" class="">인증 프로그램을 통한 협력 : 지속 가능한 품질의 비밀 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/double-washed" class="" tabindex="-1" aria-label="두 번의 완벽함 : 이중 습식가공의 마스터 오리진 멕시코 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/52/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>두 번의 완벽함 : 이중 습식가공의 마스터 오리진 멕시코 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
