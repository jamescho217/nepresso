...
<article class="v_articlePage v_articleId26"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/26/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>인증 프로그램을 통한 협력 : <br>지속 가능한 품질의 비밀</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">열대우림동맹과 네스프레소의 특별한 협력관계는 <br>고객에게 양질의 커피를 제공할 수 있는 환경을 조성하고 농부에게는 향상된 삶의 질을 보장 합니다.</p><p class="v_paragraph">가장 중요한 원재료인 커피의 미래를 보장하고 비지니스의 지속적인 성장을 깨닫는 것, 그것이 이 프로그램 성공으로 얻게 된 가장 큰 긍정적 결과 입니다. 이러한 이유로, 네스프레소는 2003년부터 열대우림동맹과 협약을 맺어, 고품질 커피를 생산할 수 있도록 농부의 생산 환경을 보호해왔습니다. 이것은 커피 농부의 삶은 물론, 모든 가족과 공동체의 삶을 윤택하게 만드는 좋은 방법 입니다.</p><aside class="v_side_block"><strong>열대우림동맹</strong> <small>우리의 파트너</small> <p> 1987년부터 시작된 열대우림동맹의 미션은 생물의 다양성과 함께 지속가능한 환경을 보존하는 것입니다.</p></aside><p class="v_paragraph">네스프레소는 열대우림동맹과 함께 AAA 지속가능 품질™ 프로그램을 만들어 운영하고 있습니다. 이 프로그램은 네스프레소의 전문적 커피 지식과 열대우림동맹의 사회적 환경적인 지속가능성 지식은 물론 농가 기술을 모두 한데 모아, 지구와 인간 모두에게 유익한 기술을 위해 운영 됩니다.</p><aside class="v_side_block"><strong>네스프레소의<br>AAA 지속가능 품질™ 프로그램</strong> <small></small> <p>2003년에 도입한 <a class="innerLink" href="../sustainable-coffee-quality/the-secret-to-sustainable-and-quality-coffee">네스프레소의 AAA 지속가능 품질™ 프로그램</a>은 열대우림동맹과 협업하여 출범했습니다. 이 프로그램은 최고 품질의 커피 생산을 위해 농부들과 함께 직접 협업하여, 건강한 농업 공동체로 살아갈 수 있도록 개선하는데 주력합니다. </p></aside><figure class="v_image v_rainforest v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/26/wide_rainforest_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden"> image</span> <figcaption><p>네스프레소와 열대우림동맹의 협력관계는 생산환경을 보호함으로서 고품질 커피 생산을 가능하게 합니다.</p></figcaption></figure><p class="v_paragraph">네스프레소의 AAA 지속가능 품질 프로그램™은 지난 11년 간 300명의 농부들을 시작으로 확대되어 현재는 11개 국가의 63,000명 이상의 농부들이 참여하고 있습니다.</p><p class="v_paragraph">그 효과는 확실한 것으로 나타났습니다.<br>실제로 활동 중인 350명 이상의 농학자 네트워크에 따르면, AAA 지속가능 품질 프로그램을 도입한 농부들은 다른 일반 농부들에 비해 상당히 긍정적인 결과를 보였습니다. 네스프레소 비지니스의 미래는 농부들의 미래와 직결되어 있고, 최적화된 사례를 통해 우리의 협력 관계는 앞으로도 지속적인 향상을 거듭할 것 입니다. </p><p class="v_paragraph">농부들의 생각은 어떤가요?<br>"우리는 네스프레소의 AAA 지속가능 프로그램을 통해 우리 농가의 추가적인 소득을 얻고 있습니다. 이는 우리 농장에 근무하는 모든 직원들의 삶을 윤택하게 하며, 자녀 교육에 큰 도움을 주고 있습니다." <br>Olga Lucía Otero, <br>2006년부터 콜롬비아 AAA 농장에서 근무 중인 농부</p><blockquote class="v_emphasis"><center>“우리는 네스프레소와 열대우림연맹이 협업을 통해 지금까지 성취한 것들을 자랑스럽게 생각하며, 농부들과 함께 공동의 가치와 활발한 커피 공동체를 만들기 위해 지속적으로 성장해 나갈 수 있기를 기대합니다. 네스프레소의 소중한 고객으로써 여러분들이 영세 커피 농부들의 지속가능성을 장려하기 위해 도와주신 것에 대해 진심으로 감사드립니다” <br>Nigel Sizer <br>열대우림동맹 회장 </center></blockquote><figure class="v_image v_aaafarms v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/26/wide_aaafarms_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden"> image</span> <figcaption><p>네스프레소는 커피의 80% 이상을 네스프레소 AAA 지속가능 품질 프로그램 인증을 받은 농장에서 조달하며 40% 이상의 커피가 열대우림연맹의 인증을 받은 농장에서 제공됩니다.</p></figcaption></figure> 
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/7ways" class="">캡슐과 커피 찌꺼기를재활용 하기 위한 7가지 방법 <br>규칙 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
