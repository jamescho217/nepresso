...
<article class="v_articlePage v_articleId43"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/43/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>여성 커피 농학자들이 에티오피아에 가져온 변화<style>.vue  {word-break:keep-all !important;}</style></h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">여성 커피 농학자들은 에티오피아 커피의 품질을 높여줄 뿐 아니라, 다른 여성들의 롤모델이 되기도 합니다.</p><p class="v_paragraph">훈다투 아야나는 단연 힘든 일을 맡고 있습니다. 고향 에티오피아에서 커피 농학자로 일했던 그녀는 커피 농부들이 전통적인 방법으로 작물을 관리하는 것을 그만두도록 설득하였지만, 쉽지는 않았습니다. </p><aside class="v_side_block"><strong>아라비카</strong> <small>정의</small> <p>에티오피아에서 탄생한 아라비카는 커피의 한 종입니다. 전 세계에서 생산되는 커피 중 3분의 2는 아라비카로 만들어졌습니다.</p></aside><p class="v_paragraph">그러나 31세의 훈다투는 단념하지 않고 계속해서 오토바이를 타고 농장을 순회하며 농부들에게 최고의 농경 기술을 보여주며 그들이 변화하기를 기다렸습니다. 오래된 커피 나무를 잘라 회춘시키는 방법을 보여주었고, 토양 관리나 퇴비 살포 등의 주제로 이야기를 했습니다. 비즈니스 스킬 또한 알려주었습니다.</p><figure class="v_image v_farmer-hundatu v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/43/wide_farmer-hundatu_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">훈다투 아야나는 커피 농부들에게 선택적 채집과 같은 농경 기술을 전수합니다. image</span> <figcaption><p>훈다투 아야나는 커피 농부들에게 선택적 채집과 같은 농경 기술을 전수합니다.</p></figcaption></figure><p class="v_paragraph">농부들은 그녀가 지속적으로 노력했다라는 점을 고마워합니다. 훈다투가 알려준 신식 기술을 활용하자 수익이 상승했기 때문입니다. 덕분에 놀랍고도 즐거운 변화가 일어났습니다. 몇몇 농부들은 자녀를 학교에 보낼 수 있게 되었고, 다른 농부들은 오토바이나 자동차, 심지어는 집까지 구매하게 되었습니다.</p><aside class="v_side_block"><strong>통계</strong> <small></small> <p>네스프레소의 도움으로 현재 네스프레소 지속 가능 품질 프로그램을 통해 커피 농부와 함께 일하는 441명의 커피 농학자 중 31%는 여성입니다.<br><br> *출처: 네스프레소 AAA 지속 가능 품질 프로그램.<br>**출처: 월드뱅크에 따르면, 평균적으로 아프리카 내 커피 농학자 중 7%는 여성인 것으로 추정된다.</p></aside><p class="v_paragraph">커피로 사람들의 삶에 변화를 가져다 주는 여성 커피 농학자는 알테아원도 지구 출신인 훈다투 뿐만이 아닙니다. 실제로 현재 네스프레소 지속 가능 품질 프로그램을 통해 커피 농부와 함께 일하는 441명의 커피 농학자 중 31%는 여성입니다. 모든 커피 농학자들은 네스프레소의 파트너사이자 비영리 단체인 테크노서브로부터 교육을 받았습니다.</p><figure class="v_embed_video v_isPlaying"><iframe aria-label="test" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/QqDNhRNjklQ?enablejsapi=1&amp;rel=0&amp;fs=0&amp;autoplay=false&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=7" id="widget8" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true"></iframe> <figcaption aria-hidden="true" tabindex="-1"><p>여성 커피 농학자들이 에티오피아에 가져온 변화</p></figcaption> <!----></figure><p class="v_paragraph">이러한 여성들은 남성이 월등히 많은 커피 산업에서 성 평등을 개선하기 위해 노력할 뿐 아니라, 가족을 부양하고 다른 여성들의 롤모델로써 활약을 하기도 합니다.</p><p class="v_paragraph">훈다투는, "우리가 처음 일을 시작했을 때에는 여성과 남성이 평등하지 않다는 문화적 암시 때문에 힘들었다"고 털어놓습니다. "하지만 우리의 집요함과 헌신을 알게 된 농부들은 곧 우리를 수용하고 정중히 대해주었다."</p><blockquote class="v_emphasis">우리가 처음 일을 시작했을 때에는 여성과 남성이 평등하지 않다는 문화적 암시 때문에 힘들었다. 하지만 우리의 집요함과 헌신을 알게 된 농부들은 곧 우리를 수용하고 정중히 대해주었다.</blockquote><p class="v_paragraph">한 가지 좋은 소식은 그녀의 인생에도 좋은 변화가 있었다는 것입니다. 그녀는, "내 월급으로 친척들까지 부양했었다"며, "지금은 동생들에게 제대로 된 교육 과정을 밟게 해 주었기 때문에 전보다 상황이 좋아졌다. 부모님은 새로운 집을 짓고, 나는 남편과 아디스아바바에 땅을 사서 커피 나무를 심기 시작했는데, 현재 체리가 열리기 시작했다."고 말합니다.</p><p class="v_paragraph">훈다투는 사람들에게 영감을 불어 넣고, 지방에서 만난 많은 소녀들과 젊은 여성들에게 멘토 역할을 하여 커피 농학자의 꿈을 키워줍니다. "내가 오토바이를 타고 가는 것을 보고 나처럼 되고 싶어 한다"고 그녀는 말합니다.</p> 
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/gender-equality" class="">에티오피아 여성 농학자들의<br>성평등 개선 노력 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 

<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/heroes" class="" tabindex="-1" aria-label="에티오피아의 커피 영웅들.vue  {word-break:keep-all !important;}"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>에티오피아의 커피 영웅들<style>.vue  {word-break:keep-all !important;}</style></h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/late-harvest" class="" tabindex="-1" aria-label="기다림의 미학: 늦수확 가공법의 콜롬비아 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/47/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>기다림의 미학: 늦수확 가공법의 콜롬비아 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/meet-farmers" class="" tabindex="-1" aria-label="명예의 전당에 있는 커피 농부와의 만남. "><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>명예의 전당에 있는 커피 농부와의 만남. </h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li></ul>
</aside>
