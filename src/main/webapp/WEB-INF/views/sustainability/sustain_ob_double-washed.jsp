...
<article class="v_articlePage v_articleId52"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/52/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>두 번의 완벽함 : 이중 습식가공의 마스터 오리진 멕시코 커피</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">까다로운 만큼 보람이 있는 가공법이 와일드한 질감과 스파이시한 풍미의 블렌드를 만들다.</p><p class="v_paragraph">정성을 쏟을수록 일의 결과는 좋아진다는 말이 있습니다. 이 말이 항상 옳은 것은 아니지만, 네스프레소가 참여하고 활동하고 있는 커피 업계에서는 이 말이 사실일 때가 더 많습니다. 커피 생두와 토양을 더욱 세심하게 관리하고 더 많은 관심을 기울일수록 더 좋은 품질의 원두와 더 뛰어난 풍미를 가진 커피가 만들어집니다. 까다로운 가공법과 완고한 원칙을 거쳐 만드는 커피는 그 만큼의 수고를 감수할 가치가 충분하다는 점을 네스프레소는 잘 알고 있습니다. </p><figure class="v_image v_beans v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/52/wide_beans_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">네스프레소는 테팟락스코 지역에서 천연 "크리올로" 교배종을 발견했습니다. 이 품종은 크기가 크고 깔끔한 맛과 중성적인 풍미를 가져 이 블렌드에 이상적입니다.&nbsp; image</span> <figcaption><p>네스프레소는 테팟락스코 지역에서 천연 "크리올로" 교배종을 발견했습니다. 이 품종은 크기가 크고 깔끔한 맛과 중성적인 풍미를 가져 이 블렌드에 이상적입니다.&nbsp;</p></figcaption></figure><p class="v_paragraph">로부스타는 멕시코에서 상대적으로 늦게 재배되기 시작했습니다. 1949년부터 멕시코의 여러 지역에서 재배되었지만 보통 대형 시장용으로 건식 가공되었습니다. 안타깝게도 이 지역 생두는 건식 가공 후 품질이 항상 우수한 것만은 아니었습니다. 그러나 네스프레소가 테팟락스코에서 발견한 커피는 특별했습니다. 깔끔한 맛과 중성적인 풍미, 유난히 큰 사이즈 등 이 커피의 독특한 특징은 네스프레소가 찾는 블렌드에 탁월한 결과를 제공할 수 있었습니다. 그러나 생두가 단지 특별하기만 한 것이 아니라 그 가공에는 완고한 원칙이 필요했습니다.&nbsp;</p><blockquote class="v_emphasis">깔끔한 맛과 중성적인 풍미, 유난히 큰 사이즈 등 이 커피만이 갖는 독특한 특징은 탁월한 결과를 제공할 수 있었습니다.&nbsp;</blockquote><figure class="v_image v_spicy v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/52/wide_spicy_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">버츄오 라인의 마스터 오리진 멕시코는 와일드하고 스파이시한 풍미와 함께 풍부한 질감이 돋보입니다.  image</span> <figcaption><p>버츄오 라인의 마스터 오리진 멕시코는 와일드하고 스파이시한 풍미와 함께 풍부한 질감이 돋보입니다. </p></figcaption></figure><div class="v_media_text v_imageProduct v_floatImageProduct"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/52/product_mexico-capsule_L.jpg" alt="product_mexico-capsule"> <div><h3>마스터 오리진 멕시코</h3> <strong>진한 풍미와 스파이시향</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7387.10" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p data-disabled="true" class="g_productPrice">₩ 990</p> <div class="g_addToCartCustom">
<button disabled="disabled" class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">마스터 오리진 멕시코제품은 현재 품절 입니다.</span> <span aria-hidden="true" class="g_labelAdd">일시 품절</span> <span aria-hidden="true" class="g_labelUpdate"></span> <span aria-hidden="true" class="g_labelPhantom">일시 품절</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">네스프레소는 이 블렌드에 적합한 풍미를 만들기 위해 생두의 과육을 모두 제거하는 습식 가공이 필요하다는 것을 알게됐습니다. 이 특별한 로부스타는 크기만 큰 것이 아니라 과육이 두껍고 질겨서 이를 제거하는 작업은 쉽지 않았습니다. 그래서 이중 습식 가공법을 적용하게 되었습니다. 커피를 발효시켜 한 번이 아닌 두 번의 연속적인 세척 과정을 거치고 나서야 네스프레소가 기대하는 품질의 커피가 나왔습니다.</p><p class="v_paragraph">버츄오 라인의 마스터 오리진 멕시코는 아라비카에 이중 습식 가공의 로부스타가 블렌딩된 제품입니다. 손이 많이 가는 까다로운 가공법이 필요하지만 그 결과로 만들어진 커피는 풍미가 뛰어납니다. 스파이시향과 로스팅향이 진한 풍부한 질감의 커피가 만들어집니다. 이러한 커피를 얻기 위한 수고는 기꺼이 감수할 만한 가치가 있습니다.&nbsp;</p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>
<aside class="v_relatedArticles"><h2>관련 글</h2>
<ul>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/black-honey" class="">달콤함과 지속가능성 : 블랙허니 가공법의 니카라과 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/late-harvest" class="">기다림의 미학: 늦수확 가공법의 콜롬비아 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul>
</aside> 
<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul><li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/secret" class="" tabindex="-1" aria-label="완벽한 커피를 재배하는 비결"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/42/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>완벽한 커피를 재배하는 비결<style>.vue  {word-break:keep-all !important;}</style></h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/volluto" class="" tabindex="-1" aria-label="볼루토"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/23/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>볼루토</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/milling" class="" tabindex="-1" aria-label="지난 100년의 커피 제조 방식을 바꾼 커피협력공동체"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/20/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>지난 100년의 커피 제조 방식을 바꾼 커피협력공동체</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li></ul>
</aside> 
