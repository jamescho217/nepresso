...
<div class="v_categoryPage"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/origins-and-blends/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo play"><iframe frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/WpgmD83fyz4?enablejsapi=0&amp;rel=0&amp;fs=0&amp;autoplay=1&amp;playlist=WpgmD83fyz4&amp;controls=0&amp;loop=1&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=13" id="widget14" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true" data-gtm-video-complete="true"></iframe></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>원산지와 블렌드</h1> <p class="v_headline">마스터 오리진 부터 블렌딩까지, 모든 한 잔의 완벽한 커피를 위한 네스프레소의 선택을 확인해보세요.</p> <!----></div></div> <div class="v_video"><div id=""></div></div> <button class="v_btnRoundM v_btnScrollTo"><i class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <section class="v_section v_articles v_origins-and-blends">
<ul class="v_items8">
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/black-honey" class="" tabindex="-1" aria-label="달콤함과 지속가능성 : 블랙허니 가공법의 니카라과 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/50/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>달콤함과 지속가능성 : 블랙허니 가공법의 니카라과 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li>
