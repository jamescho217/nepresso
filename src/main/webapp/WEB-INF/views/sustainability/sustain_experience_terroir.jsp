...
<article class="v_articlePage v_articleId15"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>테루아 테이스팅 노트: <br>커피에 있어 중요한 이유</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">네스프레소 커는 토양, 기후 및 지역이 만들어내는 완벽한 하모니의 산물입니다.</p><p class="v_paragraph">사람이 가진 개성처럼 네스프레소 커피는 환경의 영향을 받습니다. </p><p class="v_paragraph">테루아(토양, 기후, 위치)는 커피의 맛과 특성에 큰 영향을 미칩니다. - 네스프레소 커피와는 달리 어떤 커피는 많은 비에 노출되기도 합니다. </p><aside class="v_side_block"><strong>테루아</strong> <small></small> <p>커피 원산지 테루아는 커피가 재배되는 곳의 토양, 기후 및 위치를 의미합니다. 이것은 커피의 맛과 특성에 상당한 영향을 미칩니다. </p></aside><p class="v_paragraph">아래 6곳의 서로 다른 국가의 자연 환경과 이들이 만들어 내는 <a class="innerLink" href="../the-coffee-experience/a-coffee-tasting-guide">독특한 커피의 풍미</a>에 대해서 살펴보세요.    </p><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/gif_colombia_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>콜롬비아</span></h3> <p>콜롬비아에서는 적도 바로 위 매우 높은 고도에서 자라는 워시드 아라비카가 생산됩니다. 이곳은 강수량이 많은 지역으로 미묘한 산미와 풍부한 과일향이 특징입니다. 이것이 바로 네스프레소 로사바야 데 콜롬비아 커피처럼 많은 커피에서 콜롬비아 아라비카를 사용하는 이유이기도 합니다. </p> <!----> <aside class="v_side_block"><strong>워시드 아라비카</strong> <small></small> <p>워시드 아라비카는 습식 방식을 통해 가공됩니다. 커피 열매는 펄핑 과정을 거쳐 껍질 및 과육이 제거된 후 발효 과정을 거치게 됩니다. 발효가 완료되면 세척 과정을 거쳐 건조에 앞서 남아있는 과육을 제거합니다. </p></aside></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/gif_brazil_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>브라질</span></h3> <p>전세계 최대의 커피 생산국인 브라질은 완전히 정반대의 스토리를 가지고 있습니다. 대부분의 브라질 커피는 건조한 저지대에서 재배되기 때문에 시리얼 향이 특징입니다. 네스프레소는 이 커피를 많은 커피 블렌딩 과정에서 베이스로 사용합니다. </p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/gif_ethiopia_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>에티오피아</span></h3> <p>아라비카가 탄생한 곳으로 매우 특별한 곳입니다. 독특한 식물들이 많이 자라고 수 백년 동안 이들 식물에 둘러쌓여 블루베리, 버가모트, 복숭아 및 시트러스 같은 매우 특별한 풍미를 갖게 되었습니다. 네스프레소의 부킬라 카 에티오피아 커피를 마시면 그 의미를 느낄 수 있습니다.</p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/gif_costarica_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>코스타리카</span></h3> <p>코스타리카는 햇빛과 강우량이 풍부하고 활화산을 포함한 화산 지대가 많아 커피가 잘 자랄 수 있는 결정적인 환경 요소를 갖추고 있습니다. 네스프레소가 커피를 소싱하는 주요 지역은 해발 1,600미터 높이로 연간 강수량이 3,000밀리미터에 이릅니다. 일반적으로 코스타리카 커피는 시트러스 향이 나는 것으로 잘 알려져 있으나 네스프레소가 커피를 소싱하는 지역은 로스팅 후 맥아 향과 코코아 향이 나는 것이 특징입니다. 크리미한 질감의 아르페지오 커피를 마셔보면 그 의미를 느낄 수 있습니다.</p> <!----> <!----></figcaption></figure></div></div>
<div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/gif_kenya_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>케냐</span></h3> <p>케냐에서 생산되는 커피는 산미가 강하고 시트러스 향 뿐만 아니라 풍부한 과일 향이 특징입니다. <br><br>케냐는 커피 재배와 관련해서 완벽한 테루아를 갖추고 있습니다. 이 곳은 해발 1,500~2,100미터 높이에 위치해 있으며 적도 바로 위에 위치해 있기 때문에 밤과 낮의 길이가 같고 커피가 자라는 지역의 일조량도 높습니다. 또한 높은 고도에서 열대성 구름과 그늘에 가려져 커피가 자랄 수 있는 완벽한 조건을 갖추고 있으며 화산지대가 많아 토양에 커피가 자라기에 좋은 미네랄이 풍부합니다. 케냐에서 생산되는 커피는 산미가 강하고 시트러스 향 뿐만 아니라 풍부한 과일 향을 갖고 있습니다. 네스프레소 코지 커피의 잘 익은 과일 향은 케냐의 아라비카에서 나온다고 할 수 있습니다.</p> <!----> <!----></figcaption></figure></div></div>
<div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/15/gif_india_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>인도</span></h3> <p>농가 수익을 높이기 위해 인도의 커피 농가들은 커피를 향신료와 함께 재배하곤 합니다. 이 곳에서는 후추 덩굴이 커피 나무를 감싸 자라기도 하는데, 이 때문에 인도 커피는 후추 향이 나기도 합니다. </p> <!----> <!----></figcaption></figure></div></div>
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/the-coffee-experience/lean-in-and-listen" class="">네스프레소의 이야기에 귀 기울여 보세요. <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/the-coffee-experience/italy" class="" tabindex="-1" aria-label="이탈리아에서 커피 주문하는 방법: 규칙"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>이탈리아에서 커피 주문하는 방법: <br>규칙</h4> <p class="v_category">커피 경험</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/day" class="" tabindex="-1" aria-label="농학자의 하루"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/59/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>농학자의 하루</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/indonesia" class="" tabindex="-1" aria-label="인도네시아에 커피 협력공동체를 만들다"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/49/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>인도네시아에 커피 협력공동체를 만들다</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li></ul></aside> 
