...
<article class="v_articlePage v_articleId10"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> 
<div class="v_sectionRestrict"><div class="v_sectionContent"><h1>명예의 전당에 있는 커피 농부와의 만남. </h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">커피 농부와 농학자들에게 경외심을 표합니다. </p><p class="v_paragraph">네스프레소는 농부들의 헌신 덕분에 <a href="”{ARTICLE_ID=9}”">완벽한 커피</a>를 탄생시킵니다. 각 농부들은 농산물의 품질 향샹에 도움을 주는 지속가능성과 생산 분야의 전문가와 농학자의 지원을 받습니다.        </p><p class="v_paragraph">우리는 그들의 협업과 환경에 대한 헌신에 보답하고자 네스프레소 지속가능 품질 관련 우수 농부상을 시상하기 시작했습니다.  </p><p class="v_paragraph">매년 네스프레소 AAA 지속 가능 품질 프로그램의 9개 회원국 중 뛰어난 농부와 농학자 팀을 선정합니다.  </p><aside class="v_side_block"><strong>네스프레소의 AAA<br>지속가능 품질™ 프로그램</strong> <small></small> <p>2003년에 도입한 <a class="innerLink" href="../sustainable-coffee-quality/the-secret-to-sustainable-and-quality-coffee">네스프레소의 AAA 지속가능 품질™ 프로그램</a>은 열대우림동맹과 협업하여 출범했습니다. 이 맞춤형 커피 프로그램은 환경을 보존하고, 농부와 지역 사회가 지속가능한 삶을 유지하도록 지원하면서, 동시에 더 좋은 커피를 고객에게 제공할 수 있게 합니다. </p></aside><p class="v_paragraph">우승자들에게 여행권을 지급합니다. - 보통 이 여행권은 네스프레소의 "명예의 전당"과 커피에 대한 사랑을 느낄 수 있는 스위스 로잔의 네스프레소의 고향으로 갑니다. </p><p class="v_paragraph">우리의 주인공들을 만나보세요:  </p>
<div class="v_gif v_section v_farmer"><div class="v_sectionRestrict"><div class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/farmer_alejandro_L.jpg&quot;);"></div> <div class="v_cell"><dl><dt>농부</dt><dd>Alejandro De Felipe Rendón</dd><dt>농학자</dt><dd>José Rafael Hernández Marini</dd><dt>농장</dt><dd>Tlaltepan (El Cerrito) (멕시코 Ixhuatlán del Café 농장 중 일부) </dd><dt>선정된 이유</dt><dd>2005년 당시 27세의 Alejandro는 네스프레소의 AAA 지속가능 품질™ 프로그램의 개척자 중에 한 명입니다. 8명의 형제들 중 막내였던 그는 자신의 형제들 모두 AAA 프로그램에 참여하도록 독려했습니다. 그는 항상 환경을 고려하면서, 생산성 증가와 커피 품질의 향상을 위해 필요한 것이 무엇인가에 대해 항상 관심을 가졌습니다. </dd></dl> <!----></div></div></div></div>
<div class="v_gif v_section v_farmer"><div class="v_sectionRestrict"><div class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/farmer_marco_L.jpg&quot;);"></div> <div class="v_cell"><dl><dt>농부</dt><dd>Marco Aurelio Alonzo Aguirre</dd><dt>농학자</dt><dd>Desiderio Valiente Reyes</dd><dt>농장</dt><dd>La Primavera &amp; Anexos (과테말라 Huehuetenango 농장 중 일부)</dd><dt>선정된 이유</dt><dd>약 10년 동안 Marco Aurelio는 네스프레소의 AAA 지속가능 품질™ 프로그램과 함께 일했습니다. 그는 농장에 중요한 변화를 가져온 최초의 생산자들 중 한 사람이고, 네스프레소의 AAA 지속가능 품질™ 프로그램에 큰 공헌을 한 농부였습니다. 예를 들면, 다양한 나무를 심고, 지역 사회를 대변하고, 학교와 도로를 건설하는데 도움을 주고, 다른 농부들에게 전기를 공급하는데 도움을 주었습니다. Desiderio는 인턴으로 일을 시작했지만 열심히 일한 덕분에 한 지역의 농학자가 되었습니다. 이 프로그램을 통해 10년 동안 일하면서, 생산자들과 강한 유대 관계를 형성했고, 그 지역의 농학자 및 인턴들로 구성된 소그룹도 만들었습니다. </dd></dl> <!----></div></div></div></div>
<div class="v_gif v_section v_farmer"><div class="v_sectionRestrict"><div class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/farmer_miller_L.jpg&quot;);"></div> <div class="v_cell"><dl><dt>농부</dt><dd>Miller Hurtatiz Ortiz</dd><dt>농학자</dt><dd>Luz Andrea Cano Ruiz</dd><dt>농장</dt><dd>La Primavera (콜롬비아 Huila 농장 중 일부) </dd><dt>선정된 이유</dt><dd>해를 거듭할수록 프로그램에 큰 공헌을 해왔습니다. Miller의 헌신 덕분에, 지역에서 성공적인 생산자로 인정받게 되었습니다. 그의 농장은 지역 사회의 좋은 모델이 되었고, 그는 공동체 근처에 도로를 건설하는데 적극적으로 참여해 왔습니다. 현재 그는 지역에서 네스프레소의 AAA 지속가능 품질™ 프로그램에 참여한 모든 이들의 롤 모델이 되었고, 지역에 있는 학교를 방문해 커피 농부로서 자신의 경험을 나누고 있습니다. Luz Andrea는 Hurtatiz 가족의 또다른 구성원입니다. 6년 이상동안 그들과 함께 일했고, 지금도 농업 활동과 밀접하게 일하고 있습니다. </dd></dl> <!----></div></div></div></div>
<div class="v_gif v_section v_farmer"><div class="v_sectionRestrict"><div class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/farmer_tintin_L.jpg&quot;);"></div> <div class="v_cell"><dl><dt>농부</dt><dd>Tintin Uhan</dd><dt>농학자</dt><dd>Imas Suryati</dd><dt>농장</dt><dd>Palempar (인도네시아 Ciwidey 농장 중 일부) </dd><dt>선정된 이유</dt><dd>Tintin은 인도네시아 여성이고, 약 50명의 네스프레소의 AAA 지속가능 품질™ 프로그램에 속한 지역 단체의 리더입니다. Tintin은 커피 농업을 시작하고자 하거나, 커피 농업의 발전을 원하는 여성들에게 방법을 제시했습니다. 커피 수확 시기를 설명하기 위해, 익은 커피 열매와 같은 색의 붉은 팔찌를 만드는 것을 도왔습니다. 농부 단체들은 자발적으로 Sunda (인도네시아) Hejo (녹색)라고 불리우는 자바 서쪽에서 발생한 산불을 끄는데 동참했습니다. 그들은 산림농업을 통해 숲을 보호할 수 있다고 생각했습니다. 그들의 생각은 옳았습니다. Imas 또한 지역의 학교와 공동체에 영어를 도입하는데 도움을 주었습니다. 이를 통해, 그들을 커피 구매자들과 소통할 수 있었고, 그들의 지식을 전수할 수 있었습니다.    </dd></dl> <!----></div></div></div></div>
<div class="v_gif v_section v_farmer"><div class="v_sectionRestrict"><div class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/10/farmer_luis_L.jpg&quot;);"></div> <div class="v_cell"><dl><dt>농부</dt><dd>Luis Fernando Quispe Lopez</dd><dt>농학자</dt><dd>Antero Flores Mego</dd><dt>농장</dt><dd>San Pedro (Villa Rica 농장 중 일부) </dd><dt>선정된 이유</dt><dd>Luis Fernando는 커피 농장의 독특한 다양성, 식물 사이에 정확한 거리, 해충과 질병 예방, 쉐이딩 시스템과 토양 보존에서 대단한 진전을 이뤘습니다. 이를 통해 열대우림연맹으로 부터 인정을 받을 수 있었습니다. Antero는 네스프레소의 AAA 지속가능 품질™ 프로그램 회원임을 자랑스러워합니다. 그는 농부들이 이 프로그램을 통해 고품질의 커피와 관련된 더 많은 것을 실천할 수 있다고 생각합니다.  </dd></dl> <!----></div></div></div></div> 
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/7ways" class="">캡슐과 커피 찌꺼기를재활용 하기 위한 7가지 방법 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/women-agronomists" class="">여성 커피 농학자들이 에티오피아에 가져온 변화 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 

<aside class="v_articles"><h2>좋아할 만한 다른 글</h2> 
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/gender-equality" class="" tabindex="-1" aria-label="에티오피아 여성 농학자들의성평등 개선 노력 "><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/11/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>에티오피아 여성 농학자들의<br>성평등 개선 노력 </h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/volluto" class="" tabindex="-1" aria-label="볼루토"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/23/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>볼루토</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li></ul></aside> 
