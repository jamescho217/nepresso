...
<article class="v_articlePage v_articleId47"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/47/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>기다림의 미학: 늦수확 가공법의 콜롬비아 커피</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">강한 신뢰로 튼튼한 파트너십과 더 좋은 커피를 창출하게 된 콜롬비아</p><p class="v_paragraph">관계에서는 항상 누군가 새롭게 도약해야 하는 순간이 있습니다. 지금 서 있는 땅은 불안정하고, 발이 닿는 공간은 익숙하지 않으며, 앞으로의 행로는 불확실합니다. 이러한 상황에서 마음 속 깊은 곳에는 또 다른 세계에 가볼 만한 가치가 있다고 속삭입니다. 미지의 세계로 한 걸음 내딛을 때 새로운 관계가 자라납니다. 이 때 신뢰에 기반한 새로운 기회가 열립니다. 불안하지만 더 크고 더 오래 지속되는 무언가를 얻기 위해 손을 뻗어야 합니다.</p><p class="v_paragraph">이러한 상황이 바로 네스프레소 AAA 지속가능 품질™ 프로그램의 농학자들과 콜롬비아 안데스 산맥 지역의 네스프레소의 파트너 농부들 사이에 일어났습니다. 이들은 서로의 지식과 열정, 기술을 하나로 모아 도약했습니다. 참가자들 모두 이러한 결과에 만족해하고 있습니다. </p><blockquote class="v_emphasis">미지의 세계로 한 걸음 내딛을 때 새로운 관계가 자라납니다. </blockquote><figure class="v_image v_harvesting v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/47/wide_harvesting_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">네스프레소의 AAA 농학자들과 농부들이 지난 15년 동안 협력하는 동안 네스프레소는 신뢰에 기반에 한번 더 도약하고 커피 수확의 한계를 창의적으로 넓힐 수 있었습니다.  image</span> <figcaption><p>네스프레소의 AAA 농학자들과 농부들이 지난 15년 동안 협력하는 동안 네스프레소는 신뢰에 기반에 한번 더 도약하고 커피 수확의 한계를 창의적으로 넓힐 수 있었습니다. </p></figcaption></figure><p class="v_paragraph">커피 업계에 종사하거나 커피를 사랑하는 모든 사람들은 잘 익은 커피체리가 어떤 것인지 잘 알고 있습니다. 진하고 아름다운 붉은 색의 커피체리는 네스프레소 농부들과 현장 작업자들의 손톱을 자주색으로 물들이면서 수확을 준비하는 완벽한 시기가 되었음을 알려줍니다. </p><p class="v_paragraph">그래서 네스프레소가 커피체리를 평소보다 더 오래 익도록 내버려두었다가 체리가 상하는 위험을 감수하며 진한 자주빛이 될 때까지 수확을 기다리라고 했을 때, 농부들이 처음에 주저하는 반응을 보인 것은 결코 놀랍지 않았습니다. 게다가 대부분의 지역 농부들이 소규모 자영농으로 축구장 두 개 정도의 규모인 2 헥타르의 땅에 생계를 의지하고 있다는 사실을 비춰볼 때, 이들이 주저할 것이라는 점은 충분히 예상하고도 남는 일이었습니다. </p><figure class="v_image v_coffee-cherry v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/47/wide_coffee-cherry_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">수확할 때가 된 커피체리는 전형적으로 진한 붉은 색을 띄지만 네스프레소는 농부들에게 커피체리가 더 진한 자주색이 될 때까지 내버려두라고 했습니다.  image</span> <figcaption><p>수확할 때가 된 커피체리는 전형적으로 진한 붉은 색을 띄지만 네스프레소는 농부들에게 커피체리가 더 진한 자주색이 될 때까지 내버려두라고 했습니다. </p></figcaption></figure><div class="v_media_text v_imageProduct v_floatImageProduct"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/47/product_colombia-capsule_L.jpg" alt="product_colombia-capsule"> <div><h3>마스터 오리진 콜롬비아</h3> <strong>과일향과 산뜻한 산미</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7715.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p class="g_productPrice">₩ 690</p> <div class="g_addToCartCustom">
<button class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">콜롬비아제품 0개가 장바구니에 담겨 있습니다. 지금 주문하기</span> <span aria-hidden="true" class="g_labelAdd">지금 주문하기</span> <span aria-hidden="true" class="g_labelUpdate">장바구니 업데이트</span> <span aria-hidden="true" class="g_labelPhantom">장바구니 업데이트</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">그러나 바로 이 때 상호 신뢰와 15년 동안 쌓인 파트너십이 진가를 발휘합니다. 네스프레소는 한 가지 아이디어가 있었습니다. 네스프레소는 콜롬비아의 특별한 지역에서 자라는 이 커피를 좀 더 익게 내버려두면 생두의 풍미 프로필이 훨씬 더 좋아진다는 것을 알았습니다. 농부들은 이런 방식이 기존의 이론과는 상반된다는 것을 알면서도 한번 시도해 보기로 했습니다. 덕분에 네스프레소는 늦수확 아라비카로 만든 마스터 오리진 콜롬비아를 선보일 수 있게 되었습니다. 이 커피는 균형잡힌 산미, 레드 와인의 과일향, 적당한 강도가 잘 어우러진 특별한 풍미를 선사합니다. </p><p class="v_paragraph">마스터 오리진 콜롬비아 늦수확 커피는 네스프레소가 오랫동안 특별한 관계를 맺어온 커피 애호국이자 재배국인 콜롬비아에 바치는 제품입니다. 결국 모든 것은 신뢰와 도약으로 귀결되며, 그 결과로 탄생한 풍부한 풍미의 커피를 한 잔의 컵으로 맛볼 수 있습니다. </p> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>
<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/naturally-processed" class="">오랜 시간을 이어온 전통 : 건식 가공법의 에티오피아 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/monsooned-malabar" class="">인도 해안의 로부스타 : 몬순 가공법의 인디아 커피 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
...
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/7ways" class="" tabindex="-1" aria-label="캡슐과 커피 찌꺼기를재활용 하기 위한 7가지 방법 "><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/4/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>캡슐과 커피 찌꺼기를<br>재활용 하기 위한 7가지 방법 </h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/certify-program" class="" tabindex="-1" aria-label="인증 프로그램을 통한 협력 : 지속 가능한 품질의 비밀"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/26/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>인증 프로그램을 통한 협력 : <br>지속 가능한 품질의 비밀</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li></ul></aside> 
