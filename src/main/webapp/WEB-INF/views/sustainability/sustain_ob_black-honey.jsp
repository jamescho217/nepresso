...
<article class="v_articlePage v_articleId50"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/50/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>달콤함과 지속가능성 : 블랙허니 가공법의 니카라과 커피</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">달콤함을 얻으려면 힘들고 어려운 과정을 거쳐야 할 때가 있습니다. 그럴 만한 가치는 충분합니다.</p><p class="v_paragraph">니카라과의 주요 수출 품목 중 하나인 커피는 니카라과 경제의 핵심적인 부분을 차지해 왔습니다. 그래서 커피 농부들은 수확된 커피의 품질을 향상시키고 생두를 차별화할 방법에 몰두해 왔습니다. 그 중 한가지 결과물이 2008년경 일부 농가에 도입된 “허니” 가공법입니다. 이는 독특하고 희귀한 가공법으로 커피체리의 천연 과당이 생두의 중심부까지 스며들게 합니다. 그 결과 달콤하고 부드러운 커피가 나오지만 이러한 결과를 얻기까지의 과정은 결코 녹록하지 않습니다.</p><figure class="v_image v_honey-processing v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/50/wide_honey-processing_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">2008년경 니카라과에서 시작된 “허니” 가공법은 희귀하고 까다로운 커피 가공법입니다. image</span> <figcaption><p>2008년경 니카라과에서 시작된 “허니” 가공법은 희귀하고 까다로운 커피 가공법입니다.</p></figcaption></figure><aside class="v_side_block"><strong>네스프레소 AAA 지속가능 품질™ 프로그램</strong> <small></small> <p>네스프레소 AAA 지속가능 품질™ 프로그램은 2003년 비영리기관인 열대우림연맹과 함께 시작되었습니다. 이는 맞춤화된 커피 프로그램으로 네스프레소가 소비자에게 최상의 커피를 제공하는 동시에, 커피 농부의 생계와 이들의 협력공동체가 지속가능하도록 지원하고 환경을 보호한다는 취지가 담겨 있습니다.</p></aside><p class="v_paragraph">“블랙 허니” 가공이 단순히 까다롭다고만 말하면 이 가공법의 어려움을 충분히 설명하지 못하는 것입니다. 과육을 제거한 뒤에 처리하는 일반적인 생두 건조법과 달리, 허니 가공법은 커피체리의 과육이 대부분 생두에 붙어 있는 상태에서 건조합니다. 따라서 커피의 풍미를 완벽하게 유지하고 결점두를 막기 위해 농부들은 생두를 끊임없이 지켜보고 돌림질을 부저런히 뒤짚고 섞어주어 생두가 엉겨붙지 않도록 해줘야 합니다. 여기에 습한 기후 때문에 건조 과정의 정도와 비중이 복잡해질 수 있고, 각각의 생두에 붙은 과육의 양이나 점도가 다르기 때문에 생두가 완전히 건조되기까지는 수 주가 걸릴 수 있습니다. 이 가공법은 번거롭지만 생산량을 늘리고 최상의 품질을 유지하기 위해서는 모두의 노력이 필요할 수 밖에 없습니다. 이런 점에서 네스프레소는 네스프레소 AAA 지속가능 품질™ 프로그램을 통해 니카라과 농부들과 협업하면서 달콤한 시너지 효과를 만들 수 있었습니다.</p><blockquote class="v_emphasis">“블랙 허니” 가공이 단순히 까다롭다고만 말하면 이 가공법의 어려움을 충분히 설명하지 못하는 것입니다. </blockquote><figure class="v_image v_sugers v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/50/wide_sugers_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">농부들은 “허니" 가공 과정에서 과육이 생두에 붙은 채로 건조시켜 커피체리의 천연 과당이 생두 내부 깊숙이 스며들게 합니다. image</span> <figcaption><p>농부들은 “허니" 가공 과정에서 과육이 생두에 붙은 채로 건조시켜 커피체리의 천연 과당이 생두 내부 깊숙이 스며들게 합니다.</p></figcaption></figure><div class="v_media_text v_imageProduct v_floatImageProduct"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/50/product_nicaragua-capsule_L.jpg" alt="product_nicaragua-capsule"> <div><h3>마스터 오리진 니카라과</h3> <strong>달콤하고 조화로운 풍미</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7713.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p class="g_productPrice">₩ 690</p> <div class="g_addToCartCustom">
<button class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">니카라과제품 0개가 장바구니에 담겨 있습니다. 지금 주문하기</span> <span aria-hidden="true" class="g_labelAdd">지금 주문하기</span> <span aria-hidden="true" class="g_labelUpdate">장바구니 업데이트</span> <span aria-hidden="true" class="g_labelPhantom">장바구니 업데이트</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">네스프레소 AAA 지속가능 품질™ 프로그램은 2010년부터 니카라과에 도입되어 현지 농부들의 역량과 권한을 강화하는 지원 시스템을 만들었습니다. 이를 통해 현지 농부들에게 지속가능한 농법을 전수하고, 생산성 향상을 위한 전략을 수립하며, 고품질 커피에 대한 프리미엄을 지급하고 있습니다. </p><p class="v_paragraph">그 결과 네스프레소 공급 파트너들에게 희귀한 “블랙 허니” 커피의 생산량 증가를 요청했을 때 기꺼이 도전에 나선 농부들을 어렵지 않게 볼 수 있었습니다.</p> <div class="v_clearboth"></div></div> 
...
<li><a href="/nespresso/sustainability/coffee-origins-and-blends/indonesia" class="">인도네시아에 커피 협력공동체를 만들다 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul>
</aside> 
...
</aside> <button tabindex="-1" aria-hidden="true" class="v_btnBackToTop"><i class="fas fa-chevron-up" style="font-size:3em;line-height:0;position:relative;left: 10px;top: 10px"></i> <span>맨위로</span></button></div></article></div>
