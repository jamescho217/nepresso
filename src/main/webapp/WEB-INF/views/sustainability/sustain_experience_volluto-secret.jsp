...
<article class="v_articlePage v_articleId2"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/2/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>볼루토 커피가 간직하고 있는 비밀 </h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> 
<button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">네스프레소 커피가 선사하는 편안한 휴식의 시간.</p><p class="v_paragraph">볼루토 커피에는 놀라운 비밀이 숨어 있습니다. 네스프레소에서 가장 오랜 역사를 가진 커피 중 하나인 볼루토는 브라질과 콜롬비아산 아라비카 블렌딩으로, 가볍고 달콤한 풍미가 특징입니다. </p><aside class="v_side_block"><strong>전체 커피 보기</strong> <small></small> <p> <a href="../../grands-crus-coffee-range">다양한 종류의 네스프레소 커를 확인해보세요</a> 고객님께 맞는 커피와 함께 최상의 커피 경험을 즐겨보시기 바랍니다.</p></aside><p class="v_paragraph">커피 블렌드를 개발하면서 갓 수확한 신선한 브라질산 커피 생두를 운반하기 전 몇 개월 간 그대로 둘 경우  <a class="innerLink" href="../the-coffee-experience/a-coffee-tasting-guide">매우 강한 풍미</a>를 갖게 된다는 것을 알게 되었습니다. '레스팅'이라고 부르는 이 과정은 이제 볼루토 커피를 만드는 중요한 한 부분이 되었습니다.</p><figure class="v_image v_beans-bags v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/2/wide_beans-bags_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">커피 자루 이미지 image</span> <figcaption><p>부드럽고 달콤한 풍미의 에스프레소 볼루토를 위하여, 선적하기 전 몇 달간 창고에 보관 합니다.</p></figcaption></figure><p class="v_paragraph">보통 커피는 열매를 보호할 수 있게 자연적으로 생겨나는 종이 같은 막인 자체 파치먼트 내에서 레스팅됩니다. 그러나 커피의 맛을 부드럽게 하기 위해 이 파치먼트를 제거하고 커피 열매를 '수퍼색'이라 불리는 초대형 자루에 넣고 운반하기 전 4개월에서 5개월 가량 레스팅 시킵니다. 그에 따라 보다 신선하고 강렬한 맛은 줄어들게 되며 이 과정을 거쳐 신선한 과일 향과 미세한 산미를 가진 에스프레소이자 부드러운 비스킷 향의 볼루토 커피가 탄생됩니다.</p><blockquote class="v_emphasis">"본래 가진 특성을 잃을 수도 있지만 깨끗하고 큰 브라질 산 수퍼색에서 제대로 레스팅 한다면 커피 품질을 손상시키지 않고 신선한 커피를 안전하게 숙성시킬 수 있습니다."  네스프레소 커피 개발 책임자 알렉스 로드리게즈</blockquote><figure class="v_image v_farmers-field v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/2/wide_farmers-field_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">농장 이미지 image</span> <figcaption><p>일부 브라질산 커피 원두는 강렬한 풍미를 가지고 있습니다.</p></figcaption></figure><div class="v_media_text v_asideRight"><div class="v_clearboth"></div> <div class="v_product"><img src="https://www.nespresso.com//shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/2/product_volluto-capsule_L.jpg" alt="product_volluto-capsule"> <div><h3>볼루토</h3> <strong>달콤하고 부드러운 맛</strong> <div><div class="g_addToCart" min="1" max="9999"><!----> <div data-product-item-id="7435.40" data-product-section="content.title" data-product-position="1" class="g_priceAndButton track-impression-product"><p class="g_productPrice">₩ 590</p> <div class="g_addToCartCustom">
<button class="g_btn g_btnBuy"><i class="fas fa-shopping-basket" style="font-size:2em;line-height:0;position:relative;left: 20px;"></i> <span class="g_visually_hidden">볼루토제품 0개가 장바구니에 담겨 있습니다. 지금 주문하기</span> <span aria-hidden="true" class="g_labelAdd">지금 주문하기</span> <span aria-hidden="true" class="g_labelUpdate">장바구니 업데이트</span> <span aria-hidden="true" class="g_labelPhantom">장바구니 업데이트</span> <i class="fas fa-plus" style="font-size:2em;line-height:0;position:relative;right: 15px;"></i></button> <span tabindex="-1"></span> <div class="g_quantity_scene"><div tabindex="-1" class="g_quantity_popin"><div class="g_quantity-popin-content"><!----></div></div></div></div></div></div></div></div></div><p class="v_paragraph">하지만 우리가 이 커피를 즐기는 이유는 볼루토 커피의 풍미 때문만은 아닙니다. 볼루토 커피는 네스프레소 커피 생산의 80% 이상을 책임지고 있는 AAA 지속가능 품질™ 프로그램을 통해 탄생한 첫 번째 커피이기도 합니다. </p><aside class="v_side_block"><strong>네스프레소의 AAA <br>지속가능 품질™ 프로그램</strong> <small></small> <p>네스프레소의 AAA 지속가능 품질™ 프로그램은 2003년 열대우림연맹과의 협력을 통해 개발되었습니다. 이 맞춤형 커피 프로그램은 농부들과 그 지역사회의 지속가능한 삶을 지원할 수 있는 최고 품질의 커피를 제공하면서 동시에 환경 보호에도 기여하는 가치있는 프로그램이라고 할 수 있습니다. </p></aside> <div class="v_clearboth"></div></div> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/the-coffee-experience/terroir" class="">테루아 테이스팅 노트: <br>커피에 있어 중요한 이유 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience/lean-in-and-listen" class="">이탈리아에서 커피 주문하는 방법: <br>규칙 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/the-coffee-experience/grinding" class="">커피 그라인딩이 과학인 이유 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
