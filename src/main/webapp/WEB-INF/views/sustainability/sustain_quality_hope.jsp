...
<article class="v_articlePage v_articleId60"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/60/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>커피 경작 공동체가 품은 희망의 힘</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article">
<p class="v_headline">네스프레소는 더 좋은 커피는 탄생하는 것이 아니라 되살아나는 것이라고 믿습니다.</p><p class="v_paragraph">완벽한 커피 한 잔의 맛은 어떤 것일까요? 깊고 풍성한 맛일까요? 은은한 향일까요? 살짝 산미가 돌거나 약간 달콤한 커피일까요? 풍미는 주관적이지만 동시에 진정 맛있는 맛은 객관적으로 느낄수 있다는 사실을 네스프레소는 알고 있습니다. "커피콩이 좋을 수록 커피 맛이 더 좋아진다,"는 ‘네스프레소 지속 가능 경영 자문위원회(<strong class="v_brand" term="nespresso">Nespresso</strong> Sustainability Advisory Board)’ 소속 조지 클루니 (George Clooney)의 말이 이 사실을 가장 잘 대변하는 것 같습니다. 그리고 최상의 원두를 통해 최상의 품질의 커피를 만들려면 작물이 자라는 땅을 돌봐야하며, 그 땅을 경작하는 사람들도 동일하게 살펴야 합니다.이 사실이 네스프레소의 리바이빙 오리진(Reviving Origins) 커피의 컨셉이 되었습니다.</p><p class="v_paragraph">2011년 네스프레소가 남수단의 예이(Yei)지역에서 농부들과 함께 일을 시작했을 때 처음 뿌리내린 리바이빙 오리진 아이디어는 땅과 사람들에게 투자하고픈 희망과 필요로 탄생했습니다. 수단 농부들은 내전 중에 농장을 떠날수 밖에 없었고 다시 집으로 돌아왔을 때 그들을 맞이한 것은 불확실한 미래와 황폐해져 보이는 불모지였습니다. 바로 이 곳에서 네스프레소는 해당 지역의 커피 산업 재건 및 재활성화를 돕고 다시 한 번 양질의 커피를 재배하고 수확하기 시작한 농민들의 생계를 개선할 수 있었습니다. 우리는 그곳에서 경제 기반의 다각화를 도모할 수 있고 지속 가능한 발전 기반을 제공하는 커피를 생산했습니다.</p><blockquote class="v_emphasis">네스프레소의 소망은 진귀한 커피 품종을 발견하여 보존하고, 커피 농업의 유산을 보호하며, 최상의 품질의 커피를 지속적으로 공급하는 것입니다.</blockquote><figure class="v_image v_south-sudan v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/60/wide_south-sudan_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">건조된 커피콩과 함께 미소짓는 여인 image</span> <figcaption><p>네스프레소의 리바이빙 오리진(Reviving Origins)의 발상은 남수단의 농부들을 도우며 함께 협업하는 시기에 시작되었습니다. 네스프레소는 땅과 농업 공동체를 소생시키고 농부 개개인의 생계 뿐 아니라 커피 산업 전반을 재건하고 소생시키는 데 일조할 수 있는 기회를 발견했습니다.</p></figcaption></figure><p class="v_paragraph"></p><p class="v_paragraph">그것은 단지 시작이었을 뿐, 네스프레소는 더 나아가 커피 작물과 농장이 위협 받고있는 더 많은 지역을 찾고자 했습니다. 왜일까요? 네스프레소의 소망은 진귀한 커피 품종을 발견하고 보존하며, 커피 농업 유산을 수호하고, 최상의 품질의 커피를 지속적으로 공급하는 것이기 때문입니다. 네스프레소의 삶은 커피를 중심으로 합니다. 즉, 네스프레소의 삶은 지리적 위치나 환경에 관계없이 커피를 돌보는 사람들에게 주안점을 둡니다. 지역 분쟁, 경제난, 자연 재해의 역경이 있는 곳, 이전에 뛰어난 최상의 품질의 커피를 생산하는 오랜 전통에 뿌리를 둔 지역이라면 다시 일어설 수 있도록  네스프레소는 도움을 주고 있습니다.</p><blockquote class="v_emphasis">"리바이빙 오리진은 양질의 커피 및 그 양질의 커피로 농부들이 지급받는 프리미엄이 장기적인 지속 가능성과 농업 공동체 및 지역 경기의 회복을 위한 촉매제가 될 수 있다는 네스프레소의 신념에 근거하고 있습니다." <br><br> -기욤 르 쿤프(GUILLAUME LE CUNFF)<br> 네스프레소 CEO</blockquote>
<figure class="v_image v_farmers v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/60/wide_farmers_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">네스프레소의  ‘AAA 지속가능한 품질™ 프로그램 (AAA Sustainable Quality™ Program)’-(남성및 여성 농부) image</span> <figcaption><p>네스프레소의 ‘AAA 지속가능한 품질™ 프로그램 (AAA Sustainable Quality™ Program)'은 농학자와 일선 파트너들과 함께 지역 농부들에게 기술 지원, 교육 및 자료를 제공해 품질 향상 및 최고의 농업 기술을 장려합니다.</p></figcaption></figure><aside class="v_side_block"><strong>알고 계신가요?</strong> <small></small> <p>리바이빙 오리진 프로그램을 통해 모든 기술 지원, 실습 교육, 자원이 각 농장 맞춤으로 조정되어 공급됩니다. 네스프레소는 ‘AAA 지속 가능한 품질™ 프로그램'의 기본 원칙을 채택하고 품질 업그레이드 및 최상의 농업 관행에 대한 인센티브를 제공합니다. 오늘날, 네스프레소는 15개국의 11만 명 이상의 농부들과 함께 일하고 있습니다.</p></aside><p class="v_paragraph">현재 상황을 말하자면, 네스프레소는 자연 재해로 커피 수확의 80% 이상을 잃은 푸에르토리코와 같은 국가들, 혹은 수십 년간의 내전으로 지역 농부들이 불안정성과 엄청난 재난을 겪은 콜롬비아의 카케타(Caquetá) 및 엘로사리오(El Rosario) 지역, 또는 가뭄과 경제 불안으로 커피 산업이 거의 소멸된 짐바브웨 등지에서 파트너십을 구축했습니다. 네스프레소의 ‘AAA 지속 가능한 품질™ 프로그램' 앰배서더들의 기술과 전문 지식을 구현하여 네스프레소는 땅에서 생태계가 다시 살아나고 그 지역 사람들 사이에서 희망이 회복되고 있음을 직접 보고 있습니다.</p><blockquote class="v_emphasis">네스프레소는 땅에서 생태계가 다시 살아나고 해당 지역 사람들 사이에서 희망이 회복되고 있음을 직접 보고 있습니다.</blockquote><p class="v_paragraph"></p><p class="v_paragraph">더 좋은 커피 한 잔을 위해서는, 가장 지속 가능한 관행을 이용해 최상의 품질의 커피콩을 조달하는 것 뿐 아니라, 유서 깊은 커피 농업 전통을 간직한 사람들에게서 더 좋은 커피 한 잔이 나온다는 사실을 네스프레소는 알게 되었습니다. 더 좋은 커피 한 잔은 자신들의 땅을 잃었다가 되찾아 가고 있는 커피 농부 및 농학자들에게서 나옵니다. 커피 농업은 단순 복원이나 재건이 아니라 되살리는 일이기 때문입니다. 커피 산업, 커피 농장, 그리고 그 지역의 사람들을 예전보다 더 강하게 만들기 위해, 네스프레소는 투자를 통해 다시 일어설 수 있도록 도움을 주고 있습니다.</p><p class="v_paragraph">네스프레소의 리바이빙 오리진 커피를 검색하시려면 <a href="https://www.nespresso.com/reviving-origins">여기</a>를 클릭하세요.</p> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/aluminium" class="">영원히 재생 가능한 알루미늄 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/meet-farmers" class="">명예의 전당에 있는 커피 농부와의 만남. <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/trees-affect" class="">커피 품질에 영향을 미치는 나무들 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
