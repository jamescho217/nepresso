...
<article class="v_articlePage v_articleId44"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>에티오피아의 커피 영웅들<style>.vue  {word-break:keep-all !important;}</style></h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">커피 농부와 자신의 삶을 개선시킨<br>에티오피아의 여성 커피 농학자들의 이야기</p><aside class="v_side_block"><strong>커피 농학자</strong> <small>정의</small> <p>커피 농학자는 토양 관리, 환경보전, 그리고 작물 생산 분야의 전문가입니다. </p></aside><p class="v_paragraph">에티오피아는 여성 커피 농학자들에게 감사할 일이 많습니다. 그들은 커피 농부와 함께 일을 하며 농작물의 품질을 향상시켜, 현재 몇몇 농부들은 전통 오두막집에서 더 나은 집으로 이사를 가고, 아이들을 학교에 보내거나 소를 사는 등 수입을 다양화할 수 있을 정도까지 이르렀으니까요. 네스프레소의 도움으로 현재 테크노서브에서 교육을 받은 105명의 커피 농학자 중 37명은 여성입니다. 이렇듯 위대한 여성들은 성 차별을 줄일 뿐 아니라, 다른 여성들에게 영감을 불어넣어 줍니다. 저희가 이 커피 영웅들을 직접 만나 보았습니다.</p><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/gif_emmush_kasa_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>에무쉬 카사, 25세</span></h3> <p>에무쉬의 전문 지식으로 인해 그녀의 마을 주민들 뿐만 아니라 가족원들 또한 큰 덕을 보았습니다.<br><br>그녀의 가족들 또한 커피 농부이며, 작물이 잘 자라준 덕분에 현재 위성 TV를 시청할 수 있습니다. 친척들이 모두 모여 함께 시청하곤 합니다.</p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/gif_abinet_chebude_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>아비넷 체부데, 26세</span></h3> <p>아비넷이 교육한 커피 농부 중 한명은 마을 사람들의 부러움을 독차지할 정도의 집을 지었습니다. 그의 자녀들은 사립 학교에 다닙니다.<br><br>아비넷의 월급 덕분에 그녀의 자녀들도 사립 학교에 보낼 수 있었습니다. 마을에서 오토바이를 소지한 유일한 여성으로, 대여를 해주기도 한답니다.</p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/gif_meseret_kanto_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>메서렛 칸토, 25세</span></h3> <p>메서렛은 그녀가 감독한 대다수의 농부들이 이제는 더 높은 품질의 커피를 대량으로 생산할 수 있게 된 사실을 자랑스럽게 여깁니다.<br><br>그녀는, "내가 알려준 방법을 활용하여 삶이 변화된 농부들을 볼 때 가장 큰 보람을 느낀다"고 합니다.</p> <!----> <!----></figcaption></figure></div></div><blockquote class="v_emphasis">내가 알려준 방법을 활용하여 삶이 변화된 농부들을 볼 때 가장 큰 보람을 느낀다.</blockquote><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/gif_aynalem_mutage_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>아이날렘 무타게, 21세</span></h3> <p>아이날렘은 네스프레소의 파트너 사이자 비영리 단체인 테크노서브가 주관한 커피 농학자가 육성 교육에 너무도 적극적으로 임한 나머지, 특별한 노력을 기리는 상까지 받았습니다.<br><br>그녀는 커피 농학자로 큰 성공을 거두었습니다. 그녀가 지원한 농부 중 하나는 정부의 농학부와 테크노서브 양측에서 모두 '우수 농장'으로 선정되는 명예를 안았습니다. 농부는 아들에게 삼륜구동 자동차인 '바다지'를 사 줄 수 있게 되었습니다.</p> <!----> <!----></figcaption></figure></div></div><div class="v_gif v_section"><div class="v_sectionRestrict"><figure class="v_table"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/44/gif_abinet_delume_L.jpg&quot;);"></div> <figcaption class="v_cell"><h3><span></span><span>아비넷 델루메, 32세</span></h3> <p>아비넷이 교육한 모든 농부들은 현재 너무나도 훌륭한 커피를 생산하는 나머지 협동조합에서 교실 등의 커뮤니티 프로젝트에 투자를 하기로 했습니다.<br><br>아비넷은 그녀의 직업에 대해 "매우 만족스럽다"고 말하며, "커피 농업은 결과가 눈에 보이는 실용적인 분야다. 농부들도 만족하고 행복해한다"고 만족을 표현했습니다.</p> <!----> <!----></figcaption></figure></div></div> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/colombia" class="">콜롬비아의 커피협력공동체 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/secret" class="">완벽한 커피를 재배하는 비결<style>.vue  {word-break:keep-all !important;}</style> <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul></aside> 
