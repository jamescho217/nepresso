...
<article class="v_articlePage v_articleId42"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url('https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/42/wide_farmer-adanech_L.jpg');"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>완벽한 커피를 재배하는 비결<style>.vue  {word-break:keep-all !important;}</style></h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">에티오피아의 커피 농부들에게 커피 농학자들이 영웅인 이유</p><p class="v_paragraph">완벽한 커피를 재배하는 비결이 궁금하세요? 위치, 기후는 물론 농부의 능력 등  많은 요인들이 영향을 줍니다. 하지만 그게 다가 아닙니다.</p><p class="v_paragraph">이 세상의 모든 완벽한 커피, 그 배후에는 항상 완벽한 커피 농학자가 있습니다. </p><p class="v_paragraph">커피 농학자는 토양 관리, 환경보전, 그리고 농작물 수확 분야의 전문가입니다. 그들은 농부들에게 지속 가능 가치를 위한 품질 좋은 커피를 대량으로 재배하는 방법을 가르칩니다. 커피의 품질이 좋을수록 농부의 수익 또한 올라갑니다. 저희가 원하는 결과죠.</p>
<figure class="v_image v_farmer-abinet v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/42/wide_farmer-abinet_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">아비넷 둘루메는 여성 농부인 반케에게 뿌리 뽑기 기술을 가르칩니다. image</span> <figcaption><p>아비넷 둘루메는 여성 농부인 반케에게 뿌리 뽑기 기술을 가르칩니다.</p></figcaption></figure><p class="v_paragraph">커피 농부가 커피 농학자에게 애착을 갖게 되는 것도 당연한 일입니다. 커피 농학자는 심기부터 수확까지 농부가 밟는 모든 과정에서 도움을 줍니다.</p><p class="v_paragraph">커피 농학자는 농부에게 최고의 농업기술을 전수하고, 비료의 사용이나 퇴비를 주는 법, 혹은 잊지 못할 맛을 내기 위해 잘 익은 커피 체리만 수확하는 것의 중요성 등의 주제로 함께 이야기를 나눕니다.</p><p class="v_paragraph">그들은 또한 농부들의 수익을 다양화하기 위해 커피 나무 사이사이 다른 작물을 재배하는 것에 대한 이점을 강조하며, 자생식물을 심어 침식을 막는 방법을 알려줍니다.</p><p class="v_paragraph">더불어 이익과 손해나 장부 기록법 등 매우 중요한 비즈니스 스킬에 대해 교육합니다.</p>
<figure class="v_image v_farmer-meseret v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/42/wide_farmer-meseret_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">메서렛 칸토는 지역 농부에게 가지치기가 커피의 품질에 미치는 영향을 알려줍니다. image</span> <figcaption><p>메서렛 칸토는 지역 농부에게 가지치기가 커피의 품질에 미치는 영향을 알려줍니다.</p></figcaption></figure><aside class="v_side_block"><strong>아라비카</strong> <small>정의</small> <p>에티오피아에서 탄생한 아라비카는 커피의 한 종입니다. 전 세계에서 생산되는 커피 중 3분의 2는 아라비카로 만들어졌습니다.</p></aside><p class="v_paragraph">커피 농학자들은 아라비카 커피의 원산지인 에티오피아에 큰 변화를 가져다 주었습니다. 그곳의 농부들은 최신식 농업기술에 대한 지식이 없었습니다. 그 예로, 대부분의 농부들은 오래된 커피 나무에서는 항상 부진한 결과만 나온다고 믿고 있었습니다.</p><p class="v_paragraph">그리하여 커피 농학자들은 오래된 나무가 잘린 뒤 재활성화되는 모습, 즉 '뿌리 뽑기'라고 불리는 기술을 농부들에게 선보였습니다. 그리고 농부들이 직접 이 기술을 쓸 수 있도록 교육을 하여, 다시 건강한 커피 체리를 생산할 수 있게 되었습니다.</p><p class="v_paragraph">이것은 그들의 삶에 아주 막대한 영향을 끼칠 수 있습니다. 예를 들어 알레타원도오레다에 사는 32살의 커피 농학자 아비넷 둘루메는 그녀가 지원하는 농부들 중 일부가 추가 수익을 사용해 집을 짓고 자녀들도 학교에 보낼 수 있게 되었다고 말합니다.</p>
<figure class="v_image v_farmer-adanech v_wideImage"><div><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/42/wide_farmer-adanech_L.jpg&quot;);"><!----></div></div> <span class="v_visually_hidden">알레타원도 지구의 아다네쉬 툼시도, 27세. image</span> <figcaption><p>알레타원도 지구의 아다네쉬 툼시도, 27세.</p></figcaption></figure><aside class="v_side_block"><strong>통계</strong> <small></small> <p>네스프레소의 도움으로 현재 네스프레소 지속 가능 품질 프로그램을 통해 커피 농부와 함께 일하는 441명의 커피 농학자 중 31%는 여성입니다.<br><br>*출처: 네스프레소 AAA 지속 가능 품질 프로그램.<br>**출처: 월드뱅크에 따르면, 평균적으로 아프리카 내 커피 농학자 중 7%는 여성인 것으로 추정된다.</p></aside><p class="v_paragraph">네스프레소의 파트너 사이자 비영리 단체인 테크노서브로부터 교육을 받은 105명의 에티오피아 커피 농학자들은 5만 4천여 명의 커피 농부들에게 현대적인 농경을 가르칩니다. 커피 농학자들 중 37명은 여성으로, 2016년에 비해 증가했습니다.</p><p class="v_paragraph">이 여성들은 성차별을 줄이는데 도움을 줄 뿐만 아니라, 가족을 부양하고 다른 여성들에게 롤모델이 되기도 합니다.</p>
<figure class="v_embed_video v_isPlaying"><iframe aria-label="test" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube-nocookie.com/embed/lECP94MXp4U?enablejsapi=0&amp;rel=0&amp;fs=0&amp;autoplay=false&amp;origin=https%3A%2F%2Fwww.nespresso.com&amp;widgetid=1" id="widget2" data-gtm-yt-inspected-2212881_756="true" data-gtm-yt-inspected-2212881_381="true" data-gtm-video-complete="true"></iframe> <figcaption aria-hidden="true" tabindex="-1"><p>완벽한 커피를 재배하는 비결</p></figcaption> <!----></figure>
<p class="v_paragraph">이러한 여성 개척자 중 하나는 알레타원도 지구에서 온 27세의 아다네쉬 툼시도로, 그녀는 커피 농학자라는 직업에 매우 보람을 느낀다고 합니다.</p><p class="v_paragraph">"전문적인 교육 및 지원을 받은 후 농부들의 삶이 개선되는 모습을 볼 때 가장 즐겁다"고 그녀는 말합니다.</p><blockquote class="v_emphasis">전문적인 교육 및 지원을 받은 후 농부들의 삶이 개선되는 모습을 볼 때 가장 즐겁다.</blockquote> 
<footer class="v_footer"></footer>

<aside class="v_relatedArticles"><h2>관련 글</h2> 
<ul>
<li><a href="/nespresso/sustainability/sustainable-coffee-quality/farmers-future" class="">커피 농부들의 안전한 미래 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li>
...
<ul>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/farmers-future" class="" tabindex="-1" aria-label="커피 농부들의 안전한 미래  "><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/7/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>커피 농부들의 안전한 미래  </h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/sustainable-coffee-quality/hope" class="" tabindex="-1" aria-label="커피 경작 공동체가 품은 희망의 힘"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/60/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>커피 경작 공동체가 품은 희망의 힘</h4> <p class="v_category">지속 가능한 품질</p> <time></time></div></div></div></a></article></li>
<li><article class="v_article_card"><a href="/nespresso/sustainability/coffee-origins-and-blends/high-altitude" class="" tabindex="-1" aria-label="손 닿지 않던 곳의 커피 : 마스터 오리진 버츄오 콜롬비아 커피"><div aria-hidden="true" class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/53/thumbnail_L.jpg&quot;);"></div> <div aria-hidden="true" class="v_content"><div class="v_table"><div class="v_cell"><h4>손 닿지 않던 곳의 커피 : 마스터 오리진 버츄오 콜롬비아 커피</h4> <p class="v_category">원산지와 블렌드</p> <time></time></div></div></div></a></article></li></ul>
</aside> 
